...
!(function (e, t) {
	"object" == typeof exports && "undefined" != typeof module
		...
		? define(t)
		: ((e =
				"undefined" != typeof globalThis ? globalThis : e || self).Tabulator =
				t());
})(this, function () {
	"use strict";
	function e(t) {
	...
	var g = (function () {
			...
			return (
				o(e, [
					...
					},
					{
						...
						value: function () {
							var e;
							return (e = this.table.modules.localize).getText.apply(
								e,
								arguments
							);
						},
					...
					},
					{
						...
						value: function () {
							var e;
							return (e = this.table.modules.localize).getLocale.apply(
								e,
								arguments
							);
						},
					},
					{
						...
						value: function () {
							var e;
							return (e = this.table.modules.comms).getConnections.apply(
								e,
								arguments
							);
						},
					...
					},
					{
						...
						value: function () {
							var e;
							return (e = this.table.eventBus).subscriptionChange.apply(
								e,
								arguments
							);
						},
					...
					},
					{
						...
						value: function () {
							var e;
							return (e = this.table.externalEvents).dispatch.apply(
								e,
								arguments
							);
						},
					...
					},
					{
						...
						value: function () {
							var e;
							return (e = this.table.externalEvents).subscriptionChange.apply(
								e,
								arguments
							);
						},
					...
					},
					{
						...
						value: function (e, t) {
							return (
								void 0 !== t && (this.table.options[e] = t),
				...
				return (
					...
					new Proxy(this, {
						get: function (e, t, i) {
							return void 0 !== e[t]
								? e[t]
								: e._column.table.componentFunctionBinder.handle(
										"column",
										e._column,
										t
								  );
			...
			return (
				o(e, [
					...
					},
					{
						...
						value: function () {
							return (
								this._column.parent instanceof C &&
					...
					},
					{
						key: "scrollTo",
						value: function () {
							return this._column.table.columnManager.scrollToColumn(
								this._column
							);
						},
					},
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								...
								this._column.table.columnManager.renderer.rerenderColumns(!0),
								t
							);
						},
					},
				...
				return (
					...
					new Proxy(this, {
						get: function (e, t, i) {
							return void 0 !== e[t]
								? e[t]
								: e._cell.table.componentFunctionBinder.handle(
										"cell",
										e._cell,
										t
								  );
		...
		w = (function (i) {
			...
			function r(e, i) {
				...
				return (
					t(this, r),
					((o = n.call(this, e.table)).table = e.table),
					(o.column = e),
					(o.row = i),
					(o.element = null),
					(o.value = null),
				...
				o(r, [
					...
					},
					{
						...
						value: function () {
							...
							switch (
								e(
									(t = this.chain("cell-format", this, null, function () {
					...
					},
					{
						key: "setValue",
						value: function (e, t, i) {
							this.setValueProcessData(e, t, i) &&
								(this.dispatch("cell-value-updated", this),
								this.cellRendered(),
								this.column.definition.cellEdited &&
									this.column.definition.cellEdited.call(
										this.table,
										this.getComponent()
									),
								this.dispatchExternal("cellEdited", this.getComponent()),
								this.subscribedExternal("dataChanged") &&
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return (
								...
								n && this.dispatch("cell-value-changed", this),
								n
							);
						},
					},
					...
					},
					{
						...
						value: function () {
							return (
								this.component || (this.component = new y(this)), this.component
							);
						},
					},
				]),
		...
		C = (function (i) {
			...
			function r(e, i) {
				...
				return (
					t(this, r),
					((o = n.call(this, i.table)).definition = e),
					(o.parent = i),
					(o.type = "column"),
					(o.columns = []),
					(o.cells = []),
					(o.element = o.createElement()),
					(o.contentElement = !1),
					(o.titleHolderElement = !1),
					(o.titleElement = !1),
					(o.groupElement = o.createGroupElement()),
					(o.isGroup = !1),
					(o.hozAlign = ""),
					(o.vertAlign = ""),
					(o.field = ""),
					...
					(o.getFieldValue = ""),
					(o.setFieldValue = ""),
					(o.titleDownload = null),
					(o.titleFormatterRendered = !1),
					o.mapDefinitions(),
					o.setField(o.definition.field),
					(o.modules = {}),
					(o.width = null),
					(o.widthStyled = ""),
					(o.maxWidth = null),
					(o.maxWidthStyled = ""),
					(o.maxInitialWidth = null),
					(o.minWidth = null),
					(o.minWidthStyled = ""),
					(o.widthFixed = !1),
					(o.visible = !0),
					(o.component = null),
					o.definition.columns
						? ((o.isGroup = !0),
				...
				o(r, [
					...
					},
					{
						...
						value: function () {
							...
							Object.keys(this.definition).forEach(function (t) {
								-1 === r.defaultOptionList.indexOf(t) &&
									console.warn(
					...
					},
					{
						...
						value: function () {
							...
							void 0 !== t.visible &&
								(t.visible ? this.show(!0) : this.hide(!0)),
							t.cssClass) &&
							...
							t.field && this.element.setAttribute("tabulator-field", t.field),
								...
								t.maxInitialWidth &&
									(this.maxInitialWidth = parseInt(t.maxInitialWidth)),
					...
					},
					{
						...
						value: function () {
							...
							return (
								...
								this.titleHolderElement.classList.add(
					...
					},
					{
						...
						value: function () {
							...
							if ((i.classList.add("tabulator-col-title"), t.editableTitle)) {
								...
								t.field
									? this.langBind("columns|" + t.field, function (n) {
					...
					},
					{
						...
						value: function (e) {
							for (
								var t, i = e, n = this.fieldStructure, o = n.length, a = 0;
								a < o && ((t = i = i[n[a]]), i);
								a++
							);
							return t;
					...
					},
					{
						...
						value: function (e, t) {
							for (
								var i = e, n = this.fieldStructure, o = n.length, a = 0;
								a < o;
								a++
							)
								if (a == o - 1) i[n[a]] = t;
					...
					},
					{
						...
						value: function () {
							...
							return new Promise(function (t, i) {
								...
								for (var n = e.cells.length, o = 0; o < n; o++)
									e.cells[0].delete();
								e.element.parentNode &&
									...
									e.table.columnManager.renderer.rerenderColumns(!0),
									t();
							});
						},
					},
						...
						value: function (e) {
							if (!this.isGroup) {
								...
								if (
									...
									var i = t + 1;
									this.maxInitialWidth &&
										!e &&
										(i = Math.min(i, this.maxInitialWidth)),
					...
					},
					{
						...
						value: function (e) {
							...
							return this.isGroup || this.parent.isGroup
								...
								: ((t = Object.assign({}, this.getDefinition())),
								  (t = Object.assign(t, e)),
								  this.table.columnManager
										.addColumn(t, !1, this)
										.then(function (e) {
											return (
												t.field == i.field && (i.field = !1),
					...
					},
					{
						...
						value: function () {
							return (
								this.component || (this.component = new v(this)), this.component
							);
						},
					},
				]),
	...
	var k = (function () {
					...
					},
					{
						...
						value: function (t, i) {
							...
							var s = function () {
								...
								null == s ||
									"object" !== e(s) ||
									(s.__proto__ !== a && s.__proto__ !== r) ||
									((u = o.findIndex(function (e) {
										return e.subject === s;
									})) > -1
										? (i[l] = o[u].copy)
										: ((c = Object.assign(Array.isArray(s) ? [] : {}, s)),
										  o.unshift({ subject: s, copy: c }),
		...
		E = (function () {
			function i(e, n) {
				...
				t(this, i),
					(this.table = e),
					(this.msgType = n),
					(this.registeredDefaults = Object.assign({}, o));
			}
			return (
				o(i, [
					{
					...
					},
					{
						...
						value: function (t) {
							...
							if (
								(Object.assign(n, t),
								!1 !== i.debugInvalidOptions ||
									this.table.options.debugInvalidOptions)
							)
								for (var o in i)
									n.hasOwnProperty(o) ||
										console.warn("Invalid " + this.msgType + " option:", o);
							for (var o in n)
								o in i
									? (n[o] = i[o])
									: Array.isArray(n[o])
									? (n[o] = Object.assign([], n[o]))
									: "object" === e(n[o]) && null !== n[o]
									? (n[o] = Object.assign({}, n[o]))
									: void 0 === n[o] && delete n[o];
							return n;
						},
					},
				]),
		...
		R = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).elementVertical = e.rowManager.element),
					(o.elementHorizontal = e.columnManager.element),
					(o.tableElement = e.rowManager.tableElement),
					(o.verticalFillMode = "fit"),
					o
				);
			}
			return (
								...
								if (o > -1) {
									if (
										...
										!i &&
											k.elVisible(a) &&
											(r =
												k.elOffset(a).top - k.elOffset(n.elementVertical).top) >
												0 &&
											r < n.elementVertical.clientHeight - a.offsetHeight)
									)
										return s(), !1;
									switch (
										(void 0 === t && (t = n.table.options.scrollToRowPosition),
										"nearest" === t &&
											(t = n.scrollToRowNearestTop(e) ? "top" : "bottom"),
										n.scrollToRow(e),
										t)
									) {
										case "middle":
										case "center":
											n.elementVertical.scrollHeight -
												n.elementVertical.scrollTop ==
											n.elementVertical.clientHeight
												? (n.elementVertical.scrollTop =
														n.elementVertical.scrollTop +
														(a.offsetTop - n.elementVertical.scrollTop) -
														(n.elementVertical.scrollHeight - a.offsetTop) / 2)
												: (n.elementVertical.scrollTop =
														n.elementVertical.scrollTop -
														n.elementVertical.clientHeight / 2);
											break;
										case "bottom":
											n.elementVertical.scrollHeight -
												n.elementVertical.scrollTop ==
											n.elementVertical.clientHeight
												? (n.elementVertical.scrollTop =
														n.elementVertical.scrollTop -
														(n.elementVertical.scrollHeight - a.offsetTop) +
														a.offsetHeight)
												: (n.elementVertical.scrollTop =
														n.elementVertical.scrollTop -
														n.elementVertical.clientHeight +
		...
		T = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).leftCol = 0),
					(o.rightCol = 0),
					(o.scrollLeft = 0),
					(o.vDomScrollPosLeft = 0),
					(o.vDomScrollPosRight = 0),
					(o.vDomPadLeft = 0),
					(o.vDomPadRight = 0),
					(o.fitDataColAvg = 0),
					(o.windowBuffer = 200),
				...
				o(n, [
					...
					},
					{
						...
						value: function () {
							var e = this.options("columns"),
								t = !0;
							return (
								"fitDataTable" == this.options("layout") &&
									(console.warn(
					...
					},
					{
						...
						value: function () {
							this.subscribe(
								"scroll-vertical",
								this.clearVisRowCache.bind(this)
							),
								this.subscribe(
									"data-refreshed",
									this.clearVisRowCache.bind(this)
						...
						value: function (e, t) {
							...
							(e && !this.initialized) ||
								...
								this.table.columnManager.columnsByIndex.forEach(function (e) {
									...
									if (e.visible) {
										...
										(t.leftPos = o),
											...
											i.isFitData &&
												(t.fitDataCheck =
													!e.modules.vdomHoz || e.modules.vdomHoz.fitDataCheck),
											o + n > i.vDomScrollPosLeft && o < i.vDomScrollPosRight
												? (-1 == i.leftCol &&
														((i.leftCol = i.columns.length),
														(i.vDomPadLeft = o)),
												  (i.rightCol = i.columns.length))
												: -1 !== i.leftCol && (i.vDomPadRight += n),
											i.columns.push(e),
											(e.modules.vdomHoz = t),
											(o += n);
									}
								...
								(this.tableElement.style.paddingRight =
									this.vDomPadRight + "px"),
								(this.initialized = !0),
								t || (e && !this.reinitChanged(n)) || this.reinitializeRows(),
					...
					},
					{
						...
						value: function () {
							...
							if (this.isFitData) {
								if (
									(this.table.columnManager.columnsByIndex.forEach(function (
										e
									) {
									...
									n &&
										...
										((this.vDomScrollPosRight =
											...
											this.elementVertical.clientWidth +
											this.windowBuffer),
										(t = this.chain("rows-sample", [1], [], function () {
								...
								"fitColumns" === this.options("layout") &&
									(this.layoutRefresh(), this.rerenderColumns(!1, !0));
						},
					},
					{
						key: "reinitChanged",
					...
					},
					{
						...
						value: function (e) {
							(this.vDomScrollPosLeft += e),
								...
								Math.abs(e) > this.windowBuffer / 2
					...
					},
					{
						...
						value: function (e, t, i) {
							for (var n = e; n < t; n++) {
								...
								(o.modules.vdomHoz.leftPos += i),
									(o.modules.vdomHoz.rightPos += i);
							}
						},
					},
					{
							...
							for (
								var e = this,
									...
									i = function () {
										...
										return i &&
											i.modules.vdomHoz.leftPos <= e.vDomScrollPosRight
											? ((t = !0),
											  e.getVisibleRows().forEach(function (e) {
													if ("group" !== e.type) {
														var t = e.getCell(i);
											  ...
											  e.fitDataColActualWidthCheck(i),
											  e.rightCol++,
											  void (e.rightCol >= e.columns.length - 1
													? (e.vDomPadRight = 0)
													: (e.vDomPadRight -= i.getWidth())))
											: "break";
									};
								;
							...
							for (
								var e = this,
									...
									i = function () {
										...
										if (!i) return "break";
										if (!(i.modules.vdomHoz.rightPos >= e.vDomScrollPosLeft))
											return "break";
										(t = !0),
											e.getVisibleRows().forEach(function (e) {
												if ("group" !== e.type) {
													var t = e.getCell(i);
													e.getElement().prepend(t.getElement()),
														t.cellRendered();
												}
											}),
											e.leftCol--,
											e.leftCol <= 0
												? (e.vDomPadLeft = 0)
												: (e.vDomPadLeft -= i.getWidth());
										var n = e.fitDataColActualWidthCheck(i);
										n &&
											((e.scrollLeft = e.elementVertical.scrollLeft =
												e.elementVertical.scrollLeft + n),
											(e.vDomPadRight -= n));
									};
								;
							...
							for (
								var e = this,
									...
									i = function () {
										...
										return i && i.modules.vdomHoz.leftPos > e.vDomScrollPosRight
											? ((t = !0),
											  e.getVisibleRows().forEach(function (e) {
													if ("group" !== e.type) {
														var t = e.getCell(i);
							...
							for (
								var e = this,
									...
									i = function () {
										...
										return i && i.modules.vdomHoz.rightPos < e.vDomScrollPosLeft
											? ((t = !0),
											  e.getVisibleRows().forEach(function (e) {
													if ("group" !== e.type) {
														var t = e.getCell(i);
					...
					},
					{
						...
						value: function (e) {
							var t, i;
							return (
								e.modules.vdomHoz.fitDataCheck &&
									(e.reinitializeWidth(),
									(i = (t = e.getWidth()) - e.modules.vdomHoz.width) &&
										((e.modules.vdomHoz.rightPos += i),
										(e.modules.vdomHoz.width = t),
										this.colPositionAdjust(
											this.columns.indexOf(e) + 1,
											this.columns.length,
											i
										)),
						...
						value: function (e) {
							if ("group" !== e.type) {
								...
								for (var t = this.leftCol; t <= this.rightCol; t++) {
									...
									if (i && i.visible) {
										var n = e.getCell(i);
										e.getElement().appendChild(n.getElement()),
											n.cellRendered();
									}
								}
							}
		...
		M = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).blockHozScrollEvent = !1),
					(i.headersElement = null),
					(i.element = null),
					(i.columns = []),
					(i.columnsByIndex = []),
					(i.columnsByField = {}),
					(i.scrollLeft = 0),
					(i.optionsList = new E(i.table, "column definition", b)),
					(i.renderer = null),
					i
				);
			}
				...
				o(r, [
					{
						...
						value: function () {
							this.initializeRenderer(),
								...
								this.subscribe(
									"scroll-horizontal",
									this.scrollHorizontal.bind(this)
								);
						},
					},
					{
						...
						value: function () {
							var e,
								t = { virtual: T, basic: x };
							(e =
								"string" == typeof this.table.options.renderHorizontal
									? t[this.table.options.renderHorizontal]
					...
					},
					{
						...
						value: function () {
							var e = document.createElement("div");
							return (
								e.classList.add("tabulator-headers"),
					...
					},
					{
						...
						value: function (t) {
							var i,
								n,
								o = [],
								a = this.table.options.autoColumnsDefinitions;
							if (t && t.length) {
								for (var r in (i = t[0])) {
									var s = { field: r, title: r },
										l = i[r];
									switch (e(l)) {
										case "undefined":
											n = "string";
					...
					},
					{
						key: "setColumns",
						value: function (e, t) {
							for (var i = this; this.headersElement.firstChild; )
							...
							(this.columns = []),
								...
								this.renderer.rerenderColumns(!1, !0),
								this.redraw(!0);
						},
					},
					{
						...
						value: function (e, t, i) {
							...
							if (i && a > -1) {
								var r = i.getTopColumn(),
									s = this.columns.indexOf(r),
									l = r.getElement();
								t
									? (this.columns.splice(s, 0, n),
									  l.parentNode.insertBefore(o, l))
									: (this.columns.splice(s + 1, 0, n),
									  l.parentNode.insertBefore(o, l.nextSibling));
							} else
								t
									? (this.columns.unshift(n),
									  this.headersElement.insertBefore(
											n.getElement(),
											this.headersElement.firstChild
									  ))
									: (this.columns.push(n),
									  this.headersElement.appendChild(n.getElement()));
					...
					},
					{
						...
						value: function (e) {
							e.definition.field &&
								(this.columnsByField[e.definition.field] = e);
						},
					},
					{
						key: "registerColumnPosition",
					...
					},
					{
						...
						value: function (e) {
							var t = this,
								i = [];
							return (
								Object.keys(this.columnsByField).forEach(function (n) {
					...
					},
					{
						...
						value: function (e, t, i) {
							e.parent.isGroup
								...
								this.renderer.rerenderColumns(!0),
								this.dispatch("column-moved", e, t, i),
								this.subscribedExternal("columnMoved") &&
									this.dispatchExternal(
										"columnMoved",
										e.getComponent(),
					...
					},
					{
						...
						value: function (e, t, i, n, o) {
							...
							r > -1 &&
								(e.splice(r, 1),
								(a = e.indexOf(i)) > -1 ? n && (a += 1) : (a = r),
								e.splice(a, 0, t),
								o &&
									(this.chain("column-moving-rows", [t, i, n], null, []) || [])
										.concat(this.table.rowManager.rows)
										.forEach(function (e) {
											if (e.cells.length) {
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return new Promise(function (l, u) {
								if (
									(void 0 === t && (t = n.table.options.scrollToColumnPosition),
									void 0 === i && (i = n.table.options.scrollToColumnIfVisible),
									e.visible)
								) {
									switch (t) {
										case "middle":
									...
									if (
										!i &&
										(a = s.offsetLeft) > 0 &&
										a + s.offsetWidth < n.element.clientWidth
									)
										return !1;
									(o = s.offsetLeft + r),
										(o = Math.max(
											Math.min(
												o,
												n.table.rowManager.element.scrollWidth -
													n.table.rowManager.element.clientWidth
											),
											0
										)),
										n.table.rowManager.scrollHorizontal(o),
										n.scrollHorizontal(o),
										l();
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return new Promise(function (o, a) {
								...
								n._reIndexColumns(),
									n.dispatch("column-add", e, t, i),
									"fitColumns" != n.layoutMode() && r.reinitializeWidth(),
									n.redraw(!0),
									n.table.rowManager.reinitialize(),
									n.renderer.rerenderColumns(),
									o(r);
							});
						},
					},
					...
					},
					{
						key: "redraw",
						value: function (e) {
							k.elVisible(this.element) && this.verticalAlignHeaders(),
								e &&
									(this.table.rowManager.resetScroll(),
									this.table.rowManager.reinitialize()),
								this.confirm("table-redrawing", e) || this.layoutRefresh(),
				...
				return (
					...
					new Proxy(this, {
						get: function (e, t, i) {
							return void 0 !== e[t]
								? e[t]
								: e._row.table.componentFunctionBinder.handle("row", e._row, t);
						},
					})
				);
			}
		...
		D = (function (e) {
			...
			function n(e, o) {
				...
				return (
					t(this, n),
					((a = i.call(this, o.table)).parent = o),
					(a.data = {}),
					(a.type = r),
					(a.element = !1),
					(a.modules = {}),
				...
				o(n, [
					...
					},
					{
						...
						value: function (e) {
							(this.initialized = !1),
								(this.heightInitialized = !1),
								this.manualHeight ||
									((this.height = 0), (this.heightStyled = "")),
								this.element &&
									null !== this.element.offsetParent &&
									this.initialize(!0),
					...
					},
					{
						...
						value: function (e) {
							...
							this.table.options.rowHeight
								...
								: ((t = this.table.options.resizableRows
										? this.element.clientHeight
										: 0),
								  this.cells.forEach(function (e) {
										var t = e.getHeight();
					...
					},
					{
						...
						value: function (e) {
							var t,
								i = this,
								n = this.element && k.elVisible(this.element),
								o = {};
							return new Promise(function (a, r) {
								for (var s in ("string" == typeof e && (e = JSON.parse(e)),
								i.dispatch("row-data-save-before", i),
								i.subscribed("row-data-changing") &&
									((o = Object.assign(o, i.data)), (o = Object.assign(o, e))),
								(t = i.chain("row-data-changing", [i, o, e], null, e))))
									i.data[s] = t[s];
									...
									i.table.columnManager
										...
										.forEach(function (e) {
											...
											if (o) {
												...
												o.getValue() != a &&
													(o.setValueProcessData(a), n && o.cellRendered());
											}
										});
								}
								n
									...
									: ((i.initialized = !1),
									  (i.height = 0),
									  (i.heightStyled = "")),
									i.dispatch("row-data-changed", i, n, e),
									i.dispatchExternal("rowUpdated", i.getComponent()),
									i.subscribedExternal("dataChanged") &&
										i.dispatchExternal(
											"dataChanged",
					...
					},
					{
						...
						value: function (e) {
							return e
								? this.chain("row-data-retrieve", [this, e], null, this.data)
								: this.data;
						},
					},
					{
						...
						value: function (e) {
							return (
								...
								this.initialized || this.generateCells(),
					...
					},
					{
						...
						value: function () {
							return (
								this.component || (this.component = new L(this)), this.component
							);
						},
					},
				]),
		...
		S = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).verticalFillMode = "fill"),
					(o.scrollTop = 0),
					(o.scrollLeft = 0),
					(o.scrollTop = 0),
					(o.scrollLeft = 0),
				...
				o(n, [
					...
					},
					{
						...
						value: function (e) {
							...
							return !(
								Math.abs(this.elementVertical.scrollTop - t) >
								Math.abs(
					...
					},
					{
						...
						value: function (e) {
							...
							this.elementVertical.scrollTop =
								k.elOffset(t).top -
								k.elOffset(this.elementVertical).top +
								this.elementVertical.scrollTop;
						},
					},
					{
		...
		P = (function (e) {
			...
			function n(e) {
				...
				return (
					...
					(o.vDomTop = 0),
					(o.vDomBottom = 0),
					(o.vDomScrollPosTop = 0),
					(o.vDomScrollPosBottom = 0),
					(o.vDomTopPad = 0),
					(o.vDomBottomPad = 0),
					(o.vDomMaxRenderChain = 90),
					(o.vDomWindowBuffer = 0),
					(o.vDomWindowMinTotalRows = 20),
					(o.vDomWindowMinMarginRows = 5),
					(o.vDomTopNewRows = []),
					(o.vDomBottomNewRows = []),
					o
				);
				...
				o(n, [
						...
						value: function (e) {
							for (
								var t = this.elementVertical.scrollTop,
									i = !1,
									n = !1,
									o = this.table.rowManager.scrollLeft,
									a = this.rows(),
									r = this.vDomTop;
								r <= this.vDomBottom;
								r++
					...
					},
					{
						...
						value: function (e) {
							...
							return !(
								Math.abs(this.vDomTop - t) > Math.abs(this.vDomBottom - t)
							);
						},
					},
					{
					...
					},
					{
						...
						value: function (e) {
							var t = this.elementVertical.scrollTop,
								...
								a = 0,
								r = this.rows();
							if (e) (o = this.vDomTop), (a = this.vDomBottom);
							else
								for (var s = this.vDomTop; s <= this.vDomBottom; s++)
									if (r[s])
										if (n) {
											...
											a = s;
										} else if (t - r[s].getElement().offsetTop >= 0) o = s;
										else {
											if (((n = !0), !(i - r[s].getElement().offsetTop >= 0)))
												break;
											a = s;
										}
					...
					},
					{
						...
						value: function (e, t, i) {
							var n = this.tableElement,
								o = this.elementVertical,
								a = 0,
								r = 0,
								s = 0,
								l = 0,
								...
								c = this.rows(),
								h = c.length,
								d = this.elementVertical.clientHeight;
							if (((i = i || 0), (e = e || 0))) {
								for (; n.firstChild; ) n.removeChild(n.firstChild);
								(s = (h - e + 1) * this.vDomRowHeight) < d &&
									(e -= Math.ceil((d - s) / this.vDomRowHeight)) < 0 &&
									(e = 0),
									(e -= a =
										Math.min(
											Math.max(
							...
							if (h && k.elVisible(this.elementVertical)) {
								for (
									this.vDomTop = e, this.vDomBottom = e - 1;
									(r <= d + this.vDomWindowBuffer ||
										u < this.vDomWindowMinTotalRows) &&
									this.vDomBottom < h - 1;
									...
									this.styleRow(f, p),
										...
										(m = f.getHeight()),
										u < a ? (l += m) : (r += m),
										m > this.vDomWindowBuffer &&
											(this.vDomWindowBuffer = 2 * m),
										this.vDomBottom++,
										u++;
								}
								e
									? ((this.vDomTopPad = t
											? this.vDomRowHeight * this.vDomTop + i
											: this.scrollTop - l),
									  (this.vDomBottomPad =
											this.vDomBottom == h - 1
												? 0
												: Math.max(
														this.vDomScrollHeight - this.vDomTopPad - r - l,
														0
												  )))
									: ((this.vDomTopPad = 0),
									  (this.vDomRowHeight = Math.floor((r + l) / u)),
									  (this.vDomBottomPad =
											this.vDomRowHeight * (h - this.vDomBottom - 1)),
									  (this.vDomScrollHeight = l + r + this.vDomBottomPad - d)),
									...
									t &&
										(this.scrollTop =
											...
											this.elementVertical.clientWidth
												? this.elementVertical.offsetHeight - d
												: 0)),
									(this.scrollTop = Math.min(
										this.scrollTop,
										this.elementVertical.scrollHeight - d
									)),
									this.elementVertical.scrollWidth >
										this.elementVertical.offsetWidth &&
										t &&
										(this.scrollTop += this.elementVertical.offsetHeight - d),
									(this.vDomScrollPosTop = this.scrollTop),
									(this.vDomScrollPosBottom = this.scrollTop),
									(o.scrollTop = this.scrollTop),
					...
					},
					{
						...
						value: function (e, t) {
							for (
								...
								if (
									((l = s.getHeight() || this.vDomRowHeight),
									(u = s.initialized),
									!(t >= l))
								)
									break;
								this.styleRow(s, a),
									i.insertBefore(s.getElement(), i.firstChild),
									(s.initialized && s.heightInitialized) || n.push(s),
									s.initialize(),
									u ||
										((l = s.getElement().offsetHeight) >
											this.vDomWindowBuffer &&
											(this.vDomWindowBuffer = 2 * l)),
									(t -= l),
									(o += l),
									this.vDomTop--,
									a--,
							...
							this._quickNormalizeRowHeight(n),
								o &&
									((this.vDomTopPad -= o),
									this.vDomTopPad < 0 &&
										(this.vDomTopPad = a * this.vDomRowHeight),
									a < 1 && (this.vDomTopPad = 0),
						...
						value: function (e, t) {
							...
							this._quickNormalizeRowHeight(n),
								o &&
									...
									(this.vDomBottomPad < 0 || a == e.length - 1) &&
										(this.vDomBottomPad = 0),
					...
					},
					{
						...
						value: function (e, t) {
							...
							n &&
								((this.vDomBottomPad += n),
								this.vDomBottomPad < 0 && (this.vDomBottomPad = 0),
								(this.tableElement.style.paddingBottom =
									this.vDomBottomPad + "px"),
								(this.vDomScrollPosBottom -= n));
						},
					},
					{
		...
		z = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).element = i.createHolderElement()),
					(i.tableElement = i.createTableElement()),
					(i.heightFixer = i.createTableElement()),
					(i.placeholder = null),
					(i.placeholderContents = null),
					(i.firstRender = !1),
					(i.renderMode = "virtual"),
					(i.fixedHeight = !1),
					(i.rows = []),
					(i.activeRowsPipeline = []),
					(i.activeRows = []),
					(i.activeRowsCount = 0),
					(i.displayRows = []),
					(i.displayRowsCount = 0),
					(i.scrollTop = 0),
					(i.scrollLeft = 0),
					(i.rowNumColumn = !1),
					(i.redrawBlock = !1),
					(i.redrawBlockRestoreConfig = !1),
					(i.redrawBlockRenderInPosition = !1),
					(i.dataPipeline = []),
					(i.displayPipeline = []),
					(i.renderer = null),
					i
				...
				o(r, [
					...
					},
					{
						...
						value: function () {
							var e = document.createElement("div");
							return (
								e.classList.add("tabulator-table"),
								e.setAttribute("role", "rowgroup"),
								e
							);
						},
					},
					{
						...
						value: function () {
							if ("string" == typeof this.table.options.placeholder) {
								...
								t.classList.add("tabulator-placeholder-contents"),
									(t.innerHTML = this.table.options.placeholder),
									e.appendChild(t),
									(this.placeholderContents = t),
									(this.placeholder = e);
							}
						},
					},
							...
							this.initializePlaceholder(),
								...
								this.element.addEventListener("scroll", function () {
									var t = e.element.scrollLeft,
										i = e.scrollLeft > t,
										n = e.element.scrollTop,
										o = e.scrollTop > n;
									e.scrollLeft != t &&
										((e.scrollLeft = t),
										e.dispatch("scroll-horizontal", t, i),
										e.dispatchExternal("scrollHorizontal", t, i),
										e._positionPlaceholder()),
										e.scrollTop != n &&
											((e.scrollTop = n),
											e.renderer.scrollRows(n, o),
											e.dispatch("scroll-vertical", n, o),
											e.dispatchExternal("scrollVertical", n, o));
								});
						},
					},
					{
					...
					},
					{
						...
						value: function (e, t, i) {
							var n = this;
							return new Promise(function (o, a) {
								t && n.getDisplayRows().length
									? n.table.options.pagination
										? n._setDataActual(e, !0)
										: n.reRenderInPosition(function () {
												n._setDataActual(e);
										  })
									: (n.table.options.autoColumns &&
											i &&
											n.table.initialized &&
											n.table.columnManager.generateColumnsFromRowData(e),
									  n.resetScroll(),
									  n._setDataActual(e)),
									o();
							});
					...
					},
					{
						...
						value: function (e, t) {
							var i = this.rows.indexOf(e),
								n = this.activeRows.indexOf(e);
							n > -1 && this.activeRows.splice(n, 1),
						...
						value: function (e, t, i) {
							...
							return new Promise(function (a, r) {
								(t = n.findAddRowPos(t)),
									...
									n.refreshActiveData(!1, !1, !0),
									n.regenerateRowNumbers(),
									o.length && n._clearPlaceholder(),
									a(o);
							});
						},
					},
					...
					},
					{
						...
						value: function (e, t, i, n) {
							var o,
								a,
								r = e instanceof D ? e : new D(e || {}, this),
								s = this.findAddRowPos(t),
								l = -1;
							return (
								i ||
									((a = this.chain("row-adding-position", [r, s], null, {
										index: i,
										top: s,
									})),
									(i = a.index),
								...
								(i = this.chain("row-adding-index", [r, i, s], null, i)) &&
									(l = this.rows.indexOf(i)),
								i && l > -1
									? ((o = this.activeRows.indexOf(i)),
									  ...
									  o > -1 && this.activeRows.splice(s ? o : o + 1, 0, r),
									  this.rows.splice(s ? l : l + 1, 0, r))
									: s
									? (this.displayRowIterator(function (e) {
											e.unshift(r);
									  }),
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							this.moveRowInArray(this.rows, e, t, i),
								...
								this.displayRowIterator(function (o) {
						...
						value: function (e, t) {
							...
							return (
								!1 !== i &&
									...
									(n = this.getDisplayRows()[i + 1]),
								!n || (n instanceof D && "row" == n.type)
									? n
									: this.nextDisplayRow(n, t)
							);
						},
					},
					{
						...
						value: function (e, t) {
							var i = this.getDisplayRowIndex(e),
								n = !1;
							return (
								i && (n = this.getDisplayRows()[i - 1]),
								!t || !n || (n instanceof D && "row" == n.type)
									? n
									: this.prevDisplayRow(n, t)
							);
						},
					},
					{
					...
					},
					{
						...
						value: function (e, t) {
							void 0 !== t
								? (this.dataPipeline.push({ handler: e, priority: t }),
					...
					},
					{
						...
						value: function (e, t) {
							void 0 !== t
								? (this.displayPipeline.push({ handler: e, priority: t }),
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							if ("function" == typeof e)
								if (
									(a = this.dataPipeline.findIndex(function (t) {
										return t.handler === e;
									})) > -1
								)
									(o = "dataPipeline"),
										t &&
											(a == this.dataPipeline.length - 1
												? (o = "display")
												: a++);
								else {
									if (
										!(
											(a = this.displayPipeline.findIndex(function (t) {
												return t.handler === e;
											})) > -1
										)
									)
									...
									(o = "displayPipeline"),
										t &&
											(a == this.displayPipeline.length - 1
												? (o = "end")
												: a++);
								}
							else (o = e || "all"), (a = 0);
							this.redrawBlock
								? (!this.redrawBlockRestoreConfig ||
										(this.redrawBlockRestoreConfig &&
											((this.redrawBlockRestoreConfig.stage === o &&
												a < this.redrawBlockRestoreConfig.index) ||
												r.indexOf(o) <
													r.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
								  (this.redrawBlockRestoreConfig = {
										handler: e,
										skipStage: t,
										renderInPosition: i,
								...
								: (k.elVisible(this.element)
										? i
											? this.reRenderInPosition(
													this.refreshPipelines.bind(this, e, o, a, i)
											  )
											: (this.refreshPipelines(e, o, a, i),
											  e || this.table.columnManager.renderer.renderColumns(),
											  this.renderTable(),
											  n.options.layoutColumnsOnNewData &&
													this.table.columnManager.redraw(!0))
										: this.refreshPipelines(e, o, a, i),
					...
					},
					{
						...
						value: function (e, t, i, n) {
							switch (
								...
								e || (this.activeRowsPipeline[0] = this.rows.slice(0)),
								t)
							) {
								case "all":
								case "dataPipeline":
									for (var o = i; o < this.dataPipeline.length; o++) {
										var a = this.dataPipeline[o].handler(
											this.activeRowsPipeline[o].slice(0)
										);
										this.activeRowsPipeline[o + 1] =
											a || this.activeRowsPipeline[o].slice(0);
									}
									this.setActiveRows(
								...
								case "displayPipeline":
									for (var r = i; r < this.displayPipeline.length; r++) {
										var s = this.displayPipeline[r].handler(
											(r ? this.getDisplayRows(r - 1) : this.activeRows).slice(
												0
											),
											n
										);
										this.setDisplayRows(
											s || this.getDisplayRows(r - 1).slice(0),
											r
										);
									}
							}
					...
					},
					{
						...
						value: function (e) {
							...
							switch (e) {
								...
								default:
									t =
										this.chain("rows-retrieve", e, null, this.rows) ||
										this.rows;
							}
							return t;
						},
					...
					},
					{
						...
						value: function () {
							var e,
								t = { virtual: P, basic: S };
							(e =
								"string" == typeof this.table.options.renderVertical
									? t[this.table.options.renderVertical]
							...
							this.dispatchExternal("renderStarted"),
								...
								this.displayRowsCount
									? (this.renderer.renderRows(),
									  this.firstRender &&
											((this.firstRender = !1), this.layoutRefresh()))
					...
					},
					{
						...
						value: function () {
							this.placeholder &&
								...
								(this.placeholderContents.style.marginLeft =
									this.scrollLeft + "px"));
						},
					},
					{
						...
						value: function () {
							...
							if ("fill" === this.renderer.verticalFillMode) {
								...
								this.fixedHeight
									? ((this.element.style.minHeight =
											"calc(100% - " + t + "px)"),
									  (this.element.style.height = "calc(100% - " + t + "px)"),
									  (this.element.style.maxHeight = "calc(100% - " + t + "px)"))
									: ((this.element.style.height = ""),
									  (this.element.style.height =
											this.table.element.clientHeight - t + "px"),
									  (this.element.scrollTop = this.scrollTop)),
									this.renderer.resize(),
									this.fixedHeight ||
										e == this.element.clientHeight ||
										(this.subscribed("table-resize")
						...
						value: function () {
							(this.redrawBlock = !1),
								this.redrawBlockRestoreConfig
									...
									: this.redrawBlockRenderInPosition &&
									  this.reRenderInPosition(),
		...
		F = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).active = !1),
					(i.element = i.createElement()),
					(i.containerElement = i.createContainerElement()),
					(i.external = !1),
					i
				);
			}
				...
				o(r, [
					...
					},
					{
						...
						value: function () {
							var e = document.createElement("div");
							return (
								e.classList.add("tabulator-footer-contents"),
					...
					},
					{
						...
						value: function () {
							if (this.table.options.footerElement)
								switch (e(this.table.options.footerElement)) {
									case "string":
		...
		H = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).el = null),
					(o.abortClasses = ["tabulator-headers", "tabulator-table"]),
					(o.previousTargets = {}),
					(o.listeners = [
						"click",
						"dblclick",
			...
			return (
				o(n, [
					...
					},
					{
						...
						value: function () {
							...
							Object.keys(this.pseudoTrackers).forEach(function (t) {
								(e.pseudoTrackers[t].subscriber = e.pseudoMouseEnter.bind(
									e,
									t
								)),
									e.subscribe(t + "-mouseover", e.pseudoTrackers[t].subscriber);
							}),
					...
					},
					{
						...
						value: function (e, t) {
							var i = this,
								n = Object.keys(this.pseudoTrackers),
								o = { row: ["cell"], cell: ["row"] };
							(n = n.filter(function (t) {
								...
								i.pseudoTrackers[e].target &&
									(i.dispatch(e + "-mouseleave", t, n),
									(i.pseudoTrackers[e].target = null));
							});
						},
					},
					{
						...
						value: function () {
							for (
								var e = Object.keys(this.listeners),
									t = 0,
									i = Object.values(this.componentMap);
								t < i.length;
								t++
							) {
								var n,
								...
								try {
									for (a.s(); !(n = a.n()).done; ) {
										...
										this.subscriptionChange(
											s,
											this.subscriptionChanged.bind(this, o, r)
										);
									}
								} catch (e) {
									a.e(e);
					...
					},
					{
						...
						value: function (e, t, i) {
							var n = this.listeners[t].components,
								o = n.indexOf(e),
								a = !1;
							i
								? -1 === o && (n.push(e), (a = !0))
								: this.subscribed(e + "-" + t) ||
								  (o > -1 && (n.splice(o, 1), (a = !0))),
					...
					},
					{
						...
						value: function () {
							for (var e in this.listeners) {
								...
								t.components.length
									? t.handler ||
									  ((t.handler = this.track.bind(this, e)),
									  this.el.addEventListener(e, t.handler))
									: t.handler &&
									  (this.el.removeEventListener(e, t.handler),
									  (t.handler = null));
							}
						},
					},
					{
						...
						value: function (e, t) {
							var i = (t.composedPath && t.composedPath()) || t.path,
								n = this.findTargets(i);
							(n = this.bindComponents(e, n)),
								this.triggerEvents(e, t, n),
								!this.pseudoTracking ||
									("mouseover" != e && "mouseleave" != e) ||
									Object.keys(n).length ||
									this.pseudoMouseLeave("none", t);
						},
					},
					{
						key: "findTargets",
						value: function (e) {
							var t,
								i = this,
								n = {},
								o = Object.keys(this.componentMap),
								a = f(e);
							try {
								for (a.s(); !(t = a.n()).done; ) {
									var r = t.value,
										s = r.classList ? d(r.classList) : [];
									if (
										s.filter(function (e) {
							...
							try {
								var l = function () {
									var e = i.value,
										o = void 0,
										s = t[e],
										l = n.previousTargets[e];
									if (l && l.target === s) o = l.component;
									else
										switch (e) {
											case "row":
											case "group":
												if (
													a.components.includes("row") ||
													a.components.includes("cell") ||
													a.components.includes("group")
												)
													(o = n.table.rowManager
														.getVisibleRows(!0)
														.find(function (e) {
														...
														t.row &&
															t.row.parentNode &&
															t.row.parentNode.closest(".tabulator-row") &&
															(t[e] = !1);
												break;
											case "column":
												a.components.includes("column") &&
													(o = n.table.columnManager.findColumn(s));
												break;
											case "cell":
												a.components.includes("cell") &&
													(t.row instanceof D
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							for (var o in i)
								i[o] &&
									n.components.includes(o) &&
									this.dispatch(o + "-" + e, t, i[o]);
						},
					},
					{
						key: "clearWatchers",
					...
					},
					{
						...
						value: function (e, t, i) {
							if (
								this.bindings[e] &&
								this.bindings[e][i] &&
								"function" == typeof this.bindings[e][i].bind
							)
		...
		O = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).requestOrder = 0),
					(i.loading = !1),
					i
				);
			}
			return (
				o(r, [
						...
						value: function (t, i, n, o, a, r) {
							...
							return (
								...
								!t ||
									...
									(t = JSON.parse(t)),
								this.confirm("data-loading", [t, i, n, a])
									? ((this.loading = !0),
									  a || this.alertLoader(),
									  (i = this.chain(
											"data-params",
									  ...
									  (i = this.mapParams(i, this.table.options.dataSendParams)),
									  this.chain(
											"data-load",
											[t, i, n, a],
											!1,
											...
											.then(function (t) {
												Array.isArray(t) ||
													...
													(t = s.mapParams(
														t,
														s.objectInvert(s.table.options.dataReceiveParams)
													));
												var i = s.chain("data-loaded", t, null, t);
												l == s.requestOrder
													? (s.clearAlert(),
													  !1 !== i &&
															(s.dispatchExternal("dataLoaded", i),
															s.table.rowManager.setData(
																i,
																o,
																void 0 === r ? !o : r
															)))
											...
											.catch(function (e) {
												console.error("Data Load Error: ", e),
													s.dispatchExternal("dataLoadError", e),
													a || s.alertError(),
													setTimeout(function () {
														s.clearAlert();
									...
									: (this.dispatchExternal("dataLoaded", t),
									  t || (t = []),
									  this.table.rowManager.setData(t, o, void 0 === r ? !o : r),
									  Promise.resolve())
							);
						},
					},
					...
					},
					{
						...
						value: function () {
							this.table.alertManager.alert(
								this.table.options.dataLoaderError ||
									this.langText("data|error"),
								"error"
							);
						},
					},
				...
				o(e, [
					{
						key: "subscriptionChange",
						value: function (e, t) {
							this.subscriptionNotifiers[e] ||
								(this.subscriptionNotifiers[e] = []),
								this.subscriptionNotifiers[e].push(t),
								this.subscribed(e) && this._notifiySubscriptionChange(e, !0);
						},
					},
					{
						key: "subscribe",
						...
						value: function (e, t) {
							...
							if (this.events[e]) {
								if (t) {
									if (
										!(
											(i = this.events[e].findIndex(function (e) {
												return e === t;
											})) > -1
										)
									)
					...
					},
					{
						...
						value: function () {
							...
							return (
								this.events[n] &&
									this.events[n].forEach(function (n, o) {
					...
					},
					{
						...
						value: function () {
							var e,
								...
								i = t[0];
							((t[0] = "ExternalEvent:" + t[0]),
							!0 === this.debug || this.debug.includes(i)) &&
								(e = console).log.apply(e, d(t));
			...
			function e(i) {
				t(this, e),
					...
					(this.dispatch = i
						...
						: this._dispatch.bind(this)),
					(this.chain = i
						? this._debugChain.bind(this)
						: this._chain.bind(this)),
					(this.confirm = i
						...
						value: function (e, t) {
							var i =
								arguments.length > 2 && void 0 !== arguments[2]
									...
									: 1e4;
							this.events[e] || (this.events[e] = []),
								this.events[e].push({ callback: t, priority: i }),
					...
					},
					{
						...
						value: function (e, t, i, n) {
							...
							return (
								Array.isArray(t) || (t = [t]),
								this.subscribed(e)
									? (this.events[e].forEach(function (e, i) {
					...
					},
					{
						...
						value: function (e, t) {
							...
							return (
								Array.isArray(t) || (t = [t]),
								this.subscribed(e) &&
									this.events[e].forEach(function (e, o) {
					...
					},
					{
						...
						value: function () {
							var e = this,
								...
								i = t.shift();
							this.events[i] &&
								this.events[i].forEach(function (i) {
					...
					},
					{
						...
						value: function (t, i) {
							var n,
								...
								a = [];
							if ("string" == typeof t) {
								if ((n = document.querySelectorAll(t)).length)
									for (var r = 0; r < n.length; r++)
										(o = e.matchElement(n[r])) && a.push(o);
							} else
								("undefined" != typeof HTMLElement &&
									t instanceof HTMLElement) ||
								t instanceof Y
									? (o = e.matchElement(t)) && a.push(o)
									: Array.isArray(t)
	...
	var N = (function (e) {
			...
			function n(e, o, a) {
				...
				return (
					t(this, n),
					((r = i.call(this, e)).element = o),
					(r.container = r._lookupContainer()),
					(r.parent = a),
					(r.reversedX = !1),
					(r.childPopup = null),
					(r.blurable = !1),
					(r.blurCallback = null),
					(r.renderedCallback = null),
					(r.visible = !1),
					r.element.classList.add("tabulator-popup-container"),
					(r.blurEvent = r.hide.bind(l(r), !1)),
					(r.escEvent = r._escapeCheck.bind(l(r))),
					(r.destroyBinding = r.tableDestroyed),
					(r.destroyed = !1),
					r
				);
			}
				...
				o(n, [
						...
						value: function () {
							...
							return (
								"string" == typeof e
									...
									: !0 === e && (e = this.table.element),
								e &&
									!this._checkContainerIsParent(e) &&
									((e = !1),
									console.warn(
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								e === t ||
								(!!t.parentNode &&
									this._checkContainerIsParent(e, t.parentNode))
							);
						},
					},
					{
							...
							return (
								this.destroyed ||
									...
									(e instanceof HTMLElement
										? ((o = e),
										  (a = (r = this.elementPositionCoords(e, t)).offset),
										  (i = r.x),
										  (n = r.y))
										: "number" == typeof e
										? ((a = { top: 0, left: 0 }), (i = e), (n = t))
										: ((i = (r = this.containerEventCoords(e)).x),
										  (n = r.y),
										  (this.reversedX = !1)),
									(this.element.style.top = n + "px"),
									(this.element.style.left = i + "px"),
									this.container.appendChild(this.element),
									"function" == typeof this.renderedCallback &&
										this.renderedCallback(),
									this._fitToScreen(i, n, o, a, t),
									(this.visible = !0),
							...
							if (
								((e + this.element.offsetWidth >= this.container.offsetWidth ||
									...
									(this.element.style.right = i
										? this.container.offsetWidth - n.left + "px"
										: this.container.offsetWidth - e + "px"),
									(this.reversedX = !0)),
								t + this.element.offsetHeight >
									Math.max(
										this.container.offsetHeight,
										a ? this.container.scrollHeight : 0
									))
							)
								if (i)
									switch (o) {
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								...
								this.visible &&
									(setTimeout(function () {
										t.table.rowManager.element.addEventListener(
											"scroll",
											t.blurEvent
										),
											t.subscribe("cell-editing", t.blurEvent),
											document.body.addEventListener("click", t.blurEvent),
											document.body.addEventListener(
												"contextmenu",
												t.blurEvent
											),
											document.body.addEventListener("mousedown", t.blurEvent),
											window.addEventListener("resize", t.blurEvent),
											document.body.addEventListener("keydown", t.escEvent);
									}, 100),
									(this.blurCallback = e)),
								this
							);
					...
					},
					{
						...
						value: function (e) {
							return (
								this.childPopup && this.childPopup.hide(),
								(this.childPopup = new n(this.table, e, this)),
								this.childPopup
							);
						},
					},
	...
	var j = {
			fitData: function (e) {
				this.table.columnManager.renderer.reinitializeColumnWidths(e),
					this.table.options.responsiveLayout &&
						this.table.modExists("responsiveLayout", !0) &&
						this.table.modules.responsiveLayout.update();
			},
			...
			fitDataStretch: function (e) {
				var t = this,
					i = 0,
					n = this.table.rowManager.element.clientWidth,
					o = 0,
					a = !1;
				e.forEach(function (e, n) {
					...
					a
						? ((o = n - i + a.getWidth()),
						  this.table.options.responsiveLayout &&
								this.table.modExists("responsiveLayout", !0) &&
								(a.setWidth(0), this.table.modules.responsiveLayout.update()),
						  o > 0 ? a.setWidth(o) : a.reinitializeWidth())
						: this.table.options.responsiveLayout &&
						  this.table.modExists("responsiveLayout", !0) &&
						  this.table.modules.responsiveLayout.update();
			},
			fitColumns: function (e) {
				var t,
					i,
					n = this.table.element.clientWidth,
					o = 0,
					a = 0,
					r = 0,
					s = [],
				...
				function d(e, t, i, n) {
					...
					return (
						e.forEach(function (e, a) {
							...
							e.column.minWidth >= r
								? o.push(e)
								: e.column.maxWidth && e.column.maxWidth < r
						...
						o.length
							? (o.forEach(function (e) {
									(a += n ? e.width - e.column.minWidth : e.column.minWidth),
										(e.width = e.column.minWidth);
							  }),
							  (c = (s = t - a) - (l = m ? Math.floor(s / m) : s) * m),
							  (c += d(p, s, l, n)))
							: ((c = m ? t - Math.floor(t / m) * m : t),
				...
				this.table.options.responsiveLayout &&
					...
					(t = Math.floor(a / r)),
					(c = d(s, a, t, !1)),
					s.length && c > 0 && (s[s.length - 1].width += +c),
					s.forEach(function (e) {
						a -= e.width;
					}),
					(i = Math.abs(c) + a) > 0 &&
						u &&
						(c = d(l, i, Math.floor(i / u), !0)),
		...
		G = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e, "layout")).mode = null),
					o.registerTableOption("layout", "fitData"),
					o.registerTableOption("layoutColumnsOnNewData", !1),
					o.registerColumnOption("widthGrow"),
					o.registerColumnOption("widthShrink"),
					o
				);
			}
			return (
	...
	var U = (function (i) {
		...
		function r(e) {
			...
			return (
				t(this, r),
				((i = n.call(this, e)).locale = "default"),
				(i.lang = !1),
				(i.bindings = {}),
				(i.langList = {}),
				i.registerTableOption("locale", !1),
				i.registerTableOption("langs", {}),
				i
			);
		}
		return (
			o(r, [
				{
					key: "initialize",
					value: function () {
						for (var e in ((this.langList = k.deepClone(r.langs)),
						!1 !== this.table.options.columnDefaults.headerFilterPlaceholder &&
				...
				},
				{
					...
					value: function (t) {
						...
						(this.locale = t),
							(this.lang = k.deepClone(this.langList.default || {})),
							"default" != t &&
								(function t(i, n) {
									for (var o in i)
										"object" == e(i[o])
				...
				},
				{
					...
					value: function (e) {
						var t = this,
							i = [];
						return (
							I.lookupTable(e).forEach(function (e) {
								t.table !== e && i.push(e);
							}),
							i
						);
	...
	var q = Object.freeze({
		...
		K = (function () {
			function i(e, n) {
				t(this, i),
					this.bindStaticFuctionality(e),
					this.bindModules(e, q, !0),
					n && this.bindModules(e, n);
			}
			return (
				o(i, [
					{
						...
						value: function (t) {
							(t.moduleBindings = {}),
								(t.extendModule = function (i, n, o) {
									if (t.moduleBindings[i]) {
										var a = t.moduleBindings[i][n];
										if (a)
											if ("object" == e(o)) for (var r in o) a[r] = o[r];
											else
												console.warn(
										...
										console.warn("Module Error - module does not exist:", i);
								}),
								...
								(t.prototype.bindModules = function () {
									...
									for (var o in ((this.modules = {}), t.moduleBindings)) {
										var a = t.moduleBindings[o],
											r = new a(this);
										(this.modules[o] = r),
											a.prototype.moduleCore
												? this.modulesCore.push(r)
												: a.moduleInitOrder
												? a.moduleInitOrder < 0
													? e.push(r)
													: i.push(r)
		...
		J = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).element = o._createAlertElement()),
					(o.msgElement = o._createMsgElement()),
					(o.type = null),
					o.element.appendChild(o.msgElement),
					o
				);
			}
			return (
				o(n, [
					...
					},
					{
						...
						value: function () {
							var e = document.createElement("div");
							return (
								e.classList.add("tabulator-alert-msg"),
		...
		Y = (function () {
			function i(e, n) {
				...
				t(this, i),
					...
					(this.componentFunctionBinder = new _(this)),
					(this.dataLoader = !1),
					(this.modules = {}),
					(this.modulesCore = []),
					(this.modulesRegular = []),
					(this.optionsList = new E(this, "table constructor")),
					(this.initialized = !1),
					(this.destroyed = !1),
					this.initializeElement(e) &&
						(this.initializeCoreSystems(n),
						setTimeout(function () {
							o._create();
						})),
					I.register(this);
			...
			return (
				o(i, [
					...
					},
					{
						...
						value: function (e) {
							(this.columnManager = new M(this)),
								(this.rowManager = new z(this)),
								(this.footerManager = new F(this)),
								(this.dataLoader = new O(this)),
								(this.alertManager = new J(this)),
								this.bindModules(),
								(this.options = this.optionsList.generate(i.defaultOptions, e)),
								this._clearObjectPointers(),
								this._mapDeprecatedFunctionality(),
								(this.externalEvents = new A(
									this,
									this.options,
									this.options.debugEventsExternal
								)),
								(this.eventBus = new B(this.options.debugEventsInternal)),
								(this.interactionMonitor = new H(this)),
					...
					},
					{
						...
						value: function () {
							(this.options.columns = this.options.columns.slice(0)),
								Array.isArray(this.options.data) &&
					...
					},
					{
						...
						value: function () {
							...
							if ("TABLE" === i.tagName) {
								...
								var o = i.attributes;
								for (var a in o)
									"object" == e(o[a]) && t.setAttribute(o[a].name, o[a].value);
								i.parentNode.replaceChild(t, i), (this.element = i = t);
							}
							for (
								i.classList.add("tabulator"), i.setAttribute("role", "grid");
								i.firstChild;

							)
								i.removeChild(i.firstChild);
							n.height &&
								((n.height = isNaN(n.height) ? n.height : n.height + "px"),
								(i.style.height = n.height)),
								!1 !== n.minHeight &&
									((n.minHeight = isNaN(n.minHeight)
										? n.minHeight
										: n.minHeight + "px"),
									(i.style.minHeight = n.minHeight)),
								!1 !== n.maxHeight &&
									((n.maxHeight = isNaN(n.maxHeight)
										? n.maxHeight
										: n.maxHeight + "px"),
									(i.style.maxHeight = n.maxHeight));
						},
					},
					{
						...
						value: function () {
							...
							this.interactionMonitor.initialize(),
								...
								this._detectBrowser(),
								this.modulesCore.forEach(function (e) {
									e.initialize();
								}),
								...
								t.autoColumns &&
									t.data &&
									this.columnManager.generateColumnsFromRowData(
										this.options.data
									),
								this.modulesRegular.forEach(function (e) {
									e.initialize();
								}),
								...
								this.options.debugInitialization &&
									...
									(e ||
										(e =
											" " ==
											(n =
												"Error" == (i = new Error().stack.split("\n"))[0]
													? i[2]
													: i[1])[0]
												? n.trim().split(" ")[1].split(".")[1]
												: n.trim().split("@")[0]),
									console.warn(
						...
						value: function (e, t, i) {
							...
							return (
								...
								new Promise(function (o, a) {
									n.dataLoader.blockActiveLoad(),
										"string" == typeof e && (e = JSON.parse(e)),
										e
											? n.rowManager.addRows(e, t, i).then(function (e) {
													var t = [];
													e.forEach(function (e) {
														t.push(e.getComponent());
													}),
					...
					},
					{
						...
						value: function (e) {
							...
							try {
								for (o.s(); !(n = o.n()).done; ) {
									var a = n.value,
										r = this.rowManager.findRow(a, !0);
									if (!r)
										return (
											console.error("Delete Error - No matching row found:", a),
					...
					},
					{
						...
						value: function (e, t, i) {
							return (
								this.initGuard(),
								"string" == typeof e && (e = JSON.parse(e)),
								this.rowManager.addRows(e, t, i).then(function (e) {
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return n
								? this.rowManager.scrollToRow(n, t, i)
					...
					},
					{
						...
						value: function (e, t) {
							...
							return i
								...
								: (console.warn("Position Error - No matching row found:", e),
								  !1);
						},
					},
					{
					...
					},
					{
						...
						value: function (e) {
							...
							return t
								? t.getComponent()
								: (console.warn("Find Error - No matching column found:", e),
								  !1);
						},
					},
					{
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return (
								this.initGuard(),
								this.columnManager.addColumn(e, t, n).then(function (e) {
									return e.getComponent();
								})
							);
						},
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							this.initGuard(),
								n
									? o
										? this.columnManager.moveColumn(n, o, i)
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return new Promise(function (o, a) {
								...
								return r
									? n.columnManager.scrollToColumn(r, t, i)
									: (console.warn(
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								t || console.error("Tabulator module not installed: " + e), t
							);
						},
					},
				]),
	...
	var $ = (function (i) {
		...
		function r(e) {
			...
			return (
				...
				i.registerColumnOption("accessor"),
				i.registerColumnOption("accessorParams"),
				i.registerColumnOption("accessorData"),
				i.registerColumnOption("accessorDataParams"),
				i.registerColumnOption("accessorDownload"),
				i.registerColumnOption("accessorDownloadParams"),
				i.registerColumnOption("accessorClipboard"),
				i.registerColumnOption("accessorClipboardParams"),
				i.registerColumnOption("accessorPrint"),
				i.registerColumnOption("accessorPrintParams"),
				i.registerColumnOption("accessorHtmlOutput"),
				i.registerColumnOption("accessorHtmlOutputParams"),
				i
			);
		}
		return (
				...
				},
				{
					...
					value: function (e) {
						...
						this.allowedTypes.forEach(function (o) {
							var a,
								r = "accessor" + (o.charAt(0).toUpperCase() + o.slice(1));
							e.definition[r] &&
								(a = t.lookupAccessor(e.definition[r])) &&
								((i = !0),
								(n[r] = {
									accessor: a,
					...
					value: function (e, t) {
						...
						return (
							this.table.columnManager.traverse(function (e) {
								...
								e.modules.accessor &&
									(r =
										e.modules.accessor[i] ||
										e.modules.accessor.accessor ||
										!1) &&
									"undefined" != (a = e.getFieldValue(o)) &&
									((l = e.getComponent()),
									(s =
										"function" == typeof r.params
											? r.params(a, o, t, l, n)
											: r.params),
									e.setFieldValue(o, r.accessor(a, o, t, s, l, n)));
							}),
							o
						);
					},
	...
	function Z(t, i) {
		...
		if (((i = i || ""), Array.isArray(t)))
			...
			for (var o in t) n = n.concat(Z(t[o], i ? i + "[" + o + "]" : o));
		else n.push({ key: i, value: t });
		return n;
	}
	function Q(e) {
		var t = Z(e),
	...
	function te(t, i) {
		...
		if (((i = i || ""), Array.isArray(t)))
			...
			for (var o in t) n = n.concat(te(t[o], i ? i + "[" + o + "]" : o));
		else n.push({ key: i, value: t });
		return n;
	}
	var ie = {
		...
		ne = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).config = {}),
					(o.url = ""),
					(o.urlGenerator = !1),
					(o.params = !1),
					(o.loaderPromise = !1),
					o.registerTableOption("ajaxURL", !1),
					o.registerTableOption("ajaxURLGenerator", !1),
					o.registerTableOption("ajaxParams", {}),
					o.registerTableOption("ajaxConfig", "get"),
					o.registerTableOption("ajaxContentType", "form"),
					o.registerTableOption("ajaxRequestFunc", !1),
					o.registerTableOption("ajaxRequesting", function () {}),
					o.registerTableOption("ajaxResponse", !1),
					(o.contentTypeFormatters = n.contentTypeFormatters),
					o
				);
			}
			return (
				o(n, [
					{
						...
						value: function () {
							(this.loaderPromise =
								this.table.options.ajaxRequestFunc || n.defaultLoaderPromise),
								(this.urlGenerator =
									this.table.options.ajaxURLGenerator || n.defaultURLGenerator),
								this.table.options.ajaxURL &&
								...
								this.subscribe(
									"data-loading",
									this.requestDataCheck.bind(this)
								),
					...
					},
					{
						...
						value: function (e, t, i, n) {
							...
							return (
								o &&
									("function" == typeof o && (o = o.call(this.table)),
									(n = Object.assign(n, o))),
								n
							);
						},
					...
					},
					{
						...
						value: function (e, t, i, n, o) {
							var a;
							return !o && this.requestDataCheck(e)
								? (e && this.setUrl(e),
								  (a = this.generateConfig(i)),
								  this.sendRequest(this.url, t, a))
								: o;
						},
					},
					{
						...
						value: function () {
							var e =
								arguments.length > 0 && void 0 !== arguments[0]
									? arguments[0]
									: {};
							(this.config = Object.assign({}, n.defaultConfig)),
								"string" == typeof e
					...
					},
					{
						...
						value: function () {
							...
							return (
								"string" == typeof e ? (t.method = e) : Object.assign(t, e), t
							);
						},
					},
					{
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return !1 !==
								...
								? this.loaderPromise(e, i, t).then(function (i) {
										return (
											n.table.options.ajaxResponse &&
												(i = n.table.options.ajaxResponse.call(
													n.table,
													e,
													t,
													i
	...
	(ne.moduleName = "ajax"),
		(ne.defaultConfig = { method: "GET" }),
		(ne.defaultURLGenerator = ee),
		(ne.defaultLoaderPromise = function (t, i, n) {
			var o,
				a = this;
			return new Promise(function (r, s) {
				if (
					((t = a.urlGenerator.call(a.table, t, i, n)),
					"GET" != i.method.toUpperCase())
				)
					if (
						(o =
							"object" === e(a.table.options.ajaxContentType)
								? a.table.options.ajaxContentType
								: a.contentTypeFormatters[a.table.options.ajaxContentType])
					) {
						for (var l in o.headers)
							i.headers || (i.headers = {}),
								void 0 === i.headers[l] && (i.headers[l] = o.headers[l]);
				...
				t
					? (void 0 === i.headers && (i.headers = {}),
					  void 0 === i.headers.Accept &&
							(i.headers.Accept = "application/json"),
					  void 0 === i.headers["X-Requested-With"] &&
							(i.headers["X-Requested-With"] = "XMLHttpRequest"),
					  void 0 === i.mode && (i.mode = "cors"),
					  "cors" == i.mode
							? (void 0 === i.headers.Origin &&
									(i.headers.Origin = window.location.origin),
							  void 0 === i.credentials && (i.credentials = "same-origin"))
							: void 0 === i.credentials && (i.credentials = "include"),
					  fetch(t, i)
							.then(function (e) {
								e.ok
									? e
	...
	var oe = (function (i) {
		...
		function r(e) {
			...
			return (
				t(this, r),
				((i = n.call(this, e)).mode = !0),
				(i.pasteParser = function () {}),
				(i.pasteAction = function () {}),
				(i.customSelection = !1),
				(i.rowRange = !1),
				(i.blocked = !0),
				i.registerTableOption("clipboard", !1),
				i.registerTableOption("clipboardCopyStyled", !0),
				i.registerTableOption("clipboardCopyConfig", !1),
				i.registerTableOption("clipboardCopyFormatter", !1),
				i.registerTableOption("clipboardCopyRowRange", "active"),
				i.registerTableOption("clipboardPasteParser", "table"),
				i.registerTableOption("clipboardPasteAction", "insert"),
				i.registerColumnOption("clipboard"),
				i.registerColumnOption("titleClipboard"),
				i
			);
		}
		return (
			o(r, [
									...
									if (!e.blocked) {
										if ((t.preventDefault(), e.customSelection))
											(i = e.customSelection),
												e.table.options.clipboardCopyFormatter &&
													(i = e.table.options.clipboardCopyFormatter(
														"plain",
														i
													));
										else {
											var o = e.table.modules.export.generateExportList(
												e.table.options.clipboardCopyConfig,
												e.table.options.clipboardCopyStyled,
												e.rowRange,
												"clipboard"
											);
											(i = (n = e.table.modules.export.genereateHTMLTable(o))
												? e.generatePlainContent(o)
												: ""),
												e.table.options.clipboardCopyFormatter &&
													((i = e.table.options.clipboardCopyFormatter(
														"plain",
													...
													(n = e.table.options.clipboardCopyFormatter(
														"html",
														n
													)));
										}
										window.clipboardData && window.clipboardData.setData
											...
											? (t.clipboardData.setData("text/plain", i),
											  n && t.clipboardData.setData("text/html", n))
											: t.originalEvent &&
											...
											e.dispatchExternal("clipboardCopied", i, n),
											e.reset();
									}
								}),
						...
						return (
							t.forEach(function (t) {
								...
								t.columns.forEach(function (i) {
									...
									if (i)
										if (
											("group" === t.type && (i.value = i.component.getKey()),
											null === i.value)
										)
											o = "";
										else
				...
				},
				{
					...
					value: function (e, t) {
						...
						(this.blocked = !1),
							...
							(!0 !== this.mode && "copy" !== this.mode) ||
								((this.rowRange =
									e || this.table.options.clipboardCopyRowRange),
				...
				},
				{
					...
					value: function (t) {
						switch (e(t)) {
							case "string":
								(this.pasteAction = r.pasteActions[t]),
									this.pasteAction ||
										console.warn(
				...
				},
				{
					...
					value: function (t) {
						switch (e(t)) {
							case "string":
								(this.pasteParser = r.pasteParsers[t]),
									this.pasteParser ||
										console.warn(
						...
						this.checkPaseOrigin(e) &&
							...
							(i = this.pasteParser.call(this, t))
								? (e.preventDefault(),
								  ...
								  (n = this.pasteAction.call(this, i)),
								  this.dispatchExternal("clipboardPasted", t, i, n))
								: this.dispatchExternal("clipboardPasteError", t));
					},
				},
				{
					key: "mutateData",
					value: function (e) {
						...
						return (
							Array.isArray(e)
								? e.forEach(function (e) {
										i.push(
											t.table.modules.mutator.transformRow(e, "clipboard")
										);
								  })
								: (i = e),
							i
	...
	(oe.moduleName = "clipboard"),
		...
		(oe.pasteParsers = {
			table: function (e) {
				var t = [],
					i = !0,
					n = this.table.columnManager.columns,
					o = [],
					a = [];
				return (
					(e = e.split("\n")).forEach(function (e) {
	...
	var ae = (function () {
		...
		se = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).topCalcs = []),
					(i.botCalcs = []),
					(i.genColumn = !1),
					(i.topElement = i.createElement()),
					(i.botElement = i.createElement()),
					(i.topRow = !1),
					(i.botRow = !1),
					(i.topInitialized = !1),
					(i.botInitialized = !1),
					i.registerTableOption("columnCalcs", !0),
					i.registerColumnOption("topCalc"),
					i.registerColumnOption("topCalcParams"),
					i.registerColumnOption("topCalcFormatter"),
					i.registerColumnOption("topCalcFormatterParams"),
					i.registerColumnOption("bottomCalc"),
					i.registerColumnOption("bottomCalcParams"),
					i.registerColumnOption("bottomCalcFormatter"),
					i.registerColumnOption("bottomCalcFormatterParams"),
					i
				);
			}
			return (
				o(r, [
					...
					},
					{
						...
						value: function () {
							(this.genColumn = new C({ field: "value" }, this)),
								...
								this.subscribe(
									"column-moved",
									this.recalcActiveRows.bind(this)
								),
					...
					},
					{
						...
						value: function (e, t) {
							return (
								this.topRow && t.unshift(this.topRow),
					...
					},
					{
						...
						value: function (e) {
							(e.column.definition.topCalc || e.column.definition.bottomCalc) &&
								(this.table.options.groupBy
									? (("table" != this.table.options.columnCalcs &&
											"both" != this.table.options.columnCalcs) ||
											this.recalcActiveRows(),
									  "table" != this.table.options.columnCalcs &&
											this.recalcRowGroup(e.row))
									: this.recalcActiveRows());
						},
					},
					{
						...
						value: function (e) {
							(e.definition.topCalc || e.definition.bottomCalc) &&
					...
					},
					{
						...
						value: function (t) {
							var i = t.definition,
								n = {
									topCalcParams: i.topCalcParams || {},
									botCalcParams: i.bottomCalcParams || {},
								};
							if (i.topCalc) {
								switch (e(i.topCalc)) {
									case "string":
										r.calculations[i.topCalc]
											? (n.topCalc = r.calculations[i.topCalc])
											: console.warn(
							...
							if (i.bottomCalc) {
								switch (e(i.bottomCalc)) {
									case "string":
										r.calculations[i.bottomCalc]
											? (n.botCalc = r.calculations[i.bottomCalc])
											: console.warn(
													"Column Calc Error - No such calculation found, ignoring: ",
													i.bottomCalc
											  );
							...
							return (
								...
								(i.generateCells = function () {
									...
									n.table.columnManager.columnsByIndex.forEach(function (o) {
										n.genColumn.setField(o.getField()),
											(n.genColumn.hozAlign = o.hozAlign),
											o.definition[e + "CalcFormatter"] &&
											n.table.modExists("format")
												? (n.genColumn.modules.format = {
														formatter: n.table.modules.format.getFormatter(
															o.definition[e + "CalcFormatter"]
														),
														params:
															o.definition[e + "CalcFormatterParams"] || {},
												  })
												: (n.genColumn.modules.format = {
														formatter:
															n.table.modules.format.getFormatter("plaintext"),
														params: {},
												  }),
					...
					},
					{
						...
						value: function (e, t) {
							var i,
								n,
								o = {},
								a = "top" == e ? this.topCalcs : this.botCalcs,
							...
							return (
								a.forEach(function (e) {
									...
									e.modules.columnCalcs &&
										...
										(n = r + "Params"),
										(i =
											"function" == typeof e.modules.columnCalcs[n]
												? e.modules.columnCalcs[n](a, t)
												: e.modules.columnCalcs[n]),
										e.setFieldValue(o, e.modules.columnCalcs[r](a, t, i)));
								}),
								o
							);
						},
	...
	var le = (function (i) {
		...
		function r(e) {
			...
			return (
				t(this, r),
				((i = n.call(this, e)).indent = 10),
				(i.field = ""),
				(i.collapseEl = null),
				(i.expandEl = null),
				(i.branchEl = null),
				(i.elementField = !1),
				(i.startOpen = function () {}),
				(i.displayIndex = 0),
				i.registerTableOption("dataTree", !1),
				i.registerTableOption("dataTreeFilter", !0),
				i.registerTableOption("dataTreeSort", !0),
				i.registerTableOption("dataTreeElementColumn", !1),
				i.registerTableOption("dataTreeBranchElement", !0),
				i.registerTableOption("dataTreeChildIndent", 9),
				i.registerTableOption("dataTreeChildField", "_children"),
				i.registerTableOption("dataTreeCollapseElement", !1),
				i.registerTableOption("dataTreeExpandElement", !1),
				i.registerTableOption("dataTreeStartExpanded", !1),
				i.registerTableOption("dataTreeChildColumnCalcs", !1),
				i.registerTableOption("dataTreeSelectPropagate", !1),
				i.registerComponentFunction(
					"row",
					"treeCollapse",
					i.collapseRow.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"treeExpand",
					i.expandRow.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"treeToggle",
					i.toggleRow.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"getTreeParent",
					i.getTreeParent.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"getTreeChildren",
					i.getRowChildren.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"addTreeChild",
					i.addTreeChildRow.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"isTreeExpanded",
					i.isRowExpanded.bind(l(i))
				),
				i
			);
		}
			...
			o(r, [
				...
				},
				{
					...
					value: function () {
						...
						this.elementField =
							this.table.options.dataTreeElementColumn || (!!e && e.field);
					},
				},
				{
					key: "getRowChildren",
				...
				},
				{
					...
					value: function () {
						var e = this,
							t = [];
						return (
							this.table.rowManager.rows.forEach(function (i) {
				...
				},
				{
					...
					value: function (e, t, i) {
						this.redrawNeeded(i) &&
							(this.initializeRow(e),
							t && (this.layoutRow(e), this.refreshData(!0)));
					},
				},
				{
					key: "cellValueChanged",
				...
				},
				{
					key: "initializeRow",
					value: function (t) {
						var i = t.getData()[this.field],
							n = Array.isArray(i),
							o = n || (!n && "object" === e(i) && null !== i);
						!o &&
							t.modules.dataTree &&
							t.modules.dataTree.branchEl &&
							t.modules.dataTree.branchEl.parentNode.removeChild(
								t.modules.dataTree.branchEl
							),
							!o &&
								t.modules.dataTree &&
								t.modules.dataTree.controlEl &&
								t.modules.dataTree.controlEl.parentNode.removeChild(
									t.modules.dataTree.controlEl
								),
							(t.modules.dataTree = {
								...
								open:
									!!o &&
									(t.modules.dataTree
										? t.modules.dataTree.open
										: this.startOpen(t.getComponent(), 0)),
								controlEl:
									!(!t.modules.dataTree || !o) && t.modules.dataTree.controlEl,
								branchEl:
									!(!t.modules.dataTree || !o) && t.modules.dataTree.branchEl,
				...
				},
				{
					...
					value: function (e, t) {
						var i = this,
							...
							o = ((t = t || e.getCells()[0].getElement()), n.controlEl);
						!1 !== n.children &&
							(n.open
								? ((n.controlEl = this.collapseEl.cloneNode(!0)),
								  n.controlEl.addEventListener("click", function (t) {
										t.stopPropagation(), i.collapseRow(e);
								  }))
								: ((n.controlEl = this.expandEl.cloneNode(!0)),
								  n.controlEl.addEventListener("click", function (t) {
							...
							o && o.parentNode === t
								? o.parentNode.replaceChild(n.controlEl, o)
								: t.insertBefore(n.controlEl, t.firstChild));
					},
				},
				{
					key: "setDisplayIndex",
						...
						return (
							e.forEach(function (e, n) {
								...
								i.push(e),
									e instanceof D &&
										(e.create(),
										(o = e.modules.dataTree.children).index ||
											!1 === o.children ||
							...
							!1 !== n.children &&
								...
								(o =
									...
									this.table.options.dataTreeFilter
										? this.table.modules.filter.filter(n.children)
										: n.children),
								this.table.modExists("sort") &&
									this.table.options.dataTreeSort &&
									this.table.modules.sort.sort(o),
								o.forEach(function (e) {
									a.push(e),
					...
					value: function (e) {
						...
						return (
							...
							n.forEach(function (n) {
								...
								o.create(),
									(o.modules.dataTree.index = e.modules.dataTree.index + 1),
									(o.modules.dataTree.parent = e),
									o.modules.dataTree.children &&
										(o.modules.dataTree.open = t.startOpen(
											o.getComponent(),
											o.modules.dataTree.index
										)),
									i.push(o);
							}),
							i
				...
				},
				{
					...
					value: function (e) {
						return e.modules.dataTree.parent
							? this.getTreeParentRoot(e.modules.dataTree.parent)
							: e;
					},
				},
				{
				...
				},
				{
					...
					value: function (e, t, i, n) {
						...
						"string" == typeof t && (t = JSON.parse(t)),
							...
							void 0 !== n &&
								!1 !== (o = this.findChildIndex(n, e)) &&
								e.data[this.field].splice(i ? o : o + 1, 0, t),
							!1 === o &&
								(i
									? e.data[this.field].unshift(t)
									: e.data[this.field].push(t)),
							this.initializeRow(e),
							this.layoutRow(e),
							this.refreshData(!0);
					},
					...
					value: function (t, i) {
						...
						return (
							"object" == e(t)
								? t instanceof D
									? (o = t.data)
									: t instanceof RowComponent
									? (o = t._getSelf().data)
									: "undefined" != typeof HTMLElement &&
									  t instanceof HTMLElement &&
									  i.modules.dataTree &&
									  (o = i.modules.dataTree.children.find(function (e) {
											return e instanceof D && e.element === t;
									  })) &&
									  (o = o.data)
								: (o =
										null != t &&
										i.data[this.field].find(function (e) {
											return e.data[n.table.options.index] == t;
										})),
							o &&
								(Array.isArray(i.data[this.field]) &&
									(o = i.data[this.field].indexOf(o)),
								-1 == o && (o = !1)),
							o
						);
					},
						...
						return (
							o.children &&
								...
								o.children.forEach(function (e) {
									e instanceof D &&
										(a.push(t ? e.getComponent() : e),
										i && (a = a.concat(n.getTreeChildren(e, t, i))));
								})),
							a
						);
					},
	...
	var ue = {
			csv: function (t, i, n) {
				var o = i && i.delimiter ? i.delimiter : ",",
					a = [],
					r = [];
				t.forEach(function (t) {
					var i = [];
				...
				e.forEach(function (e) {
					...
					switch (e.type) {
						...
						case "row":
							e.columns.forEach(function (e) {
								e &&
									(t[e.component.getTitleDownload() || e.component.getField()] =
										e.value);
							}),
								n.push(t);
					}
			...
			pdf: function (t, i, n) {
					...
					return (
						t.columns.forEach(function (t) {
							...
							if (t) {
								...
								(o = { content: t.value, colSpan: t.width, rowSpan: t.height }),
									i && (o.styles = i),
									n.push(o);
							}
						}),
				...
				u.orientation || (u.orientation = i.orientation || "landscape"),
					u.unit || (u.unit = "pt"),
					t.forEach(function (e) {
						switch (e.type) {
							case "header":
				...
				i &&
					i.autoTable &&
					(r =
						"function" == typeof i.autoTable
							? i.autoTable(d) || {}
							: i.autoTable),
					c &&
						(r.didDrawPage = function (e) {
							d.text(c, 40, 30);
						}),
					(r.head = o),
					(r.body = a),
					d.autoTable(r),
					i && i.documentProcessing && i.documentProcessing(d),
					n(d.output("arraybuffer"), "application/pdf");
			},
			xlsx: function (t, i, n) {
				...
				function s() {
					var i = [],
						...
						a = {
							...
							e: {
								c: t[0]
									? t[0].columns.reduce(function (e, t) {
					...
					return (
						t.forEach(function (t, o) {
							...
							t.columns.forEach(function (t, i) {
								t
									? (a.push(
											t.value instanceof Date || "object" !== e(t.value)
												? t.value
						...
						XLSX.utils.sheet_add_aoa(o, i),
						(o["!ref"] = XLSX.utils.encode_range(a)),
						n.length && (o["!merges"] = n),
						o
					);
				}
				if (((a.SheetNames = []), (a.Sheets = {}), i.sheetOnly)) n(s());
				else {
					if (i.sheets)
						for (var l in i.sheets)
							!0 === i.sheets[l]
								? (a.SheetNames.push(l), (a.Sheets[l] = s()))
								: (a.SheetNames.push(l),
								  r.commsSend(i.sheets[l], "download", "intercept", {
										type: "xlsx",
										options: { sheetOnly: !0 },
										active: this.active,
					...
					i.documentProcessing && (a = i.documentProcessing(a)),
						n(
							(function (e) {
								for (
								...
								XLSX.write(a, { bookType: "xlsx", bookSST: !0, type: "binary" })
							),
		...
		ce = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					(o = i.call(this, e)).registerTableOption(
						"downloadReady",
						function (e, t) {
							return t;
						}
					),
					o.registerTableOption("downloadConfig", {}),
					o.registerTableOption("downloadRowRange", "active"),
					o.registerColumnOption("download"),
					o.registerColumnOption("titleDownload"),
					o
				);
			}
			return (
				o(n, [
							...
							if (
								...
								r.call(
									...
									function (i, n) {
										a
											? !0 === a
												? this.triggerDownload(i, n, e, t, !0)
												: a(i)
											: this.triggerDownload(i, n, e, t);
									}.bind(this)
								);
							}
						},
					...
					},
					{
						...
						value: function (e, t, i, n, o) {
							...
							(r = this.table.options.downloadReady(e, r)) &&
								(o
									? window.open(window.URL.createObjectURL(r))
									: navigator.msSaveOrOpenBlob
									? navigator.msSaveOrOpenBlob(r, n)
									: (a.setAttribute("href", window.URL.createObjectURL(r)),
	...
	var de = (function () {
		function i(e, n, o, a, r, s) {
			t(this, i),
				...
				(this.table = e.table),
				(this.cell = n),
				(this.params = this._initializeParams(s)),
				(this.data = []),
				(this.displayItems = []),
				(this.currentItems = []),
				...
				(this.lastAction = ""),
				(this.blurable = !0),
				(this.actions = { success: a, cancel: r }),
				this._deprecationCheck(),
				this._initializeValue(),
				o(this._onRendered.bind(this));
		}
		return (
			o(i, [
				{
				...
				},
				{
					...
					value: function () {
						...
						void 0 === e &&
							void 0 !== this.params.defaultValue &&
							(e = this.params.defaultValue),
				...
				},
				{
					...
					value: function () {
						var e = document.createElement("div");
						return (
							e.classList.add("tabulator-edit-list"),
						...
						(this.listEl.style.minWidth = e.offsetWidth + "px"),
							this.params.maxWidth &&
								(!0 === this.params.maxWidth
									? (this.listEl.style.maxWidth = e.offsetWidth + "px")
				...
				},
				{
					...
					value: function () {
						...
						if (
							(i.setAttribute(
								"type",
								this.params.clearable ? "search" : "text"
							),
							(i.style.padding = "4px"),
							(i.style.width = "100%"),
							...
							for (var n in t)
								"+" == n.charAt(0)
									? ((n = n.slice(1)),
									  i.setAttribute(n, i.getAttribute(n) + t["+" + n]))
									: i.setAttribute(n, t[n]);
						return (
							this.params.mask && he(i, this.params),
							this._bindInputEvents(i),
							i
						);
					},
				},
				{
					...
					value: function (t) {
						var i,
							n = ["values", "valuesURL", "valuesLookup"];
						return (
							((t = Object.assign({}, t)).verticalNavigation =
								t.verticalNavigation || "editor"),
							(t.placeholderLoading =
								void 0 === t.placeholderLoading
									? "Searching ..."
									: t.placeholderLoading),
							(t.placeholderEmpty =
								void 0 === t.placeholderEmpty
									? "No Results Found"
									: t.placeholderEmpty),
							(t.filterDelay = void 0 === t.filterDelay ? 300 : t.filterDelay),
							(t.emptyValue = Object.keys(t).includes("emptyValue")
								? t.emptyValue
								: ""),
				...
				},
				{
					...
					value: function (e) {
						e.addEventListener("focus", this._inputFocus.bind(this)),
							...
							this.params.autocomplete &&
								e.addEventListener("keyup", this._inputKeyUp.bind(this));
					},
				},
				{
					key: "_inputFocus",
				...
				},
				{
					...
					value: function (e) {
						...
						("editor" == this.params.verticalNavigation ||
							("hybrid" == this.params.verticalNavigation && t)) &&
						...
						("editor" == this.params.verticalNavigation ||
							...
							t < this.displayItems.length - 1 &&
								(-1 == t
									...
									: this._focusItem(this.displayItems[t + 1])));
					},
				},
				{
					key: "_keySide",
				...
				},
				{
					key: "_keyEnter",
					value: function (e) {
						this.params.autocomplete && "typing" === this.lastAction
							? this._resolveValue(!0)
							: this.focusedItem && this._chooseItem(this.focusedItem);
					},
				},
				{
					key: "_keyEsc",
				...
				},
				{
					...
					value: function (e) {
						...
						var n = this.displayItems.find(function (e) {
							return (
								void 0 !== e.label &&
								e.label.toLowerCase().startsWith(t.filterTerm)
							);
						});
						n && this._focusItem(n),
							(this.filterTimeout = setTimeout(function () {
					...
					value: function (e) {
						...
						return (
							...
							this.params.values
								...
								? (i = this.params.valuesLookup(this.cell, this.input.value))
								: this.params.valuesLookup &&
								  (i = this._uniqueColumnValues(this.params.valuesLookupField)),
							i instanceof Promise
								? (e || this._addPlaceholder(this.params.placeholderLoading),
								  i.then().then(function (e) {
										return t.listIteration === n
											? t._parseList(e)
											: Promise.reject(n);
								  }))
				...
				},
				{
					...
					value: function (e) {
						var t = document.createElement("div");
						"function" == typeof e && (e = e(cell.getComponent(), this.listEl)),
							e &&
								(this._clearList(),
								e instanceof HTMLElement
									? (t = e)
									: (t.classList.add("tabulator-edit-list-placeholder"),
									  (t.innerHTML = e)),
				...
				},
				{
					...
					value: function (e, t) {
						return (
							(e = ee(e, {}, this.params.filterRemote ? { term: t } : {})),
							fetch(e)
								.then(function (e) {
									return e.ok
										...
										: (console.error(
												"List Ajax Load Error - Connection Error: " + e.status,
												e.statusText
										  ),
										  Promise.reject(e));
								})
								.catch(function (e) {
									return (
										console.error(
											"List Ajax Load Error - Connection Error: ",
											e
										),
										Promise.reject(e)
									);
				...
				},
				{
					...
					value: function (e) {
						...
						return (
							(t = e
								? this.table.columnManager.getColumnByField(e)
								: this.cell.getColumn()._getSelf())
								? n.forEach(function (e) {
				...
				},
				{
					...
					value: function (t) {
						...
						return (
							...
							t.forEach(function (t) {
								"object" !== e(t) && (t = { label: t, value: t }),
									i._parseListItem(t, n, 0);
							}),
					...
					value: function (e, t, i) {
						...
						e.options
							...
							: ((n = {
							  ...
							  this.initialValues &&
									this.initialValues.indexOf(e.value) > -1 &&
									this._chooseItem(n, !0)),
							t.push(n);
					},
				},
				{
				...
				},
				{
					...
					value: function (e) {
						...
						return (
							this.params.sort &&
								((t =
									"function" == typeof this.params.sort
										? this.params.sort
						...
						if (e || 0 === e) {
							if (t || 0 === t) {
								...
								for (
									i = i.match(l),
										n = n.match(l),
										r = i.length > n.length ? n.length : i.length;
									s < r;

								)
									if ((o = i[s]) !== (a = n[s++]))
										return isFinite(o) && isFinite(a)
											? ("0" === o.charAt(0) && (o = "." + o),
											  "0" === a.charAt(0) && (a = "." + a),
											  o - a)
											: o > a
				...
				},
				{
					...
					value: function () {
						var e = this,
							t = this.params.filterFunc || this._defaultFilterFunc,
							i = this.input.value;
						return (
							i
								? ((this.filtered = !0),
				...
				},
				{
					...
					value: function (e, t, i, n) {
						...
						return (
							(null !== t || void 0 !== t) &&
							(String(t).toLowerCase().indexOf(e) > -1 ||
								String(i).toLowerCase(e).indexOf() > -1)
						);
					},
				},
				{
				...
				},
				{
					...
					value: function (t) {
						...
						if (!this.filtered || t.visible) {
							if (!o) {
								if (
									(((o = document.createElement("div")).tabIndex = 0),
									(i = this.params.itemFormatter
										? this.params.itemFormatter(t.label, t.value, t.original, o)
										: t.label) instanceof HTMLElement
										? o.appendChild(i)
										: (o.innerHTML = i),
									t.group
										? o.classList.add("tabulator-edit-list-group")
										: o.classList.add("tabulator-edit-list-item"),
									o.classList.add("tabulator-edit-list-group-level-" + t.level),
									t.elementAttributes && "object" == e(t.elementAttributes))
								)
									for (var a in t.elementAttributes)
										"+" == a.charAt(0)
											? ((a = a.slice(1)),
											  o.setAttribute(
													a,
													this.input.getAttribute(a) +
														t.elementAttributes["+" + a]
											  ))
											: o.setAttribute(a, t.elementAttributes[a]);
								t.group
									? o.addEventListener("click", this._groupClick.bind(this, t))
									: o.addEventListener("click", this._itemClick.bind(this, t)),
									o.addEventListener("mousedown", this._preventBlur.bind(this)),
									(t.element = o);
							}
							this._styleItem(t),
								this.listEl.appendChild(o),
								t.group
					...
					value: function () {
						...
						if (this.input.parentNode) {
							if (
								...
								return void this.popup.hide(!0);
							this._setListWidth(),
								this.popup || (this.popup = this.edit.popup(this.listEl)),
								this.popup.show(this.cell.getElement(), "bottom"),
								e || this.popup.hideOnBlur(this._resolveValue.bind(this, !0));
						}
					},
				},
				{
					...
					value: function (e, t) {
						...
						(this.typing = !1),
							this.params.multiselect
								? ((i = this.currentItems.indexOf(e)) > -1
										? (this.currentItems.splice(i, 1), (e.selected = !1))
										: (this.currentItems.push(e), (e.selected = !0)),
				...
				},
				{
					...
					value: function (e) {
						var t, i;
						if ((this.popup.hide(!0), this.params.multiselect))
							t = this.currentItems.map(function (e) {
								return e.value;
							});
							...
							t = this.currentItems[0]
								? this.currentItems[0].value
								: null == (i = this.initialValues[0]) || "" === i
								? i
								: this.params.emptyValue;
						"" === t && (t = this.params.emptyValue),
							this.actions.success(t),
							this.isFilter &&
								(this.initialValues = t && !Array.isArray[t] ? [t] : t);
					},
				},
			]),
			i
	...
	var me = {
			input: function (t, i, n, o, a) {
				...
				if (
					(s.setAttribute("type", a.search ? "search" : "text"),
					(s.style.padding = "4px"),
					(s.style.width = "100%"),
					(s.style.boxSizing = "border-box"),
					a.elementAttributes && "object" == e(a.elementAttributes))
				)
					for (var l in a.elementAttributes)
						"+" == l.charAt(0)
							? ((l = l.slice(1)),
							  s.setAttribute(
									l,
									s.getAttribute(l) + a.elementAttributes["+" + l]
							  ))
							: s.setAttribute(l, a.elementAttributes[l]);
				function u(e) {
					(null == r && "" !== s.value) || s.value !== r
						? n(s.value) && (r = s.value)
						: o();
				}
				return (
			...
			textarea: function (t, i, n, o, a) {
				...
				if (
					...
					for (var h in a.elementAttributes)
						"+" == h.charAt(0)
							? ((h = h.slice(1)),
							  u.setAttribute(
									h,
									u.getAttribute(h) + a.elementAttributes["+" + h]
							  ))
							: u.setAttribute(h, a.elementAttributes[h]);
				function d(e) {
					(null == r && "" !== u.value) || u.value !== r
						? (n(u.value) && (r = u.value),
						  setTimeout(function () {
				...
				return (
					...
					u.addEventListener("keyup", function () {
						...
						(u.style.height = e + "px"),
							e != c && ((c = e), t.getRow().normalizeHeight());
					}),
					u.addEventListener("keydown", function (e) {
						switch (e.keyCode) {
							case 27:
								...
								break;
							case 38:
								("editor" == s || ("hybrid" == s && u.selectionStart)) &&
									(e.stopImmediatePropagation(), e.stopPropagation());
								break;
							case 40:
								("editor" == s ||
									("hybrid" == s && u.selectionStart !== u.value.length)) &&
									(e.stopImmediatePropagation(), e.stopPropagation());
								break;
							case 35:
							case 36:
			...
			number: function (t, i, n, o, a) {
				var r = t.getValue(),
					s = a.verticalNavigation || "editor",
					l = document.createElement("input");
				if (
					(l.setAttribute("type", "number"),
					void 0 !== a.max && l.setAttribute("max", a.max),
					void 0 !== a.min && l.setAttribute("min", a.min),
					void 0 !== a.step && l.setAttribute("step", a.step),
					(l.style.padding = "4px"),
					(l.style.width = "100%"),
					...
					for (var u in a.elementAttributes)
						"+" == u.charAt(0)
							? ((u = u.slice(1)),
							  l.setAttribute(
									u,
									l.getAttribute(u) + a.elementAttributes["+" + u]
							  ))
							: l.setAttribute(u, a.elementAttributes[u]);
				l.value = r;
				var c = function (e) {
					h();
				};
			...
			range: function (t, i, n, o, a) {
				...
				if (
					...
					void 0 !== a.max && s.setAttribute("max", a.max),
					void 0 !== a.min && s.setAttribute("min", a.min),
					void 0 !== a.step && s.setAttribute("step", a.step),
					(s.style.padding = "4px"),
					(s.style.width = "100%"),
					(s.style.boxSizing = "border-box"),
					a.elementAttributes && "object" == e(a.elementAttributes))
			...
			star: function (t, i, n, o, a) {
				var r = this,
					s = t.getElement(),
					l = t.getValue(),
					u = s.getElementsByTagName("svg").length || 5,
					c = s.getElementsByTagName("svg")[0]
				...
				if (
					...
					m.setAttribute("height", c),
					m.setAttribute("viewBox", "0 0 512 512"),
					m.setAttribute("xml:space", "preserve"),
					(m.style.padding = "0 1px"),
					a.elementAttributes && "object" == e(a.elementAttributes))
				)
					for (var v in a.elementAttributes)
						"+" == v.charAt(0)
							? ((v = v.slice(1)),
							  d.setAttribute(
									v,
									d.getAttribute(v) + a.elementAttributes["+" + v]
							  ))
							: d.setAttribute(v, a.elementAttributes[v]);
				for (var b = 1; b <= u; b++) f(b);
				return (
					p((l = Math.min(parseInt(l), u))),
			...
			progress: function (t, i, n, o, a) {
				var r,
					...
					u =
						void 0 === a.max
							? (l.getElementsByTagName("div")[0] &&
									l.getElementsByTagName("div")[0].getAttribute("max")) ||
							  100
							: a.max,
					c =
						void 0 === a.min
							? (l.getElementsByTagName("div")[0] &&
									l.getElementsByTagName("div")[0].getAttribute("min")) ||
							  0
							: a.min,
					h = (u - c) / 100,
					d = t.getValue() || 0,
				...
				if (
					...
					for (var g in a.elementAttributes)
						"+" == g.charAt(0)
							? ((g = g.slice(1)),
							  p.setAttribute(
									g,
									p.getAttribute(g) + a.elementAttributes["+" + g]
							  ))
							: p.setAttribute(g, a.elementAttributes[g]);
				return (
					(l.style.padding = "4px 4px"),
					(d = Math.min(parseFloat(d), u)),
					(d = Math.max(parseFloat(d), c)),
					(d = Math.round((d - c) / h)),
					(p.style.width = d + "%"),
					...
					l.addEventListener("keydown", function (e) {
						switch (e.keyCode) {
							case 39:
								e.preventDefault(),
									(p.style.width = p.clientWidth + l.clientWidth / 100 + "px");
								break;
							case 37:
								e.preventDefault(),
									(p.style.width = p.clientWidth - l.clientWidth / 100 + "px");
			...
			tickCross: function (t, i, n, o, a) {
				var r = t.getValue(),
					s = document.createElement("input"),
					l = a.tristate,
					u = void 0 === a.indeterminateValue ? null : a.indeterminateValue,
					c = !1,
					h = Object.keys(a).includes("trueValue"),
					d = Object.keys(a).includes("falseValue");
				if (
					...
					for (var m in a.elementAttributes)
						"+" == m.charAt(0)
							? ((m = m.slice(1)),
							  s.setAttribute(
									m,
									s.getAttribute(m) + a.elementAttributes["+" + m]
							  ))
							: s.setAttribute(m, a.elementAttributes[m]);
				function p(e) {
					var t = s.checked;
					return (
						(t = h && t ? a.trueValue : d && !t ? a.falseValue : t),
						l
							? e
								? c
									? u
									: t
								: s.checked && !c
								? ((s.checked = !1), (s.indeterminate = !0), (c = !0), u)
								: ((c = !1), t)
							: t
					);
				}
		...
		pe = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).currentCell = !1),
					(i.mouseClick = !1),
					(i.recursionBlock = !1),
					(i.invalidEdit = !1),
					(i.editedCells = []),
					(i.editors = r.editors),
					i.registerColumnOption("editable"),
					i.registerColumnOption("editor"),
					i.registerColumnOption("editorParams"),
					i.registerColumnOption("cellEditing"),
					i.registerColumnOption("cellEdited"),
					i.registerColumnOption("cellEditCancelled"),
					i.registerTableFunction(
						"getEditedCells",
						i.getEditedCells.bind(l(i))
					),
					i.registerTableFunction(
						"clearCellEdited",
						i.clearCellEdited.bind(l(i))
					),
					i.registerTableFunction("navigatePrev", i.navigatePrev.bind(l(i))),
					i.registerTableFunction("navigateNext", i.navigateNext.bind(l(i))),
					i.registerTableFunction("navigateLeft", i.navigateLeft.bind(l(i))),
					i.registerTableFunction("navigateRight", i.navigateRight.bind(l(i))),
					i.registerTableFunction("navigateUp", i.navigateUp.bind(l(i))),
					i.registerTableFunction("navigateDown", i.navigateDown.bind(l(i))),
					i.registerComponentFunction(
						"cell",
						"isEdited",
						i.cellisEdited.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"clearEdited",
						i.clearEdited.bind(l(i))
					),
					i.registerComponentFunction("cell", "edit", i.editCell.bind(l(i))),
					i.registerComponentFunction(
						"cell",
						"cancelEdit",
						i.cellCancelEdit.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"navigatePrev",
						i.navigatePrev.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"navigateNext",
						i.navigateNext.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"navigateLeft",
						i.navigateLeft.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"navigateRight",
						i.navigateRight.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"navigateUp",
						i.navigateUp.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"navigateDown",
						i.navigateDown.bind(l(i))
					),
					i
				);
			}
				...
				o(r, [
					{
						...
						value: function () {
							this.subscribe("cell-init", this.bindEditor.bind(this)),
								...
								this.subscribe(
									"column-delete",
									this.columnDeleteCheck.bind(this)
								),
								...
								this.subscribe(
									"keybinding-nav-left",
									this.navigateLeft.bind(this, void 0)
								),
								this.subscribe(
								...
								this.subscribe(
									"keybinding-nav-up",
									this.navigateUp.bind(this, void 0)
								),
								this.subscribe(
									"keybinding-nav-down",
									this.navigateDown.bind(this, void 0)
								);
						},
					},
					{
									...
									(i &&
										...
										(i =
											!0 === i
												? this.table.addRow({})
												: "function" == typeof i
												? this.table.addRow(i(t.row.getComponent()))
					...
					},
					{
						...
						value: function () {
							...
							if (i) {
								if ((n && n.preventDefault(), (e = this.navigateLeft())))
									return !0;
								if (
									(t = this.table.rowManager.prevDisplayRow(i.row, !0)) &&
									(e = this.findNextEditableCell(t, t.cells.length))
								)
									return e.getComponent().edit(), !0;
							}
							return !1;
						},
					},
					{
						...
						value: function () {
							var e,
								...
								n = arguments.length > 1 ? arguments[1] : void 0;
							if (i) {
								if ((n && n.preventDefault(), (e = this.navigateRight())))
									return !0;
								if (
									(t = this.table.rowManager.nextDisplayRow(i.row, !0)) &&
									(e = this.findNextEditableCell(t, -1))
								)
									return e.getComponent().edit(), !0;
							}
							return !1;
						...
						value: function () {
							...
							return (
								!!(
									...
									(n && n.preventDefault(),
									(e = i.getIndex()),
									(t = this.findPrevEditableCell(i.row, e)))
								) && (t.getComponent().edit(), !0)
							);
						},
					},
					{
						...
						value: function () {
							...
							return (
								!!(
									...
									(n && n.preventDefault(),
									(e = i.getIndex()),
									(t = this.findNextEditableCell(i.row, e)))
								) && (t.getComponent().edit(), !0)
							);
						},
					},
									...
									if (o.column.modules.edit && k.elVisible(o.getElement())) {
										...
										if (
											("function" == typeof o.column.modules.edit.check &&
												(a = o.column.modules.edit.check(o.getComponent())),
											a)
										) {
											i = o;
											break;
					...
					},
					{
						...
						value: function (t) {
							...
							switch (e(t.definition.editor)) {
								case "string":
									this.editors[t.definition.editor]
										? (i.editor = this.editors[t.definition.editor])
										: console.warn(
									...
									!0 === t.definition.editor &&
										("function" != typeof t.definition.formatter
											? this.editors[t.definition.formatter]
												? (i.editor = this.editors[t.definition.formatter])
												: (i.editor = this.editors.input)
											: console.warn(
						...
						value: function () {
							if (this.currentCell) {
								...
								this.clearEditor(!0),
									...
									e.column.definition.cellEditCancelled &&
										e.column.definition.cellEditCancelled.call(this.table, t),
					...
					},
					{
						...
						value: function (e) {
							if ("virtual" == this.table.rowManager.getRenderMode()) {
								...
								n.offsetTop;
								n.offsetTop < t
									? (this.table.rowManager.element.scrollTop -= t - n.offsetTop)
									: n.offsetTop + n.offsetHeight > i &&
									  (this.table.rowManager.element.scrollTop +=
											n.offsetTop + n.offsetHeight - i);
								...
								r.offsetLeft;
								this.table.modExists("frozenColumns") &&
									((o += parseInt(this.table.modules.frozenColumns.leftMargin)),
									(a -= parseInt(
										this.table.modules.frozenColumns.rightMargin
									))),
									"virtual" === this.table.options.renderHorizontal &&
										((o -= parseInt(
					...
					},
					{
						...
						value: function (t, i, n) {
							var o,
								...
								c = t.getElement();
							if (!this.currentCell) {
								if (t.column.modules.edit.blocked)
									return (this.mouseClick = !1), c.blur(), !1;
								switch (
									(i && i.stopPropagation(), e(t.column.modules.edit.check))
								) {
									case "function":
								...
								if (l || n) {
									if (
										...
										this.mouseClick &&
											((this.mouseClick = !1),
											t.column.definition.cellClick &&
												t.column.definition.cellClick.call(this.table, i, a)),
										t.column.definition.cellEditing &&
											t.column.definition.cellEditing.call(this.table, a),
										this.dispatch("cell-editing", t),
										this.dispatchExternal("cellEditing", a),
										(r =
											"function" == typeof t.column.modules.edit.params
												? t.column.modules.edit.params(a)
												: t.column.modules.edit.params),
										!1 ===
											(o = t.column.modules.edit.editor.call(
												s,
												a,
												function (e) {
													u = e;
												...
												function (e) {
													if (s.currentCell === t) {
														...
														return !0 === i ||
															...
															? (s.clearEditor(),
															  t.modules.edit || (t.modules.edit = {}),
															  (t.modules.edit.edited = !0),
															  -1 == s.editedCells.indexOf(t) &&
																	s.editedCells.push(t),
															  t.setValue(e, !0),
															  !0 === i)
															: ((s.invalidEdit = !0),
															  s.focusCellNoEvent(t, !0),
															  u(),
															  !1);
													}
												},
									...
									for (
										c.classList.add("tabulator-editing"),
											t.row.getElement().classList.add("tabulator-row-editing");
										c.firstChild;

									)
										c.removeChild(c.firstChild);
									c.appendChild(o), u();
									for (var h = c.children, d = 0; d < h.length; d++)
										h[d].addEventListener("click", function (e) {
											e.stopPropagation();
										});
									return !0;
								}
	...
	var fe = function e(i, n, o, a) {
		...
		ve = (function (n) {
			...
			function s(e) {
				...
				return (
					t(this, s),
					((i = r.call(this, e)).config = {}),
					(i.cloneTableStyle = !0),
					(i.colVisProp = ""),
					i.registerTableOption("htmlOutputConfig", !1),
					i.registerColumnOption("htmlOutput"),
					i.registerColumnOption("titleHtmlOutput"),
					i
				);
			}
			return (
				o(s, [
					...
					},
					{
						...
						value: function (e) {
							...
							function o(e, n) {
								...
								if (
									(void 0 === t[n] && (t[n] = []),
									(e.height = e.subGroups ? 1 : a - e.depth + 1),
									t[n].push(e),
									e.height > 1)
								)
									for (var r = 1; r < e.height; r++)
										void 0 === t[n + r] && (t[n + r] = []), t[n + r].push(!1);
								if (e.width > 1)
									for (var s = 1; s < e.width; s++) t[n].push(!1);
								e.subGroups &&
						...
						value: function (e) {
							...
							return (
								...
								(e = e.filter(function (e) {
									...
									var a = e.getData(t.colVisProp),
										r = [],
										s = 0;
									switch (e.type) {
										case "group":
											(s = e.level),
												r.push(new ge(e.key, e.getComponent(), i.length, 1));
											break;
										case "calc":
										case "row":
											i.forEach(function (e) {
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								(s.rowFormatter =
									null !== r ? r : this.table.options.rowFormatter),
								this.table.options.dataTree &&
									!1 !== this.config.dataTree &&
									this.table.modExists("columnCalcs") &&
									(s.treeElementField =
										this.table.modules.dataTree.elementField),
								(s.groupHeader =
									this.table.options[
										"groupHeader" +
											(this.colVisProp.charAt(0).toUpperCase() +
								...
								e.forEach(function (e, i) {
									switch (e.type) {
										...
										case "row":
											...
											t.mapElementStyles(
												i % 2 && a.evenRow ? a.evenRow : a.oddRow,
												r,
												[
													"border-top",
													"border-left",
								...
								e.columns.forEach(function (e) {
									if (e) {
										...
										(t.colSpan = e.width),
											(t.rowSpan = e.height),
											(t.innerHTML = e.value),
											n.cloneTableStyle && (t.style.boxSizing = "border-box"),
											i.forEach(function (e) {
												t.classList.add(e);
											}),
											n.mapElementStyles(e.component.getElement(), t, [
												"text-align",
												"border-top",
												"border-left",
												"border-right",
											...
											n.mapElementStyles(
												e.component._column.contentElement,
												t,
												[
													"padding-top",
													"padding-left",
					...
					},
					{
						...
						value: function (e, t, i) {
							var n = document.createElement("tr"),
								...
								a = e.columns[0];
							return (
								n.classList.add("tabulator-print-table-row"),
								t.groupHeader && t.groupHeader[e.indent]
									? (a.value = t.groupHeader[e.indent](
											a.value,
											e.component._group.getRowCount(),
											e.component._group.getData(),
											e.component
									...
									: !1 === t.groupHeader
									? (a.value = a.value)
									: (a.value = e.component._group.generator(
											a.value,
											e.component._group.getRowCount(),
											e.component._group.getData(),
											e.component
								...
								(o.colSpan = a.width),
								(o.innerHTML = a.value),
								n.classList.add("tabulator-print-table-group"),
								n.classList.add("tabulator-group-level-" + e.indent),
								a.component.isVisible() &&
									n.classList.add("tabulator-group-visible"),
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return (
								n.classList.add("tabulator-print-table-calcs"),
								this.mapElementStyles(i.calcRow, n, [
									"border-top",
									"border-left",
									"border-right",
									"border-bottom",
					...
					},
					{
						...
						value: function (t, n, o) {
							...
							return (
								...
								t.columns.forEach(function (s) {
									if (s) {
										var l = document.createElement("td"),
											u = s.component._column,
											c = a.table.columnManager.findColumnIndex(u),
											h = s.value,
											d = {
												modules: {},
												getValue: function () {
										...
										if (
											...
											a.table.modExists("format") &&
												!1 !== a.config.formatCells)
										)
											h = a.table.modules.format.formatExportValue(
												d,
												a.colVisProp
											);
										else
										...
										h instanceof Node ? l.appendChild(h) : (l.innerHTML = h),
											(o.styleCells[c] || o.firstCell) &&
												(a.mapElementStyles(o.styleCells[c] || o.firstCell, l, [
													"padding-top",
													"padding-left",
													"padding-right",
													"padding-bottom",
											...
											a.table.options.dataTree &&
												!1 !== a.config.dataTree &&
												((n.treeElementField &&
													n.treeElementField == u.field) ||
													(!n.treeElementField && 0 == i)) &&
												(t.component._row.modules.dataTree.controlEl &&
													l.insertBefore(
												...
												t.component._row.modules.dataTree.branchEl &&
													l.insertBefore(
														t.component._row.modules.dataTree.branchEl.cloneNode(
															!0
														),
														l.firstChild
													)),
	...
	var be = {
			...
			like: function (e, t, i, n) {
				return null == e
					? t === e
					: null != t && String(t).toLowerCase().indexOf(e.toLowerCase()) > -1;
			},
			keywords: function (e, t, i, n) {
				var o = e
						.toLowerCase()
						.split(void 0 === n.separator ? " " : n.separator),
					a = String(null == t ? "" : t).toLowerCase(),
					r = [];
				return (
					o.forEach(function (e) {
			...
			starts: function (e, t, i, n) {
				return null == e
					? t === e
					: null != t && String(t).toLowerCase().startsWith(e.toLowerCase());
			},
			...
			in: function (e, t, i, n) {
				return Array.isArray(e)
					...
					: (console.warn("Filter Error - filter value is not an array:", e),
					  !1);
			},
		},
		ye = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).filterList = []),
					(i.headerFilters = {}),
					(i.headerFilterColumns = []),
					(i.prevHeaderFilterChangeCheck = ""),
					(i.prevHeaderFilterChangeCheck = "{}"),
					(i.changed = !1),
					(i.tableInitialized = !1),
					i.registerTableOption("filterMode", "local"),
					i.registerTableOption("initialFilter", !1),
					i.registerTableOption("initialHeaderFilter", !1),
					i.registerTableOption("headerFilterLiveFilterDelay", 300),
					i.registerColumnOption("headerFilter"),
					i.registerColumnOption("headerFilterPlaceholder"),
					i.registerColumnOption("headerFilterParams"),
					i.registerColumnOption("headerFilterEmptyCheck"),
					i.registerColumnOption("headerFilterFunc"),
					i.registerColumnOption("headerFilterFuncParams"),
					i.registerColumnOption("headerFilterLiveFilter"),
					i.registerTableFunction("searchRows", i.searchRows.bind(l(i))),
					i.registerTableFunction("searchData", i.searchData.bind(l(i))),
					i.registerTableFunction("setFilter", i.userSetFilter.bind(l(i))),
					i.registerTableFunction(
						"refreshFilter",
						i.userRefreshFilter.bind(l(i))
					),
					i.registerTableFunction("addFilter", i.userAddFilter.bind(l(i))),
					i.registerTableFunction("getFilters", i.getFilters.bind(l(i))),
					i.registerTableFunction(
						"setHeaderFilterFocus",
						i.userSetHeaderFilterFocus.bind(l(i))
					),
					i.registerTableFunction(
						"getHeaderFilterValue",
						i.userGetHeaderFilterValue.bind(l(i))
					),
					i.registerTableFunction(
						"setHeaderFilterValue",
						i.userSetHeaderFilterValue.bind(l(i))
					),
					i.registerTableFunction(
						"getHeaderFilters",
						i.getHeaderFilters.bind(l(i))
					),
					i.registerTableFunction(
						"removeFilter",
						i.userRemoveFilter.bind(l(i))
					),
					i.registerTableFunction("clearFilter", i.userClearFilter.bind(l(i))),
					i.registerTableFunction(
						"clearHeaderFilter",
						i.userClearHeaderFilter.bind(l(i))
					),
					i.registerComponentFunction(
						"column",
						"headerFilterFocus",
						i.setHeaderFilterFocus.bind(l(i))
					),
					i.registerComponentFunction(
						"column",
						"reloadHeaderFilter",
						i.reloadHeaderFilter.bind(l(i))
					),
					i.registerComponentFunction(
						"column",
						"getHeaderFilterValue",
						i.getHeaderFilterValue.bind(l(i))
					),
					i.registerComponentFunction(
						"column",
						"setHeaderFilterValue",
						i.setHeaderFilterValue.bind(l(i))
					),
					i
				);
			}
			return (
				o(r, [
						...
						value: function () {
							this.subscribe(
								...
								"remote" === this.table.options.filterMode &&
									this.subscribe(
										"data-params",
										this.remoteFilterParams.bind(this)
									),
					...
					},
					{
						...
						value: function () {
							var e = this;
							this.table.options.initialFilter &&
								this.setFilter(this.table.options.initialFilter),
								this.table.options.initialHeaderFilter &&
									this.table.options.initialHeaderFilter.forEach(function (t) {
						...
						value: function (t, i) {
							...
							(t.modules.filter = {
								success: function (i) {
									var a,
										s =
											("input" == t.modules.filter.tagType &&
												"text" == t.modules.filter.attrType) ||
											"textarea" == t.modules.filter.tagType
												? "partial"
												: "match",
										l = "",
										u = "";
									if (
										void 0 === t.modules.filter.prevSuccess ||
										t.modules.filter.prevSuccess !== i
									) {
										if (
											((t.modules.filter.prevSuccess = i),
											t.modules.filter.emptyFunc(i))
										)
											delete n.headerFilters[o];
										else {
											switch (
												((t.modules.filter.value = i),
												e(t.definition.headerFilterFunc))
											) {
												case "string":
													r.filters[t.definition.headerFilterFunc]
														? ((l = t.definition.headerFilterFunc),
														  (a = function (e) {
																var n =
																		t.definition.headerFilterFuncParams || {},
																	o = t.getFieldValue(e);
																return (
																	(n = "function" == typeof n ? n(i, o, e) : n),
																	r.filters[t.definition.headerFilterFunc](
																		i,
																		o,
																		e,
														...
														: console.warn(
																...
																t.definition.headerFilterFunc
														  );
													break;
												case "function":
													l = a = function (e) {
														var n = t.definition.headerFilterFuncParams || {},
															o = t.getFieldValue(e);
														return (
															(n = "function" == typeof n ? n(i, o, e) : n),
															t.definition.headerFilterFunc(i, o, e, n)
														);
													};
											}
											if (!a)
										...
										(t.modules.filter.value = i),
											(u = JSON.stringify(n.headerFilters)),
											n.prevHeaderFilterChangeCheck !== u &&
												((n.prevHeaderFilterChangeCheck = u),
												n.trackChanges(),
												n.refreshFilter());
									}
					...
					},
					{
						...
						value: function (t, i, n) {
							var o,
								...
								h = this,
								d = this,
								m = t.modules.filter.success,
								p = t.getField();
							if (
								((t.modules.filter.value = i),
								t.modules.filter.headerElement &&
									t.modules.filter.headerElement.parentNode &&
									t.contentElement.removeChild(
										t.modules.filter.headerElement.parentNode
									),
								p)
							) {
								switch (
									...
									e(t.definition.headerFilter))
								) {
									case "string":
										d.table.modules.edit.editors[t.definition.headerFilter]
											? ((a =
													d.table.modules.edit.editors[
														t.definition.headerFilter
													]),
											  ("tick" !== t.definition.headerFilter &&
													"tickCross" !== t.definition.headerFilter) ||
													t.definition.headerFilterEmptyCheck ||
													(t.modules.filter.emptyFunc = function (e) {
														return !0 !== e && !1 !== e;
													}))
											: console.warn(
									...
									case "boolean":
										t.modules.edit && t.modules.edit.editor
											? (a = t.modules.edit.editor)
											: t.definition.formatter &&
											  d.table.modules.edit.editors[t.definition.formatter]
											? ((a =
													d.table.modules.edit.editors[t.definition.formatter]),
											  ("tick" !== t.definition.formatter &&
													"tickCross" !== t.definition.formatter) ||
													t.definition.headerFilterEmptyCheck ||
													(t.modules.filter.emptyFunc = function (e) {
														return !0 !== e && !1 !== e;
													}))
								...
								if (a) {
									if (
										...
										(c =
											"function" ==
											typeof (c = t.definition.headerFilterParams || {})
												? c.call(d.table, s)
												: c),
										!(r = a.call(
									...
									p
										? d.langBind(
												"headerFilters|columns|" + t.definition.field,
												function (e) {
													r.setAttribute(
														"placeholder",
														void 0 !== e && e
															? e
															: d.langText("headerFilters|default")
													);
												}
										  )
										...
										r.addEventListener("focus", function (e) {
											...
											t !==
												h.table.rowManager.element.scrollLeft +
													parseInt(
														h.table.columnManager.element.style.marginLeft
													) &&
												(h.table.rowManager.scrollHorizontal(t),
												h.table.columnManager.scrollHorizontal(t));
										}),
										(l = !1),
										(u = function (e) {
											l && clearTimeout(l),
										...
										(t.modules.filter.headerElement = r),
										(t.modules.filter.attrType = r.hasAttribute("type")
											? r.getAttribute("type").toLowerCase()
											: ""),
										(t.modules.filter.tagType = r.tagName.toLowerCase()),
										!1 !== t.definition.headerFilterLiveFilter &&
											("autocomplete" !== t.definition.headerFilter &&
												"tickCross" !== t.definition.headerFilter &&
												(("autocomplete" !== t.definition.editor &&
													"tickCross" !== t.definition.editor) ||
													!0 !== t.definition.headerFilter) &&
												(r.addEventListener("keyup", u),
												r.addEventListener("search", u),
												...
												"text" == t.modules.filter.attrType &&
													"ie" !== this.table.browser &&
													r.setAttribute("type", "search")),
											("input" != t.modules.filter.tagType &&
												"select" != t.modules.filter.tagType &&
												"textarea" != t.modules.filter.tagType) ||
												r.addEventListener("mousedown", function (e) {
													e.stopPropagation();
												})),
										o.appendChild(r),
										t.contentElement.appendChild(o),
										n || d.headerFilterColumns.push(t);
								}
							} else
								console.warn(
					...
					},
					{
						...
						value: function (e, t, i, n) {
							(this.filterList = []),
								Array.isArray(e) ||
									(e = [{ field: e, type: t, value: i, params: n }]),
								this.addFilter(e);
						},
					},
					{
						...
						value: function (e) {
							...
							return (
								"function" == typeof e.field
									...
									: r.filters[e.type]
									? (i = (t = this.table.columnManager.getColumnByField(
											e.field
									  ))
											? function (i) {
													return r.filters[e.type](
														e.value,
														t.getFieldValue(i),
														i,
														e.params || {}
						...
						value: function (e, t) {
							...
							return (
								e.forEach(function (e) {
									var o;
									Array.isArray(e)
										? n.push(i.filtersToArray(e, t))
										: ((o = { field: e.field, type: e.type, value: e.value }),
										  t && "function" == typeof o.type && (o.type = "function"),
										  n.push(o));
								}),
								n
							);
					...
					},
					{
						...
						value: function (t, i, n) {
							var o = this;
							Array.isArray(t) || (t = [{ field: t, type: i, value: n }]),
								t.forEach(function (t) {
									var i = -1;
									(i =
										"object" == e(t.field)
							...
							return (
								...
								this.table.rowManager.rows.forEach(function (t) {
									...
									r.forEach(function (e) {
										...
										i &&
											a.push(
												"data" === e ? t.getData("data") : t.getComponent()
											);
								}),
								a
							);
						...
						value: function (e, t) {
							...
							return (
								this.subscribedExternal("dataFiltering") &&
									this.dispatchExternal("dataFiltering", this.getFilters(!0)),
								"remote" !== this.table.options.filterMode &&
					...
					},
					{
						...
						value: function (e, t) {
							...
							this.headerFilters))
								this.headerFilters[a].func(o) || (n = !1);
							return n;
						},
					},
					{
	...
	var we = {
			...
			money: function (e, t, i) {
				...
				if (
					(s < 0 && ((s = Math.abs(s)), (l = h)),
					(n = !1 !== p ? s.toFixed(p) : s),
					(o = (n = String(n).split("."))[0]),
					(a = n.length > 1 ? u + n[1] : ""),
					!1 !== t.thousand)
				)
			...
			link: function (t, i, n) {
				...
				if (
					(i.labelField &&
						...
						(l = (function t(i, n) {
							...
							i.labelField.split(this.table.options.nestedFieldSeparator),
							o
						))),
					i.label)
				)
				...
				if (l) {
					if ((i.urlField && (a = (o = t.getData())[i.urlField]), i.url))
						switch (e(i.url)) {
							case "string":
								a = i.url;
								break;
					...
					return (
						u.setAttribute("href", r + a),
						i.target && u.setAttribute("target", i.target),
						i.download &&
							((s = "function" == typeof s ? s(t) : !0 === s ? "" : s),
							u.setAttribute("download", s)),
						(u.innerHTML = this.emptyToSpace(this.sanitizeHTML(l))),
						u
					);
				}
				return "&nbsp;";
			...
			image: function (t, i, n) {
				var o = document.createElement("img"),
					a = t.getValue();
				switch (
					(i.urlPrefix && (a = i.urlPrefix + t.getValue()),
					i.urlSuffix && (a += i.urlSuffix),
				...
				return (s && n === t.trueValue) ||
					(!s &&
						((r && n) ||
							...
							1 === n ||
							"1" === n))
					? (o.setAttribute("aria-checked", !0), l || "")
					: !a || ("null" !== n && "" !== n && null != n)
					? (o.setAttribute("aria-checked", !1), u || "")
					: (o.setAttribute("aria-checked", "mixed"), "");
			},
			datetime: function (e, t, i) {
				var n,
					o = window.DateTime || luxon.DateTime,
					a = t.inputFormat || "yyyy-MM-dd HH:mm:ss",
					r = t.outputFormat || "dd/MM/yyyy HH:mm:ss",
					s = void 0 !== t.invalidPlaceholder ? t.invalidPlaceholder : "",
					l = e.getValue();
				if (void 0 !== o)
					return (n = o.isDateTime(l)
						? l
						: "iso" === a
						? o.fromISO(String(l))
						: o.fromFormat(String(l), a)).isValid
						? (t.timezone && (n = n.setZone(t.timezone)), n.toFormat(r))
						: !0 !== s && l
						? "function" == typeof s
							? s(l)
							: s
			...
			datetimediff: function (e, t, i) {
				var n,
					...
					u = void 0 !== t.humanize && t.humanize,
					c = void 0 !== t.date ? t.date : o.now(),
					h = e.getValue();
				if (void 0 !== o)
					return (n = o.isDateTime(h)
						? h
						: "iso" === a
						? o.fromISO(String(h))
						: o.fromFormat(String(h), a)).isValid
						? u
							? n.diff(c, l).toHuman() + (s ? " " + s : "")
							: parseInt(n.diff(c, l)[l]) + (s ? " " + s : "")
						: !0 === r
						? h
						: "function" == typeof r
						? r(h)
			...
			lookup: function (e, t, i) {
				var n = e.getValue();
				return void 0 === t[n]
					? (console.warn("Missing display value for " + n), n)
					: t[n];
			},
			star: function (e, t, i) {
				var n = e.getValue(),
				...
				(r.style.verticalAlign = "middle"),
					...
					(n = n && !isNaN(n) ? parseInt(n) : 0),
					(n = Math.max(0, Math.min(n, a)));
				for (var l = 1; l <= a; l++) {
					var u = s.cloneNode(!0);
					(u.innerHTML =
						l <= n
			...
			traffic: function (t, i, n) {
				var o,
					a,
					r = this.sanitizeHTML(t.getValue()) || 0,
					s = document.createElement("span"),
					l = i && i.max ? i.max : 100,
					u = i && i.min ? i.min : 0,
					c = i && void 0 !== i.color ? i.color : ["red", "orange", "green"],
					h = "#666666";
				if (!isNaN(r) && void 0 !== t.getValue()) {
					switch (
						(s.classList.add("tabulator-traffic-light"),
						(a = parseFloat(r) <= l ? parseFloat(r) : l),
						(a = parseFloat(a) >= u ? parseFloat(a) : u),
						(o = (l - u) / 100),
						(a = Math.round((a - u) / o)),
						e(c))
					) {
			...
			progress: function (t, i, n) {
				var o,
					...
					s,
					l,
					u = this.sanitizeHTML(t.getValue()) || 0,
					c = t.getElement(),
					h = i && i.max ? i.max : 100,
					d = i && i.min ? i.min : 0,
					m = i && i.legendAlign ? i.legendAlign : "center";
				switch (
					((a = parseFloat(u) <= h ? parseFloat(u) : h),
					(a = parseFloat(a) >= d ? parseFloat(a) : d),
					(o = (h - d) / 100),
					(a = Math.round((a - d) / o)),
					e(i.color))
				) {
					...
					case "object":
						if (Array.isArray(i.color)) {
							var p = 100 / i.color.length,
								f = Math.floor(a / p);
							(f = Math.min(f, i.color.length - 1)),
								(f = Math.max(f, 0)),
								(r = i.color[f]);
							break;
						}
				...
				switch (e(i.legendColor)) {
					...
					case "object":
						if (Array.isArray(i.legendColor)) {
							...
							(f = Math.min(f, i.legendColor.length - 1)),
								(f = Math.max(f, 0)),
								(l = i.legendColor[f]);
						}
						break;
				...
				(g.style.display = "inline-block"),
					...
					(g.style.width = a + "%"),
					(g.style.backgroundColor = r),
					(g.style.height = "100%"),
					g.setAttribute("data-max", h),
					g.setAttribute("data-min", d);
			...
			rownum: function (e, t, i) {
				return (
					this.table.rowManager.activeRows.indexOf(e.getRow()._getSelf()) + 1 ||
					""
				);
			},
			...
			responsiveCollapse: function (e, t, i) {
				...
				function a(e) {
					...
					(o.open = e),
						t &&
							(o.open
								? (n.classList.add("open"), (t.style.display = ""))
								: (n.classList.remove("open"), (t.style.display = "none")));
				}
				return (
			...
			rowSelection: function (e, t, i) {
				...
				if (
					((o.type = "checkbox"),
					o.setAttribute("aria-label", "Select Row"),
					...
					if (
						...
						r instanceof L
							? (o.addEventListener("change", function (e) {
									"click" === n.table.options.selectableRangeMode && a
										? (a = !1)
										: r.toggleSelect();
							  }),
							  "click" === this.table.options.selectableRangeMode &&
									o.addEventListener("click", function (e) {
										(a = !0),
											n.table.modules.selectRow.handleComplexRowClick(
												r._row,
												e
											);
									}),
							  (o.checked = r.isSelected && r.isSelected()),
							  this.table.modules.selectRow.registerRowSelectCheckbox(r, o))
							: (o = "");
					} else
						o.addEventListener("change", function (e) {
							n.table.modules.selectRow.selectedRows.length
								? n.table.deselectRow()
								: n.table.selectRow(t.rowRange);
						}),
		...
		Ce = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					(i = n.call(this, e)).registerColumnOption("formatter"),
					i.registerColumnOption("formatterParams"),
					i.registerColumnOption("formatterPrint"),
					i.registerColumnOption("formatterPrintParams"),
					i.registerColumnOption("formatterClipboard"),
					i.registerColumnOption("formatterClipboardParams"),
					i.registerColumnOption("formatterHtmlOutput"),
					i.registerColumnOption("formatterHtmlOutputParams"),
					i.registerColumnOption("titleFormatter"),
					i.registerColumnOption("titleFormatterParams"),
					i
				);
			}
			return (
				o(r, [
					{
						...
						value: function () {
							this.subscribe("cell-format", this.formatValue.bind(this)),
								...
								this.subscribe(
									"column-layout",
									this.initializeColumn.bind(this)
								),
						...
						value: function (e) {
							(e.modules.format = this.lookupFormatter(e, "")),
								...
								void 0 !== e.definition.formatterClipboard &&
									(e.modules.format.clipboard = this.lookupFormatter(
										e,
										"Clipboard"
									)),
					...
					},
					{
						...
						value: function (t, i) {
							var n = {
									params: t.definition["formatter" + i + "Params"] || {},
								},
								o = t.definition["formatter" + i];
							switch (e(o)) {
								case "string":
									r.formatters[o]
										? (n.formatter = r.formatters[o])
										: (console.warn(
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return e.definition.titleFormatter
								? ((n = this.getFormatter(e.definition.titleFormatter)),
								  (a = function (t) {
								  ...
								  (o =
										"function" ==
										typeof (o = e.definition.titleFormatterParams || {})
											? o()
											: o),
								  n.call(this, r, o, a))
								: t;
								...
								return (
									(i =
										"function" == typeof n.params
											? n.params(component)
											: n.params),
									n.formatter.call(this, e.getComponent(), i, function (t) {
										e.modules.format || (e.modules.format = {}),
											(e.modules.format.renderedCallback = t),
											(e.modules.format.rendered = !1);
									})
	...
	var ke = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).leftColumns = []),
				(o.rightColumns = []),
				(o.leftMargin = 0),
				(o.rightMargin = 0),
				(o.rightPadding = 0),
				(o.initializationMode = "left"),
				(o.active = !1),
				(o.blocked = !0),
				o.registerColumnOption("frozen"),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					...
					value: function () {
						this.subscribe("cell-layout", this.layoutCell.bind(this)),
							...
							this.subscribe(
								"column-delete",
								this.reinitializeColumns.bind(this)
							),
				...
				},
				{
					...
					value: function (e) {
						e ||
							((this.leftMargin =
								this._calcSpace(this.leftColumns, this.leftColumns.length) +
								"px"),
							(this.rightMargin =
				...
				},
				{
					...
					value: function (e) {
						var t = this;
						e.forEach(function (e) {
							e.calcs.top && t.layoutRow(e.calcs.top),
								e.calcs.bottom && t.layoutRow(e.calcs.bottom),
								e.groupList &&
									e.groupList.length &&
									t.layoutGroupCalcs(e.groupList && e.groupList);
						});
					},
				},
				{
					...
					value: function (e) {
						...
						(this.table.columnManager.headersElement.style.marginLeft =
							...
							(this.table.columnManager.element.style.paddingRight =
								this.rightMargin),
							this.leftColumns.forEach(function (o, a) {
								if (
									((o.modules.frozen.marginValue =
										n + t.table.columnManager.scrollLeft),
									(o.modules.frozen.margin =
										o.modules.frozen.marginValue + "px"),
									o.visible && (n += o.getWidth()),
									a == t.leftColumns.length - 1
							...
							this.rightColumns.forEach(function (i, n) {
								i.visible && (o += i.getWidth()),
									(i.modules.frozen.marginValue = t.rightPadding - o),
									(i.modules.frozen.margin =
										i.modules.frozen.marginValue + "px"),
									n == t.rightColumns.length - 1
				...
				},
				{
					...
					value: function (e) {
						...
						(e.getElement().style.paddingLeft = this.leftMargin),
							"fitDataFill" === this.table.options.layout &&
					...
					value: function (e, t) {
						t.modules.frozen &&
							...
							t.modules.frozen.edge &&
								e.classList.add(
									"tabulator-frozen-" + t.modules.frozen.position
								));
					},
				},
				{
	...
	var Ee = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).topElement = document.createElement("div")),
				(o.rows = []),
				o.registerComponentFunction("row", "freeze", o.freezeRow.bind(l(o))),
				o.registerComponentFunction(
					"row",
					"unfreeze",
					o.unfreezeRow.bind(l(o))
				),
				o.registerComponentFunction(
					"row",
					"isFrozen",
					o.isRowFrozen.bind(l(o))
				),
				o
			);
		}
	...
	var Re = (function () {
				...
				return (
					...
					new Proxy(this, {
						get: function (e, t, i) {
							return void 0 !== e[t]
								? e[t]
								: e._group.groupManager.table.componentFunctionBinder.handle(
										"row",
										e._group,
										t
								  );
		...
		xe = (function () {
			function e(i, n, o, a, r, s, l) {
				t(this, e),
					...
					(this.level = o),
					(this.field = r),
					(this.hasSubGroups = o < i.groupIDLookups.length - 1),
				...
				o(e, [
						...
						value: function (t, i) {
							var n = i + "_" + t,
								o = new e(
									...
									i,
									t,
									this.groupManager.groupIDLookups[i].field,
									this.groupManager.headerGenerator[i] ||
										this.groupManager.headerGenerator[0],
									!!this.old && this.old.groups[n]
								);
						...
						value: function (e) {
							...
							if (this.hasSubGroups) {
								...
								this.groupManager.allowedValues[t]
									...
									: (this.groups[n] || this._createGroup(i, t),
									  this.groups[n].addRow(e));
							}
						},
					},
					{
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							o > -1
								? i
									? this.rows.splice(o + 1, 0, e)
									: this.rows.splice(o, 0, e)
								: i
								? this.rows.push(e)
								: this.rows.unshift(e),
							...
							t > -1 && this.rows.splice(t, 1),
								this.groupManager.table.options.groupValues || this.rows.length
									? (i.parentNode && i.parentNode.removeChild(i),
									  ...
									  this.groupManager.table.modExists("columnCalcs") &&
											"table" != this.groupManager.table.options.columnCalcs &&
											this.groupManager.table.modules.columnCalcs.recalcGroup(
												this
											))
									: (this.parent
						...
						value: function () {
							var e =
								arguments.length > 0 && void 0 !== arguments[0]
									...
									: [];
							return (
								e.unshift(this.key), this.parent && this.parent.getPath(e), e
							);
						},
					},
					{
					...
					},
					{
						...
						value: function () {
							(this.initialized = !1),
								(this.height = 0),
								k.elVisible(this.element) && this.initialize(!0);
						},
					},
					{
						key: "setHeight",
					...
					{ key: "deinitializeHeight", value: function () {} },
					{
						...
						value: function () {
							return (
								this.component || (this.component = new Re(this)),
								this.component
							);
						},
					},
		...
		Te = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).groupIDLookups = !1),
					(o.startOpen = [
						function () {
							return !1;
						},
					...
					(o.groups = {}),
					(o.displayIndex = 0),
					(o.displayHandler = o.getRows.bind(l(o))),
					o.registerTableOption("groupBy", !1),
					o.registerTableOption("groupStartOpen", !0),
					o.registerTableOption("groupValues", !1),
					o.registerTableOption("groupUpdateOnCellEdit", !1),
					o.registerTableOption("groupHeader", !1),
					o.registerTableOption("groupHeaderPrint", null),
					o.registerTableOption("groupHeaderClipboard", null),
					o.registerTableOption("groupHeaderHtmlOutput", null),
					o.registerTableOption("groupHeaderDownload", null),
					o.registerTableOption("groupToggleElement", "arrow"),
					o.registerTableOption("groupClosedShowCalcs", !1),
					o.registerTableFunction("setGroupBy", o.setGroupBy.bind(l(o))),
					o.registerTableFunction(
						"setGroupValues",
						o.setGroupValues.bind(l(o))
					),
					o.registerTableFunction(
						"setGroupStartOpen",
						o.setGroupStartOpen.bind(l(o))
					),
					o.registerTableFunction(
						"setGroupHeader",
						o.setGroupHeader.bind(l(o))
					),
					o.registerTableFunction("getGroups", o.userGetGroups.bind(l(o))),
					o.registerTableFunction(
						"getGroupedData",
						o.userGetGroupedData.bind(l(o))
					),
					o.registerComponentFunction(
						"row",
						"getGroup",
						o.rowGetGroup.bind(l(o))
					),
					o
				);
			}
				...
				o(n, [
					{
						...
						value: function () {
							this.table.options.groupBy &&
								...
								this.subscribe(
									"table-built",
									this.configureGroupSetup.bind(this)
								),
								this.subscribe("row-deleting", this.rowDeleting.bind(this)),
								this.subscribe("row-deleted", this.rowsUpdated.bind(this)),
								this.subscribe(
									"scroll-horizontal",
									this.scrollHeaders.bind(this)
								),
						...
						value: function () {
							...
							if (this.table.options.groupBy) {
								var t = this.table.options.groupBy,
									i = this.table.options.groupStartOpen,
								...
								Array.isArray(t) || (t = [t]),
									t.forEach(function (t, i) {
										...
										(n =
											"function" == typeof t
												? t
												: (o = e.table.columnManager.getColumnByField(t))
												? function (e) {
									...
									i &&
										...
										i.forEach(function (e) {}),
										(this.startOpen = i)),
									n && (this.headerGenerator = Array.isArray(n) ? n : [n]);
							}
						},
					},
					{
					...
					},
					{
						...
						value: function (e) {
							(this.table.options.groupStartOpen = e),
								this.configureGroupSetup(),
								this.table.options.groupBy
									? (this.refreshData(), this.trackChanges())
									: console.warn(
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							var n = t instanceof xe ? t : t.modules.group,
								o = e instanceof xe ? e : e.modules.group;
							n === o
								? this.table.rowManager.moveRowInArray(n.rows, e, t, i)
								: (o && o.removeRow(e), n.insertRow(e, t, i));
						},
					},
					{
						key: "rowDeleting",
						...
						value: function (e) {
							return this.table.options.groupBy && this.groupIDLookups.length
								? (this.dispatchExternal("dataGrouping"),
								  ...
								  this.subscribedExternal("dataGrouped") &&
										this.dispatchExternal("dataGrouped", this.getGroups(!0)),
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								e.forEach(function (e) {
									var n = { level: 0, rowCount: 0, headerContent: "" },
										o = [];
									e.hasSubGroups
										? ((o = t.pullGroupListData(e.groupList)),
										  (n.level = e.level),
										  (n.rowCount = o.length - e.groupList.length),
										  (n.headerContent = e.generator(
												e.key,
												n.rowCount,
												e.rows,
												e
						...
						value: function (e) {
							...
							return (
								this.options("dataTree") &&
									(e = this.table.modules.dataTree.getTreeParentRoot(e)),
								this.groupList.forEach(function (i) {
									var n = i.getRowGroup(e);
									n && (t = n);
								}),
					...
					},
					{
						...
						value: function (e) {
							...
							return (
								...
								e && this.refreshData(!0, this.displayHandler),
								t
							);
						},
					},
					{
						...
						value: function (e) {
							"virtual" === this.table.options.renderHorizontal &&
								(e -= this.table.columnManager.renderer.vDomPadLeft),
								(e += "px"),
								this.groupList.forEach(function (t) {
									t.scrollHeader(e);
								});
	...
	var Me = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).history = []),
				(o.index = -1),
				o.registerTableOption("history", !1),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					...
					value: function (e) {
						var t, i;
						this.table.options.groupBy
							? (t = (i = e.getComponent().getGroup().rows).indexOf(e)) &&
							  (t = i[t - 1])
							: (t = e.table.rowManager.getRowIndex(e)) &&
							  (t = e.table.rowManager.rows[t - 1]),
				...
				},
				{
					...
					value: function (e, t) {
						this.history.forEach(function (i) {
							if (i.component instanceof D)
								i.component === e && (i.component = t);
							else if (i.component instanceof w && i.component.row === e) {
		...
		return (
			o(r, [
				...
				},
				{
					...
					value: function () {
						var e = this.table.originalElement,
							...
							i = (t.columns, e.getElementsByTagName("th")),
						...
						(this.hasIndex = !1),
							...
							i.length
								? this._extractHeaders(i, n)
								: this._generateBlankHeaders(i, n);
						for (var a = 0; a < n.length; a++) {
							var r = n[a].getElementsByTagName("td"),
								s = {};
							this.hasIndex || (s[t.index] = a);
							for (var l = 0; l < r.length; l++) {
								var u = r[l];
								void 0 !== this.fieldIndex[l] &&
									(s[this.fieldIndex[l]] = u.innerHTML);
							}
							o.push(s);
						}
				...
				},
				{
					...
					value: function (t, i, n) {
						var o = t.attributes,
							a = n ? Object.keys(n) : Object.keys(i),
							r = {};
						...
						o)) {
							...
							u &&
								...
								void 0 !== r[l] && (i[r[l]] = this._attribValue(u.value)));
						}
					},
				},
				{
				...
				},
				{
					...
					value: function (e, t) {
						for (var i = 0; i < e.length; i++) {
							...
							r ? (a = !0) : (r = { title: o.textContent.trim() }),
								r.field ||
									(r.field = o.textContent
										.trim()
										.toLowerCase()
										.replace(" ", "_")),
								(n = o.getAttribute("width")) && !r.width && (r.width = n),
	...
	var De = {
			...
			json: function (e) {
				try {
					...
					return (
						console.warn(
							"JSON Import Error - File contents is invalid JSON",
							e
						),
						Promise.reject()
					);
		...
		Se = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					(o = i.call(this, e)).registerTableOption("importFormat"),
					o.registerTableOption("importReader", "text"),
					o
				);
			}
			return (
				o(n, [
					{
						...
						value: function () {
							this.registerTableFunction(
								"import",
								this.importFromFile.bind(this)
							),
								this.table.options.importFormat &&
									(this.subscribe(
										"data-loading",
										this.loadDataCheck.bind(this),
										10
									),
					...
					},
					{
						...
						value: function (e) {
							var t;
							return (
								e || (e = this.table.options.importFormat),
								(t = "string" == typeof e ? n.importers[e] : e) ||
									console.error("Import Error - Importer not found:", e),
								t
							);
						},
					},
					...
					},
					{
						key: "structureData",
						value: function (e) {
							return Array.isArray(e) && e.length && Array.isArray(e[0])
								? this.table.options.autoColumns
									? this.structureArrayToObject(e)
									: this.structureArrayToColumns(e)
								: e;
						},
					},
					{
	...
	var Pe = (function (e) {
		...
		function n(e) {
			...
			return (
				...
				o.registerColumnOption("headerClick"),
				o.registerColumnOption("headerDblClick"),
				o.registerColumnOption("headerContext"),
				o.registerColumnOption("headerMouseEnter"),
				o.registerColumnOption("headerMouseLeave"),
				o.registerColumnOption("headerMouseOver"),
				o.registerColumnOption("headerMouseOut"),
				o.registerColumnOption("headerMouseMove"),
				o.registerColumnOption("headerTap"),
				o.registerColumnOption("headerDblTap"),
				o.registerColumnOption("headerTapHold"),
				o.registerColumnOption("cellClick"),
				o.registerColumnOption("cellDblClick"),
				o.registerColumnOption("cellContext"),
				o.registerColumnOption("cellMouseEnter"),
				o.registerColumnOption("cellMouseLeave"),
				o.registerColumnOption("cellMouseOver"),
				o.registerColumnOption("cellMouseOut"),
				o.registerColumnOption("cellMouseMove"),
				o.registerColumnOption("cellTap"),
				o.registerColumnOption("cellDblTap"),
				o.registerColumnOption("cellTapHold"),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					...
					value: function (e, t) {
						if (
							...
							this.table.modules.edit.currentCell !== this
						) {
							e.preventDefault();
							try {
								if (document.selection)
									...
									var i;
									(i = document.createRange()).selectNode(this.element),
										window.getSelection().removeAllRanges(),
				...
				},
				{
					...
					value: function () {
						for (var e in this.eventMap)
							this.subscriptionChangeExternal(
								e,
								this.subscriptionChanged.bind(this, e)
							);
					},
				},
				{
						...
						t
							? this.subscribers[e] ||
							  (this.eventMap[e].includes("-")
									? ((this.subscribers[e] = this.handle.bind(this, e)),
									  this.subscribe(this.eventMap[e], this.subscribers[e]))
									: this.subscribeTouchEvents(e))
							: this.eventMap[e].includes("-")
							? !this.subscribers[e] ||
							  this.columnSubscribers[e] ||
							  this.subscribedExternal(e) ||
							  (this.unsubscribe(this.eventMap[e], this.subscribers[e]),
							  delete this.subscribers[e])
							: this.unsubscribeTouchEvents(e);
					},
				},
				{
					...
					value: function (e) {
						...
						this.touchSubscribers[t + "-touchstart"] ||
							((this.touchSubscribers[t + "-touchstart"] =
								this.handleTouch.bind(this, t, "start")),
							(this.touchSubscribers[t + "-touchend"] = this.handleTouch.bind(
								this,
								t,
								"end"
							)),
							...
							this.subscribe(
								t + "-touchend",
								this.touchSubscribers[t + "-touchend"]
							)),
				...
				},
				{
					...
					value: function (e) {
						...
						if (this.subscribers[e] && !this.subscribedExternal(e)) {
							for (var n in (delete this.subscribers[e], this.eventMap))
								this.eventMap[n] === i && this.subscribers[n] && (t = !1);
							t &&
								(this.unsubscribe(
									i + "-touchstart",
									this.touchSubscribers[i + "-touchstart"]
								),
								this.unsubscribe(
									i + "-touchend",
									this.touchSubscribers[i + "-touchend"]
								),
				...
				},
				{
					...
					value: function (e, t, i, n) {
						var o = this,
							a = this.touchWatchers[e];
						switch (("column" === e && (e = "header"), t)) {
							case "start":
								(a.tap = !0),
									clearTimeout(a.tapHold),
									(a.tapHold = setTimeout(function () {
										clearTimeout(a.tapHold),
											(a.tapHold = null),
											(a.tap = null),
											clearTimeout(a.tapDbl),
											(a.tapDbl = null),
											o.dispatchEvent(e + "TapHold", i, n);
									}, 1e3));
								break;
							case "end":
								a.tap && ((a.tap = null), this.dispatchEvent(e + "Tap", i, n)),
									a.tapDbl
										? (clearTimeout(a.tapDbl),
										  (a.tapDbl = null),
										  this.dispatchEvent(e + "DblTap", i, n))
										: (a.tapDbl = setTimeout(function () {
				...
				},
				{
					...
					value: function (e, t, i) {
						...
						this.columnSubscribers[e] &&
							(i instanceof w
								? (n = i.column.definition[e])
								: i instanceof C && (n = i.definition[e]),
							n && n(t, o)),
	...
	var ze = (function (i) {
		...
		function r(e) {
			...
			return (
				t(this, r),
				((i = n.call(this, e)).watchKeys = null),
				(i.pressedKeys = null),
				(i.keyupBinding = !1),
				(i.keydownBinding = !1),
				i.registerTableOption("keybindings", {}),
				i.registerTableOption("tabEndNewRow", !1),
				i
			);
		}
		return (
	...
	var Fe = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).menuContainer = null),
				(o.nestedMenuBlock = !1),
				(o.currentComponent = null),
				(o.rootPopup = null),
				(o.columnSubscribers = {}),
				o.registerTableOption("menuContainer", void 0),
				o.registerTableOption("rowContextMenu", !1),
				o.registerTableOption("rowClickMenu", !1),
				o.registerTableOption("groupContextMenu", !1),
				o.registerTableOption("groupClickMenu", !1),
				o.registerColumnOption("headerContextMenu"),
				o.registerColumnOption("headerClickMenu"),
				o.registerColumnOption("headerMenu"),
				o.registerColumnOption("headerMenuIcon"),
				o.registerColumnOption("contextMenu"),
				o.registerColumnOption("clickMenu"),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					...
					value: function () {
						void 0 !== this.table.options.menuContainer &&
							(console.warn(
				...
				},
				{
					...
					value: function (e) {
						...
						t.headerContextMenu &&
							...
							t.clickMenu &&
								!this.columnSubscribers.clickMenu &&
								((this.columnSubscribers.clickMenu =
									this.loadMenuTableCellEvent.bind(this, "clickMenu")),
				...
				},
				{
					...
					value: function (e) {
						var t,
							i = this,
							n = e.definition.headerMenuIcon;
						(t = document.createElement("span")).classList.add(
							"tabulator-header-popup-button"
						),
							n
								? ("function" == typeof n && (n = n(e.getComponent())),
							...
							t.addEventListener("click", function (t) {
								t.stopPropagation(),
									t.preventDefault(),
									i.loadMenuEvent(e.definition.headerMenu, t, e);
							}),
				...
				},
				{
					...
					value: function (e, t, i) {
						i._cell && (i = i._cell),
							i.column.definition[e] &&
								this.loadMenuEvent(i.column.definition[e], t, i);
					},
				},
				{
				...
				},
				{
					...
					value: function (e, t, i) {
						i._group ? (i = i._group) : i._row && (i = i._row),
							(e =
								"function" == typeof e
									? e.call(this.table, t, i.getComponent())
									: e),
							this.loadMenu(t, i, e);
					},
				},
				{
					...
					value: function (e, t, i, n, o) {
						...
						if (
							(l.classList.add("tabulator-menu"),
							s || e.preventDefault(),
							i && i.length)
						) {
							if (n) a = o.child(l);
							...
							i.forEach(function (e) {
								...
								e.separator
									...
									: (i.classList.add("tabulator-menu-item"),
									  "function" == typeof n &&
											(n = n.call(r.table, t.getComponent())),
									  n instanceof Node ? i.appendChild(n) : (i.innerHTML = n),
									  "function" == typeof o &&
											(o = o.call(r.table, t.getComponent())),
									  o
									...
									(this.rootPopup.hideOnBlur(function () {
										(r.rootPopup = null),
											r.currentComponent &&
												(r.dispatchExternal(
													"menuClosed",
													r.currentComponent.getComponent()
												),
												(r.currentComponent = null));
									}),
	...
	var He = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).placeholderElement =
					o.createPlaceholderElement()),
				(o.hoverElement = !1),
				(o.checkTimeout = !1),
				(o.checkPeriod = 250),
				(o.moving = !1),
				...
				(o.toColAfter = !1),
				(o.startX = 0),
				(o.autoScrollMargin = 40),
				(o.autoScrollStep = 5),
				(o.autoScrollTimeout = !1),
				(o.touchMove = !1),
				(o.moveHover = o.moveHover.bind(l(o))),
				(o.endMove = o.endMove.bind(l(o))),
				o.registerTableOption("movableColumns", !1),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					key: "initialize",
					value: function () {
						this.table.options.movableColumns &&
							this.subscribe("column-init", this.initializeColumn.bind(this));
					},
				},
				{
						...
						e.modules.frozen ||
							...
							(n.mousemove = function (n) {
								e.parent === i.moving.parent &&
									((i.touchMove ? n.touches[0].pageX : n.pageX) -
										k.elOffset(t).left +
				...
				},
				{
					...
					value: function (e, t) {
						var i = t.getElement(),
							n = this.table.columnManager.getElement(),
						...
						(this.moving = t),
							...
							(this.hoverElement.style.bottom =
								n.clientHeight - o.offsetHeight + "px"),
							this.touchMove ||
								(this._bindMouseMove(),
						...
						(this.toCol = e),
							...
							t
								...
								: e.getCells().forEach(function (e, t) {
										...
										n.parentNode &&
											i[t] &&
											n.parentNode.insertBefore(i[t].getElement(), n);
								  });
					},
				},
				{
					...
					value: function (e) {
						var t,
							...
							a =
								...
								k.elOffset(n).left +
								o;
						(this.hoverElement.style.left = a - this.startX + "px"),
							a - o < this.autoScrollMargin &&
							...
							o + n.clientWidth - a < this.autoScrollMargin &&
								(this.autoScrollTimeout ||
									(this.autoScrollTimeout = setTimeout(function () {
										(t = Math.min(n.clientWidth, o + 5)),
											(i.table.rowManager.getElement().scrollLeft = t),
											(i.autoScrollTimeout = !1);
									}, 1)));
					},
	...
	var _e = (function (i) {
		...
		function r(e) {
			...
			return (
				t(this, r),
				((i = n.call(this, e)).placeholderElement =
					i.createPlaceholderElement()),
				(i.hoverElement = !1),
				(i.checkTimeout = !1),
				(i.checkPeriod = 150),
				(i.moving = !1),
				...
				(i.startY = 0),
				(i.startX = 0),
				(i.moveHover = i.moveHover.bind(l(i))),
				(i.endMove = i.endMove.bind(l(i))),
				(i.tableRowDropEvent = !1),
				(i.touchMove = !1),
				(i.connection = !1),
				(i.connectionSelectorsTables = !1),
				(i.connectionSelectorsElements = !1),
				(i.connectionElements = []),
				(i.connections = []),
				(i.connectedTable = !1),
				(i.connectedRow = !1),
				i.registerTableOption("movableRows", !1),
				i.registerTableOption("movableRowsConnectedTables", !1),
				i.registerTableOption("movableRowsConnectedElements", !1),
				i.registerTableOption("movableRowsSender", !1),
				i.registerTableOption("movableRowsReceiver", "insert"),
				i.registerColumnOption("rowHandle"),
				i
			);
		}
		return (
			o(r, [
					...
					value: function (e) {
						...
						(i.mouseup = function (e) {
							...
							(i.mousemove = function (i) {
								var n;
								i.pageY -
									k.elOffset(e.element).top +
									t.table.rowManager.element.scrollTop >
								e.getHeight() / 2
									? (t.toRow === e && t.toRowAfter) ||
									  ((n = e.getElement()).parentNode.insertBefore(
											t.placeholderElement,
											n.nextSibling
									  ),
									  t.moveRow(e, !0))
									: (t.toRow !== e || t.toRowAfter) &&
									  (n = e.getElement()).previousSibling &&
									  (n.parentNode.insertBefore(t.placeholderElement, n),
									  t.moveRow(e, !1));
							}.bind(t)),
							(e.modules.moveRow = i);
					},
							...
							(n.mousemove = function (t) {
								...
								e.getHeight() / 2
									? (i.toRow === e && i.toRowAfter) ||
									  ...
									  i.moveRow(e, !0))
									: (i.toRow !== e || i.toRowAfter) &&
									  (n.parentNode.insertBefore(i.placeholderElement, n),
									  i.moveRow(e, !1));
							}.bind(i)),
							this.hasHandle ||
								((t = e.getElement()).addEventListener(
									"mousedown",
									function (t) {
										1 === t.which &&
											(i.checkTimeout = setTimeout(function () {
						...
						(i = t.getElement()),
							this.connection
								? ((n = i.getBoundingClientRect()),
								  (this.startX = n.left - o + window.pageXOffset),
								  (this.startY = n.top - a + window.pageYOffset))
								: (this.startY = a - i.getBoundingClientRect().top);
					},
				},
				{
					key: "endMove",
				...
				},
				{
					...
					value: function (e) {
						var t,
							i = this;
						this.connectionSelectorsTables &&
							((t = this.commsConnections(this.connectionSelectorsTables)),
				...
				},
				{
					...
					value: function () {
						var e;
						this.connectionSelectorsTables &&
							((e = this.commsConnections(this.connectionSelectorsTables)),
				...
				},
				{
					...
					value: function (t, i) {
						...
						switch (
							(t.stopImmediatePropagation(),
							e(this.table.options.movableRowsReceiver))
						) {
							case "string":
	...
	var Oe = (function (i) {
		...
		function r(e) {
			...
			return (
				...
				(i.enabled = !0),
				i.registerColumnOption("mutator"),
				i.registerColumnOption("mutatorParams"),
				i.registerColumnOption("mutatorData"),
				i.registerColumnOption("mutatorDataParams"),
				i.registerColumnOption("mutatorEdit"),
				i.registerColumnOption("mutatorEditParams"),
				i.registerColumnOption("mutatorClipboard"),
				i.registerColumnOption("mutatorClipboardParams"),
				i.registerColumnOption("mutateLink"),
				i
			);
		}
		return (
			o(r, [
				...
				},
				{
					...
					value: function (e) {
						...
						this.allowedTypes.forEach(function (o) {
							var a,
								r = "mutator" + (o.charAt(0).toUpperCase() + o.slice(1));
							e.definition[r] &&
								(a = t.lookupMutator(e.definition[r])) &&
								((i = !0),
								(n[r] = {
									mutator: a,
									params: e.definition[r + "Params"] || {},
						...
						return (
							this.enabled &&
								this.table.columnManager.traverse(function (a) {
									...
									a.modules.mutate &&
										(r =
											a.modules.mutate[o] || a.modules.mutate.mutator || !1) &&
										((n = a.getFieldValue(void 0 !== i ? i : e)),
										("data" != t && void 0 === n) ||
											((l = a.getComponent()),
											(s =
												"function" == typeof r.params
													? r.params(n, e, t, l)
													: r.params),
											a.setFieldValue(e, r.mutator(n, e, t, s, l))));
								}),
							e
						);
					},
				},
				{
					...
					value: function (e, t) {
						if (e.column.modules.mutate) {
							...
							if (i)
								return (
									(n = Object.assign(n, e.row.getData())),
									e.column.setFieldValue(n, t),
									i.mutator(t, n, "edit", i.params, e.getComponent())
								);
						}
						return t;
					},
	...
	var Ae = {
			rows: function (e, t, i, n, o) {
				...
				return (
					...
					n
						? ((s.innerHTML = " " + t + "-" + Math.min(t + e - 1, n) + " "),
						  (u.innerHTML = " " + n + " "),
						  a.appendChild(r),
						  a.appendChild(s),
						  a.appendChild(l),
		...
		Be = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).mode = "local"),
					(i.progressiveLoad = !1),
					(i.element = null),
					(i.pageCounterElement = null),
					(i.pageCounter = null),
					(i.size = 0),
					(i.page = 1),
					(i.count = 5),
					(i.max = 1),
					(i.remoteRowCountEstimate = null),
					(i.displayIndex = 0),
					(i.initialLoad = !0),
					(i.dataChanging = !1),
					(i.pageSizes = []),
					i.registerTableOption("pagination", !1),
					i.registerTableOption("paginationMode", "local"),
					i.registerTableOption("paginationSize", !1),
					i.registerTableOption("paginationInitialPage", 1),
					i.registerTableOption("paginationCounter", !1),
					i.registerTableOption("paginationCounterElement", !1),
					i.registerTableOption("paginationButtonCount", 5),
					i.registerTableOption("paginationSizeSelector", !1),
					i.registerTableOption("paginationElement", !1),
					i.registerTableOption("paginationAddRow", "page"),
					i.registerTableOption("progressiveLoad", !1),
					i.registerTableOption("progressiveLoadDelay", 0),
					i.registerTableOption("progressiveLoadScrollMargin", 0),
					i.registerTableFunction("setMaxPage", i.setMaxPage.bind(l(i))),
					i.registerTableFunction("setPage", i.setPage.bind(l(i))),
					i.registerTableFunction(
						"setPageToRow",
						i.userSetPageToRow.bind(l(i))
					),
					i.registerTableFunction("setPageSize", i.userSetPageSize.bind(l(i))),
					i.registerTableFunction("getPageSize", i.getPageSize.bind(l(i))),
					i.registerTableFunction("previousPage", i.previousPage.bind(l(i))),
					i.registerTableFunction("nextPage", i.nextPage.bind(l(i))),
					i.registerTableFunction("getPage", i.getPage.bind(l(i))),
					i.registerTableFunction("getPageMax", i.getPageMax.bind(l(i))),
					i.registerComponentFunction(
						"row",
						"pageTo",
						i.setPageToRow.bind(l(i))
					),
					i
				);
			}
			return (
				o(r, [
						...
						value: function () {
							this.table.options.pagination
								? (this.subscribe("row-deleted", this.rowsUpdated.bind(this)),
								  ...
								  this.subscribe(
										"table-built",
										this.calculatePageSizes.bind(this)
								  ),
								  ...
								  "remote" === this.table.options.paginationMode &&
										(this.subscribe(
											"data-params",
											this.remotePageParams.bind(this)
										),
										this.subscribe(
											"data-loaded",
											this._parseRemoteData.bind(this)
										)),
								  ...
								  this.registerDisplayHandler(
										this.restOnRenderBefore.bind(this),
										40
								  ),
								...
								: this.table.options.progressiveLoad &&
								  ...
								  this.initializeProgressive(
										this.table.options.progressiveLoad
								  ),
								  "scroll" === this.table.options.progressiveLoad &&
										this.subscribe(
											"scroll-vertical",
											this.scrollVertical.bind(this)
										));
						},
					},
					{
							...
							return (
								t
									? o.length
										? (i = o[0])
										: n.activeRows.length &&
										  ((i = n.activeRows[n.activeRows.length - 1]), (t = !1))
									: o.length &&
									  ((i = o[o.length - 1]), (t = !(o.length < this.size))),
								{ index: i, top: t }
							);
						},
					},
					...
					},
					{
						...
						value: function (e) {
							return this.table.options.pagination &&
								(e = this.rowManager.findRow(e))
								? this.setPageToRow(e)
								: Promise.reject();
						},
					},
					{
						...
						value: function (e) {
							return (
								!!this.table.options.pagination &&
								(this.setPageSize(e), this.setPage(1))
							);
						},
					},
					{
						...
						value: function (e, t) {
							...
							t ||
								...
								((i = this.table.rowManager.getElement()).scrollHeight -
									i.clientHeight -
									e <
									(this.table.options.progressiveLoadScrollMargin ||
										2 * i.clientHeight) &&
									this.nextPage().catch(function () {}));
						},
					},
					{
							...
							if (this.pageSizeSelect) {
								if (Array.isArray(this.table.options.paginationSizeSelector))
									(t = this.table.options.paginationSizeSelector),
										(this.pageSizes = t),
										-1 == this.pageSizes.indexOf(this.size) &&
											t.unshift(this.size);
								...
								for (; this.pageSizeSelect.firstChild; )
									this.pageSizeSelect.removeChild(
										this.pageSizeSelect.firstChild
									);
								t.forEach(function (t) {
									var i = document.createElement("option");
									(i.value = t),
										!0 === t
											? e.langBind("pagination|all", function (e) {
													i.innerHTML = e;
											  })
											: (i.innerHTML = t),
					...
					},
					{
						...
						value: function () {
							var e = this.table.options.paginationCounter,
								t = null;
							e &&
								((t = "function" == typeof e ? e : r.pageCounters[e])
									? ((this.pageCounter = t),
									  (this.pageCounterElement = document.createElement("span")),
									  this.pageCounterElement.classList.add(
					...
					},
					{
						...
						value: function (e) {
							var t,
								...
								n = this;
							e ||
								(this.langBind("pagination|first", function (e) {
								...
								this.pageSizeSelect &&
									...
									this.langBind("pagination|page_size", function (e) {
					...
					},
					{
						...
						value: function (e) {
							(e = parseInt(e)),
								(this.max = e || 1),
								this.page > this.max &&
									((this.page = this.max), this.trigger());
						},
					},
					{
						key: "setPage",
						value: function (e) {
							...
							return ((e = parseInt(e)) > 0 && e <= this.max) ||
								"local" !== this.mode
								? ((this.page = e), this.trackChanges(), this.trigger())
								: (console.warn(
					...
					},
					{
						...
						value: function (e) {
							var t = this.table.rowManager
								.getDisplayRows(this.displayIndex - 1)
								.indexOf(e);
							if (t > -1) {
						...
						value: function (t, i, n) {
							...
							if (this.pageCounter)
								switch (
									("remote" === this.mode &&
										((i = this.size),
										(n = (this.page - 1) * this.size + 1),
										(t = this.remoteRowCountEstimate)),
									e(
										(o = this.pageCounter.call(
											this,
											i,
											n,
											this.page,
					...
					},
					{
						...
						value: function () {
							for (
								var e = Math.floor((this.count - 1) / 2),
									t = Math.ceil((this.count - 1) / 2),
									i =
										this.max - this.page + e + 1 < this.count
											? this.max - this.count + 1
											: Math.max(this.page - e, 1),
									n =
										this.page <= t
											? Math.min(this.count, this.max)
											: Math.min(this.page + t, this.max);
								this.pagesElement.firstChild;

							)
								this.pagesElement.removeChild(this.pagesElement.firstChild);
							1 == this.page
								? ((this.firstBut.disabled = !0), (this.prevBut.disabled = !0))
								: ((this.firstBut.disabled = !1), (this.prevBut.disabled = !1)),
								this.page == this.max
									? ((this.lastBut.disabled = !0), (this.nextBut.disabled = !0))
									: ((this.lastBut.disabled = !1),
									  (this.nextBut.disabled = !1));
							for (var o = i; o <= n; o++)
								o > 0 &&
									o <= this.max &&
									this.pagesElement.appendChild(this._generatePageButton(o));
							this.footerRedraw();
						},
					},
					{
						...
						value: function (e) {
							...
							return (
								...
								e == this.page && i.classList.add("active"),
								i.setAttribute("type", "button"),
								i.setAttribute("role", "button"),
								this.langBind("pagination|page_title", function (t) {
					...
					},
					{
						...
						value: function (e) {
							...
							if ("local" == this.mode) {
								...
								return (
									this._setPageCounter(r.length, a, o ? r.indexOf(o) + 1 : 0), t
								);
							}
							return (
								this._setPageButtons(),
					...
					},
					{
						...
						value: function () {
							...
							switch (this.mode) {
								case "local":
									return (
										(e = this.table.rowManager.scrollLeft),
										this.refreshData(),
										this.table.rowManager.scrollHorizontal(e),
								...
								case "remote":
									return (
										(this.dataChanging = !0),
										this.reloadData(null).finally(function () {
											t.dataChanging = !1;
										})
									);
					...
					},
					{
						...
						value: function (e) {
							...
							if (
								(void 0 === e.last_page &&
									console.warn(
										"Remote Pagination Error - Server response missing '" +
											(this.options("dataReceiveParams").last_page ||
												"last_page") +
											"' property"
									),
								e.data)
								...
								if (
									((this.max = parseInt(e.last_page) || 1),
									(this.remoteRowCountEstimate =
										void 0 !== e.last_row
											? e.last_row
											: e.last_page * this.size -
											  (this.page == e.last_page
									...
									switch (this.mode) {
										case "progressive_load":
											1 == this.page
												...
												: this.table.rowManager.addRows(e.data),
												this.page < this.max &&
													setTimeout(function () {
														i.nextPage();
										...
										case "progressive_scroll":
											(e =
												1 === this.page
													? e.data
													: this.table.rowManager.getData().concat(e.data)),
												this.table.rowManager.setData(
													e,
													1 !== this.page,
													1 == this.page
												...
												this.table.rowManager.element.scrollHeight <=
													this.table.rowManager.element.clientHeight + t &&
													this.page < this.max &&
													setTimeout(function () {
														i.nextPage();
													});
	...
	var Ie = {
		...
		Ve = (function (e) {
			...
			function n(e) {
				...
				return (
					t(this, n),
					((o = i.call(this, e)).mode = ""),
					(o.id = ""),
					(o.defWatcherBlock = !1),
					(o.config = {}),
					(o.readFunc = !1),
					(o.writeFunc = !1),
					o.registerTableOption("persistence", !1),
					o.registerTableOption("persistenceID", ""),
					o.registerTableOption("persistenceMode", !0),
					o.registerTableOption("persistenceReaderFunc", !1),
					o.registerTableOption("persistenceWriterFunc", !1),
					o
				);
			}
			return (
				o(n, [
							...
							if (this.table.options.persistence) {
								...
								(this.mode =
									...
									this.table.options.persistenceReaderFunc
										? "function" ==
										  typeof this.table.options.persistenceReaderFunc
											? (this.readFunc =
													this.table.options.persistenceReaderFunc)
											: n.readers[this.table.options.persistenceReaderFunc]
											? (this.readFunc =
													n.readers[this.table.options.persistenceReaderFunc])
											: console.warn(
										...
										: n.readers[this.mode]
										? (this.readFunc = n.readers[this.mode])
										: console.warn(
												"Persistence Read Error - invalid reader set",
												this.mode
										  ),
									this.table.options.persistenceWriterFunc
										? "function" ==
										  typeof this.table.options.persistenceWriterFunc
											? (this.writeFunc =
													this.table.options.persistenceWriterFunc)
											: n.writers[this.table.options.persistenceWriterFunc]
											? (this.writeFunc =
													n.writers[this.table.options.persistenceWriterFunc])
											: console.warn(
										...
										: n.writers[this.mode]
										? (this.writeFunc = n.writers[this.mode])
										: console.warn(
									...
									this.subscribe(
										"sort-changed",
										this.eventSave.bind(this, "sort")
									),
									this.subscribe(
										"group-changed",
										this.eventSave.bind(this, "group")
									),
									this.subscribe(
										"page-changed",
										this.eventSave.bind(this, "page")
									),
									this.subscribe(
										"column-resized",
					...
					},
					{
						...
						value: function () {
							...
							this.config.sort &&
								!1 == !(e = this.load("sort")) &&
								(this.table.options.initialSort = e),
								this.config.filter &&
									!1 == !(t = this.load("filter")) &&
									(this.table.options.initialFilter = t);
						},
					},
					{
						key: "tableRedraw",
						...
						value: function (e) {
							return (
								this.table.columnManager.setColumns(
									this.mergeDefinition(this.table.options.columns, e)
								),
								!0
							);
						},
								...
								(t = t || []).forEach(function (t, o) {
									...
									r &&
										(!0 === i.config.columns || null == i.config.columns
											? (a = Object.keys(r)).push("width")
											: (a = i.config.columns),
										a.forEach(function (e) {
											"columns" !== e && void 0 !== t[e] && (r[e] = t[e]);
										}),
										r.columns &&
											(r.columns = i.mergeDefinition(r.columns, t.columns)),
										n.push(r));
								}),
								e.forEach(function (e, o) {
									i._findColumn(t, e) ||
										(n.length > o ? n.splice(o, 0, e) : n.push(e));
								}),
								n
							);
						},
						...
						value: function () {
							...
							return (
								this.config.page &&
									...
									(!0 === this.config.page || this.config.page.page) &&
										(e.paginationInitialPage =
											this.table.modules.page.getPage())),
								e
							);
						},
					},
						...
						value: function (e) {
							...
							return (
								e.forEach(function (e) {
									...
									e.isGroup
										? ((a.title = r.title),
										  (a.columns = t.parseColumns(e.getColumns())))
										: ((a.field = e.getField()),
										  !0 === t.config.columns || null == t.config.columns
												? ((o = Object.keys(r)).push("width"),
												  o.push("visible"))
												: (o = t.config.columns),
	...
	(Ve.moduleName = "persistence"),
		(Ve.moduleInitOrder = -10),
		(Ve.readers = Ie),
		(Ve.writers = Ne);
	var We = (function (e) {
		a(n, e);
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).columnSubscribers = {}),
				o.registerTableOption("rowContextPopup", !1),
				o.registerTableOption("rowClickPopup", !1),
				o.registerTableOption("groupContextPopup", !1),
				o.registerTableOption("groupClickPopup", !1),
				o.registerColumnOption("headerContextPopup"),
				o.registerColumnOption("headerClickPopup"),
				o.registerColumnOption("headerPopup"),
				o.registerColumnOption("headerPopupIcon"),
				o.registerColumnOption("contextPopup"),
				o.registerColumnOption("clickPopup"),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					...
					value: function () {
						this.table.options.rowContextPopup &&
							...
							this.table.options.rowClickPopup &&
								this.subscribe(
									"row-click",
									this.loadPopupEvent.bind(
										this,
				...
				},
				{
					...
					value: function () {
						this.table.options.groupContextPopup &&
							...
							this.table.options.groupClickPopup &&
								this.subscribe(
									"group-click",
									this.loadPopupEvent.bind(
										this,
				...
				},
				{
					...
					value: function (e) {
						var t = e.definition;
						t.headerContextPopup &&
							!this.columnSubscribers.headerContextPopup &&
							((this.columnSubscribers.headerContextPopup =
								this.loadPopupTableColumnEvent.bind(
									this,
									"headerContextPopup"
								)),
							this.subscribe(
				...
				},
				{
					...
					value: function (e) {
						var t,
							i = this,
							n = e.definition.headerPopupIcon;
						(t = document.createElement("span")).classList.add(
							"tabulator-header-popup-button"
						),
							n
							...
							t.addEventListener("click", function (t) {
								t.stopPropagation(),
									t.preventDefault(),
									i.loadPopupEvent(e.definition.headerPopup, t, e);
							}),
							e.titleElement.insertBefore(t, e.titleElement.firstChild);
					},
				},
				{
					...
					value: function (e, t, i) {
						i._cell && (i = i._cell),
							i.column.definition[e] &&
								this.loadPopupEvent(i.column.definition[e], t, i);
					},
				},
				{
				...
				},
				{
					...
					value: function (e, t, i, n) {
						...
						i instanceof HTMLElement
							...
							o.classList.add("tabulator-popup"),
							o.addEventListener("click", function (e) {
								e.stopPropagation();
							}),
							s || e.preventDefault(),
							(a = this.popup(o)),
							"function" == typeof n && a.renderCallback(n),
							a.show(e).hideOnBlur(function () {
	...
	var je = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).element = !1),
				(o.manualBlock = !1),
				o.registerTableOption("printAsHtml", !1),
				o.registerTableOption("printFormatter", !1),
				o.registerTableOption("printHeader", !1),
				o.registerTableOption("printFooter", !1),
				o.registerTableOption("printStyled", !0),
				o.registerTableOption("printRowRange", "visible"),
				o.registerTableOption("printConfig", {}),
				o.registerColumnOption("print"),
				o.registerColumnOption("titlePrint"),
				o
			);
		}
		return (
			o(n, [
				{
					...
					value: function () {
						this.table.options.printAsHtml &&
							...
							this.registerTableFunction(
								"print",
								this.printFullscreen.bind(this)
							);
					},
				},
				{
					...
					value: function (e, t, i) {
						var n,
							...
							u = this.table.modules.export.genereateTable(
								...
								e || this.table.options.printRowRange,
								"print"
							);
						(this.manualBlock = !0),
							(this.element = document.createElement("div")),
	...
	var Ge = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).data = !1),
				(o.blocked = !1),
				(o.origFuncs = {}),
				(o.currentVersion = 0),
				o.registerTableOption("reactiveData", !1),
				o
			);
		}
		return (
								...
								value: function () {
									...
									return (
										i.blocked ||
											t !== i.currentVersion ||
											(i.data.length &&
												(n = i.table.rowManager.getRowFromDataObject(
													i.data[0]
												)) &&
												n.deleteActual()),
									...
									if (!i.blocked && t === i.currentVersion) {
										if (
											(s &&
												((n =
													!!e[a] &&
													i.table.rowManager.getRowFromDataObject(e[a]))
													? s.forEach(function (e) {
	...
	var Ue = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).startColumn = !1),
				(o.startX = !1),
				(o.startWidth = !1),
				(o.latestX = !1),
				(o.handle = null),
				(o.initialNextColumn = null),
				(o.nextColumn = null),
				(o.initialized = !1),
				o.registerColumnOption("resizable", !0),
				o.registerTableOption("resizableColumnFit", !1),
				o
			);
		}
		return (
			o(n, [
				{
					...
					value: function () {
						this.subscribe(
							"column-rendered",
							this.layoutColumnHeader.bind(this)
						);
					},
				},
				{
					...
					value: function () {
						this.initialized ||
							(this.subscribe(
								"cell-rendered",
								this.layoutCellHandles.bind(this)
							),
							this.subscribe(
								"cell-delete",
							...
							this.subscribe(
								"column-moved",
								this.columnLayoutUpdated.bind(this)
							),
							...
							this.subscribe(
								"column-width",
								this.columnWidthUpdated.bind(this)
							),
							this.subscribe(
								"column-delete",
								this.deInitializeComponent.bind(this)
					...
					value: function (e) {
						...
						e.modules.frozen &&
							(this.table.modules.frozenColumns.leftColumns.includes(e)
								? this.table.modules.frozenColumns.leftColumns.forEach(
										function (e) {
											t.reinitializeColumn(e);
										}
								  )
								: this.table.modules.frozenColumns.rightColumns.includes(e) &&
								  this.table.modules.frozenColumns.rightColumns.forEach(
										function (e) {
											t.reinitializeColumn(e);
										}
								  ));
				...
				},
				{
					...
					value: function (e) {
						var t =
							!!e.modules.frozen &&
							e.modules.frozen.marginValue + e.getWidth() + "px";
						e.cells.forEach(function (e) {
							e.modules.resize &&
								e.modules.resize.handleEl &&
								(t && (e.modules.resize.handleEl.style.left = t),
					...
					value: function (e, t, i, n) {
						...
						if (
							("header" === e &&
								(r = {
									variableHeight:
										"textarea" == i.definition.formatter ||
										i.definition.variableHeight,
								}),
							(!0 === a || a == e) && this._checkResizability(s))
						) {
							...
							var u = function (e) {
								(o.startColumn = i),
									(o.initialNextColumn = o.nextColumn = s.nextColumn()),
									o._mouseDown(e, s, l);
							};
							l.addEventListener("mousedown", u),
								l.addEventListener("touchstart", u, { passive: !0 }),
								l.addEventListener("dblclick", function (e) {
									var t = s.getWidth();
									e.stopPropagation(),
										s.reinitializeWidth(!0),
										t !== s.getWidth() &&
											(o.dispatch("column-resized", s),
											o.table.externalEvents.dispatch(
												"columnResized",
												s.getComponent()
											));
								}),
								i.modules.frozen &&
									...
									(l.style.left =
										i.modules.frozen.marginValue + i.getWidth() + "px")),
								(r.handleEl = l),
								n.parentNode && i.visible && n.after(l);
						}
						t.modules.resize = r;
					},
				},
				...
				},
				{
					...
					value: function (e, t) {
						e.modules.resize &&
							e.modules.resize.handleEl &&
							(e.modules.resize.handleEl.style.height = t);
					},
				},
				{
				...
				},
				{
					...
					value: function (e, t, i) {
						...
						function o(e) {
							var i,
								o,
								a = void 0 === e.screenX ? e.touches[0].screenX : e.screenX,
								r = a - n.startX,
								s = a - n.latestX;
							if (
								((n.latestX = a),
								...
								t.setWidth(n.startWidth + r),
								(o = t.width == t.minWidth || t.width == t.maxWidth),
								s < 0 && (n.nextColumn = n.initialNextColumn),
								n.table.options.resizableColumnFit &&
									n.nextColumn &&
									(!i || !o))
							) {
								var l = n.nextColumn.getWidth();
								s > 0 &&
									l <= n.nextColumn.minWidth &&
									(n.nextColumn = n.nextColumn.nextColumn()),
									n.nextColumn &&
										n.nextColumn.setWidth(n.nextColumn.getWidth() - s);
							}
							n.table.columnManager.renderer.rerenderColumns(!0),
								!n.table.browserSlow &&
									t.modules.resize &&
						...
						function a(e) {
							n.startColumn.modules.edit &&
								(n.startColumn.modules.edit.blocked = !1),
								n.table.browserSlow &&
									t.modules.resize &&
									t.modules.resize.variableHeight &&
									t.checkCellHeights(),
								...
								n.table.element.classList.remove("tabulator-block-select"),
								n.startWidth !== t.getWidth() &&
									(n.dispatch("column-resized", t),
									n.table.externalEvents.dispatch(
										"columnResized",
										t.getComponent()
									));
						}
						n.table.element.classList.add("tabulator-block-select"),
							e.stopPropagation(),
							n.startColumn.modules.edit &&
								(n.startColumn.modules.edit.blocked = !0),
							(n.startX =
							...
							i.addEventListener("touchmove", o, { passive: !0 }),
	...
	var Xe = (function (e) {
		...
		function n(e) {
			...
			return (
				...
				(o.handle = null),
				(o.prevHandle = null),
				o.registerTableOption("resizableRows", !1),
				o
			);
		}
		return (
					...
					value: function (e, t, i) {
						...
						function a(e) {
							document.body.removeEventListener("mouseup", o),
								...
								i.removeEventListener("touchend", a),
								n.table.element.classList.remove("tabulator-block-select"),
								n.dispatchExternal("rowResized", t.getComponent());
						}
						n.table.element.classList.add("tabulator-block-select"),
							e.stopPropagation(),
							(n.startY =
								void 0 === e.screenY ? e.touches[0].screenY : e.screenY),
							(n.startHeight = t.getHeight()),
							document.body.addEventListener("mousemove", o),
							document.body.addEventListener("mouseup", a),
							i.addEventListener("touchmove", o, { passive: !0 }),
							i.addEventListener("touchend", a);
	...
	var qe = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).binding = !1),
				(o.observer = !1),
				(o.containerObserver = !1),
				(o.tableHeight = 0),
				(o.tableWidth = 0),
				(o.containerHeight = 0),
				(o.containerWidth = 0),
				(o.autoResize = !1),
				o.registerTableOption("autoResize", !0),
				o
			);
		}
		return (
						...
						if (this.table.options.autoResize) {
							...
							(this.tableHeight = i.element.clientHeight),
								...
								"virtual" === i.rowManager.getRenderMode()
									? ((this.autoResize = !0),
									  (this.observer = new ResizeObserver(function (t) {
											if (
												!i.browserMobile ||
												(i.browserMobile && !i.modules.edit.currentCell)
											) {
												var n = Math.floor(t[0].contentRect.height),
													o = Math.floor(t[0].contentRect.width);
												(e.tableHeight == n && e.tableWidth == o) ||
													((e.tableHeight = n),
													(e.tableWidth = o),
													i.element.parentNode &&
														((e.containerHeight =
															i.element.parentNode.clientHeight),
														(e.containerWidth =
															i.element.parentNode.clientWidth)),
													e.table.columnManager.renderer.rerenderColumns(!0),
													i.redraw());
											}
									  })),
									  ...
									  this.table.element.parentNode &&
											...
											((this.containerObserver = new ResizeObserver(function (
												t
											) {
												if (
													!i.browserMobile ||
													...
													var n = Math.floor(t[0].contentRect.height),
														o = Math.floor(t[0].contentRect.width);
													(e.containerHeight == n && e.containerWidth == o) ||
														((e.containerHeight = n),
														(e.containerWidth = o),
														(e.tableHeight = i.element.clientHeight),
														(e.tableWidth = i.element.clientWidth)),
														i.columnManager.renderer.rerenderColumns(!0),
														i.redraw();
												}
											})),
	...
	var Ke = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).columns = []),
				(o.hiddenColumns = []),
				(o.mode = ""),
				(o.index = 0),
				(o.collapseFormatter = []),
				(o.collapseStartOpen = !0),
				(o.collapseHandleColumn = !1),
				o.registerTableOption("responsiveLayout", !1),
				o.registerTableOption("responsiveLayoutCollapseStartOpen", !0),
				o.registerTableOption("responsiveLayoutCollapseUseFormatters", !0),
				o.registerTableOption("responsiveLayoutCollapseFormatter", !1),
				o.registerColumnOption("responsive"),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					...
					value: function (e) {
						-1 ===
							["fitColumns", "fitDataStretch"].indexOf(this.layoutMode()) &&
							(e || this.update());
					},
				},
				{
					...
					value: function () {
						...
						(this.mode = this.table.options.responsiveLayout),
							...
							(this.hiddenColumns = []),
							this.table.columnManager.columnsByIndex.forEach(function (i, n) {
								i.modules.responsive &&
									i.modules.responsive.order &&
									i.modules.responsive.visible &&
									((i.modules.responsive.index = n),
									t.push(i),
									i.visible ||
										"collapse" !== e.mode ||
										e.hiddenColumns.push(i));
							}),
						...
						var i,
							n = f(this.table.columnManager.columnsByIndex);
						try {
							for (n.s(); !(i = n.n()).done; ) {
								var o = i.value;
				...
				},
				{
					...
					value: function (e, t) {
						!t &&
							e.modules.responsive &&
							((e.modules.responsive.visible = e.visible),
				...
				},
				{
					...
					value: function (e) {
						var t,
							...
							o = [];
						return (
							this.hiddenColumns.forEach(function (a) {
									...
									if (
										...
										(t = {
											...
											o.push({
												...
												value: a.modules.format.formatter.call(
													i.table.modules.format,
													t,
													a.modules.format.params,
													function (e) {
														e();
													}
												),
					...
					value: function (e) {
						...
						return (
							e.forEach(function (e) {
								...
								o.appendChild(r),
									this.langBind("columns|" + e.field, function (t) {
	...
	var Je = (function (i) {
		...
		function r(e) {
			...
			return (
				t(this, r),
				((i = n.call(this, e)).selecting = !1),
				(i.lastClickedRow = !1),
				(i.selectPrev = []),
				(i.selectedRows = []),
				(i.headerCheckboxElement = null),
				i.registerTableOption("selectable", "highlight"),
				i.registerTableOption("selectableRangeMode", "drag"),
				i.registerTableOption("selectableRollingSelection", !0),
				i.registerTableOption("selectablePersistence", !0),
				i.registerTableOption("selectableCheck", function (e, t) {
					return !0;
				}),
				i.registerTableFunction("selectRow", i.selectRows.bind(l(i))),
				i.registerTableFunction("deselectRow", i.deselectRows.bind(l(i))),
				i.registerTableFunction("toggleSelectRow", i.toggleRow.bind(l(i))),
				i.registerTableFunction(
					"getSelectedRows",
					i.getSelectedRows.bind(l(i))
				),
				i.registerTableFunction(
					"getSelectedData",
					i.getSelectedData.bind(l(i))
				),
				i.registerComponentFunction("row", "select", i.selectRows.bind(l(i))),
				i.registerComponentFunction(
					"row",
					"deselect",
					i.deselectRows.bind(l(i))
				),
				i.registerComponentFunction(
					"row",
					"toggleSelect",
			...
			o(r, [
								...
								? (i.classList.add("tabulator-selectable"),
								  ...
								  t.table.options.selectable &&
										...
										("click" === t.table.options.selectableRangeMode
											? i.addEventListener(
													"click",
													this.handleComplexRowClick.bind(this, e)
											  )
											: (i.addEventListener("click", function (i) {
					...
					value: function (e, t) {
						...
						if (t.shiftKey) {
							...
							var n = this.table.rowManager.getDisplayRowIndex(
								...
								o = this.table.rowManager.getDisplayRowIndex(e),
								a = n <= o ? n : o,
								r = n >= o ? n : o,
								...
								? (s.forEach(function (t) {
										t !== i.lastClickedRow &&
											(!0 === i.table.options.selectable ||
												i.isRowSelected(e) ||
												i.selectedRows.length < i.table.options.selectable) &&
											i.toggleRow(t);
								  }),
								  (this.lastClickedRow = e))
								: (this.deselectRows(void 0, !0),
					...
					value: function (t) {
						...
						switch (e(t)) {
							case "undefined":
								...
								break;
							case "string":
								(i = this.table.rowManager.findRow(t))
									? this._selectRow(i, !0, !0)
									: this.table.rowManager.getRows(t).forEach(function (e) {
											n._selectRow(e, !0, !0);
									  }),
									this._rowSelectionChanged();
								break;
				...
				},
				{
					...
					value: function (e, t, i) {
						...
						n
							? -1 == this.selectedRows.indexOf(n) &&
							  (n.getElement().classList.add("tabulator-selected"),
							  n.modules.select || (n.modules.select = {}),
							  (n.modules.select.selected = !0),
							  n.modules.select.checkboxEl &&
									(n.modules.select.checkboxEl.checked = !0),
							  this.selectedRows.push(n),
							  this.table.options.dataTreeSelectPropagate &&
									this.childRowSelection(n, !0),
							  this.dispatchExternal("rowSelected", n.getComponent()),
				...
				},
				{
					...
					value: function (e, t) {
						var i,
							n = this,
							o = n.table.rowManager.findRow(e);
						o
							? (i = n.selectedRows.findIndex(function (e) {
									return e == o;
							  })) > -1 &&
							  (o.getElement().classList.remove("tabulator-selected"),
							  o.modules.select || (o.modules.select = {}),
							  (o.modules.select.selected = !1),
							  o.modules.select.checkboxEl &&
									(o.modules.select.checkboxEl.checked = !1),
							  n.selectedRows.splice(i, 1),
							  this.table.options.dataTreeSelectPropagate &&
									this.childRowSelection(o, !1),
							  this.dispatchExternal("rowDeselected", o.getComponent()),
							  n._rowSelectionChanged(t))
							: t ||
							  console.warn(
	...
	function Ye(e, t, i, n, o, a, r) {
		var s = window.DateTime || luxon.DateTime,
			l = r.format || "dd/MM/yyyy HH:mm:ss",
			u = r.alignEmptyValues,
			c = 0;
		if (void 0 !== s) {
			if (
				((e = s.isDateTime(e)
					...
					: "iso" === l
					? s.fromISO(String(e))
					: s.fromFormat(String(e), l)),
				(t = s.isDateTime(t)
					? t
					: "iso" === l
					? s.fromISO(String(t))
					: s.fromFormat(String(t), l)),
				e.isValid)
			) {
	...
	var $e = {
			number: function (e, t, i, n, o, a, r) {
				var s = r.alignEmptyValues,
					l = r.decimalSeparator,
					u = r.thousandSeparator,
					c = 0;
				if (
					((e = String(e)),
					(t = String(t)),
			...
			string: function (t, i, n, o, a, r, s) {
				...
				if (t) {
					if (i) {
						...
						return String(t)
							.toLowerCase()
							.localeCompare(String(i).toLowerCase(), l);
					}
					c = 1;
				} else c = i ? -1 : 0;
				return (
					(("top" === u && "desc" === r) || ("bottom" === u && "asc" === r)) &&
						(c *= -1),
					c
				);
			},
			date: function (e, t, i, n, o, a, r) {
				return (
					r.format || (r.format = "dd/MM/yyyy"),
					Ye.call(this, e, t, i, n, o, a, r)
				);
			},
			time: function (e, t, i, n, o, a, r) {
				return (
					r.format || (r.format = "HH:mm"), Ye.call(this, e, t, i, n, o, a, r)
				);
			},
			datetime: Ye,
			boolean: function (e, t, i, n, o, a, r) {
				return (
			...
			alphanum: function (e, t, i, n, o, a, r) {
				...
				if (e || 0 === e) {
					if (t || 0 === t) {
						if (isFinite(e) && isFinite(t)) return e - t;
						if ((s = String(e).toLowerCase()) === (l = String(t).toLowerCase()))
							return 0;
						if (!p.test(s) || !p.test(l)) return s > l ? 1 : -1;
						for (
							s = s.match(m),
								l = l.match(m),
								h = s.length > l.length ? l.length : s.length;
							d < h;
		...
		Ze = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).sortList = []),
					(i.changed = !1),
					i.registerTableOption("sortMode", "local"),
					i.registerTableOption("initialSort", !1),
					i.registerTableOption("columnHeaderSortMulti", !0),
					i.registerTableOption("sortOrderReverse", !1),
					i.registerTableOption(
						"headerSortElement",
						"<div class='tabulator-arrow'></div>"
					),
					i.registerColumnOption("sorter"),
					i.registerColumnOption("sorterParams"),
					i.registerColumnOption("headerSort", !0),
					i.registerColumnOption("headerSortStartingDir"),
					i.registerColumnOption("headerSortTristate"),
					i
				);
			}
			return (
				o(r, [
					{
						...
						value: function () {
							this.subscribe("column-layout", this.initializeColumn.bind(this)),
								...
								this.registerTableFunction(
									"setSort",
									this.userSetSort.bind(this)
								),
								this.registerTableFunction(
									"getSorters",
									this.getSort.bind(this)
								),
								this.registerTableFunction(
									"clearSort",
									this.clearSort.bind(this)
								),
								"remote" === this.table.options.sortMode &&
									this.subscribe(
										"data-params",
										this.remoteSortParams.bind(this)
									);
						},
					},
					{
						key: "tableBuilt",
						value: function () {
							this.table.options.initialSort &&
					...
					},
					{
						...
						value: function (t) {
							...
							switch (e(t.definition.sorter)) {
								case "string":
									r.sorters[t.definition.sorter]
										? (a = r.sorters[t.definition.sorter])
										: console.warn(
							...
							(t.modules.sort = {
								...
								!1 !== t.definition.headerSort &&
									((i = t.getElement()).classList.add("tabulator-sortable"),
									(n = document.createElement("div")).classList.add(
										"tabulator-col-sorter"
									),
									"object" == e(this.table.options.headerSortElement)
										? n.appendChild(this.table.options.headerSortElement)
										: (n.innerHTML = this.table.options.headerSortElement),
									t.titleHolderElement.appendChild(n),
									(t.modules.sort.element = n),
									i.addEventListener("click", function (e) {
										var i = "",
											n = [],
											a = !1;
										if (t.modules.sort) {
											if (t.modules.sort.tristate)
												i =
													"none" == t.modules.sort.dir
														? t.modules.sort.startingDir
														: t.modules.sort.dir == t.modules.sort.startingDir
														? "asc" == t.modules.sort.dir
															? "desc"
															: "asc"
														: "none";
											else
											...
											o.table.options.columnHeaderSortMulti &&
											(e.shiftKey || e.ctrlKey)
												? ((a = (n = o.getSort()).findIndex(function (e) {
							...
							Array.isArray(e) || (e = [{ column: e, dir: t }]),
								e.forEach(function (e) {
									...
									(t = i.table.columnManager.findColumn(e.column))
										? ((e.column = t), n.push(e), (i.changed = !0))
										: console.warn(
					...
					},
					{
						...
						value: function (t) {
							var i,
								n = this.table.rowManager.activeRows[0],
								o = "string";
							if (n && ((n = n.getData()), t.getField()))
								switch (e((i = t.getFieldValue(n)))) {
									case "undefined":
										o = "string";
										break;
									case "boolean":
					...
					},
					{
						...
						value: function (e) {
							var t = this,
								...
								o = [];
							return (
								this.subscribedExternal("dataSorting") &&
									this.dispatchExternal("dataSorting", t.getSort()),
								...
								"remote" !== this.table.options.sortMode
									? (i.forEach(function (e, i) {
											...
											e.column &&
												o &&
												(o.sorter || (o.sorter = t.findSorter(e.column)),
												(e.params =
													"function" == typeof o.params
														? o.params(e.column.getComponent(), e.dir)
														: o.params),
												n.push(e)),
												t.setColumnHeader(e.column, e.dir);
									  }),
									  n.length && t._sortItems(e, n))
									: i.forEach(function (e, i) {
											t.setColumnHeader(e.column, e.dir);
									  }),
								this.subscribedExternal("dataSorted") &&
									...
									this.dispatchExternal("dataSorted", t.getSort(), o)),
								e
							);
						},
					},
					...
					},
					{
						...
						value: function (e, t) {
							...
							e.sort(function (e, o) {
								for (var a, r = n; r >= 0; r--) {
									var s = t[r];
									if (0 !== (a = i._sortRow(e, o, s.column, s.dir, s.params)))
										break;
								}
								return a;
							});
	...
	var Qe = (function (e) {
		...
		function n(e) {
			...
			return (
				t(this, n),
				((o = i.call(this, e)).tooltipSubscriber = null),
				(o.headerSubscriber = null),
				(o.timeout = null),
				(o.popupInstance = null),
				o.registerTableOption("tooltipGenerationMode", void 0),
				o.registerTableOption("tooltipDelay", 300),
				o.registerColumnOption("tooltip"),
				o.registerColumnOption("headerTooltip"),
				o
			);
		}
		return (
			o(n, [
				...
				},
				{
					key: "deprecationCheck",
					value: function () {
						void 0 !== this.table.options.tooltipGenerationMode &&
							console.warn(
				...
				},
				{
					...
					value: function (e) {
						e.definition.headerTooltip &&
							...
							e.definition.tooltip &&
								!this.tooltipSubscriber &&
								((this.tooltipSubscriber = !0),
								this.subscribe(
									"cell-mousemove",
				...
				},
				{
					...
					value: function (e, t, i) {
						var n =
							"tooltip" === e
								? i.column.definition.tooltip
								: i.definition.headerTooltip;
						n &&
							(this.clearPopup(),
							(this.timeout = setTimeout(
								this.loadTooltip.bind(this, t, i, n),
						...
						"function" == typeof i &&
							...
							i instanceof HTMLElement
								...
								: ((n = document.createElement("div")),
								  ...
								  (n.innerHTML = i)),
							(i || 0 === i || "0" === i || !1 === i) &&
								(n.classList.add("tabulator-tooltip"),
								n.addEventListener("mousemove", function (e) {
									return e.preventDefault();
								}),
								(this.popupInstance = this.popup(n)),
								"function" == typeof o && this.popupInstance.renderCallback(o),
								(a = this.popupInstance.containerEventCoords(e)),
								this.popupInstance
									.show(a.x + 15, a.y + 15)
									.hideOnBlur(function () {
										r.dispatchExternal("TooltipClosed", t.getComponent()),
											(r.popupInstance = null);
									}),
	...
	var et = {
		...
		tt = (function (i) {
			...
			function r(e) {
				...
				return (
					t(this, r),
					((i = n.call(this, e)).invalidCells = []),
					i.registerTableOption("validationMode", "blocking"),
					i.registerColumnOption("validator"),
					i.registerTableFunction(
						"getInvalidCells",
						i.getInvalidCells.bind(l(i))
					),
					i.registerTableFunction(
						"clearCellValidation",
						i.userClearCellValidation.bind(l(i))
					),
					i.registerTableFunction("validate", i.userValidate.bind(l(i))),
					i.registerComponentFunction(
						"cell",
						"isValid",
						i.cellIsValid.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"clearValidation",
						i.clearValidation.bind(l(i))
					),
					i.registerComponentFunction(
						"cell",
						"validate",
						i.cellValidate.bind(l(i))
					),
					i.registerComponentFunction(
						"column",
						"validate",
						i.columnValidate.bind(l(i))
					),
					i.registerComponentFunction(
						"row",
						"validate",
						i.rowValidate.bind(l(i))
					),
					i
				);
			}
						...
						value: function (e, t, i) {
							var n = this,
								o =
									...
									this.validate(e.column.modules.validate, e, t);
							return (
								!0 !== o &&
									setTimeout(function () {
						...
						value: function (e) {
							...
							e.definition.validator &&
								(Array.isArray(e.definition.validator)
									...
									: (t = this._extractValidator(e.definition.validator)) &&
									  n.push(t),
								(e.modules.validate = !!n.length && n));
						},
					},
					{
						...
						value: function (t) {
							...
							switch (e(t)) {
								case "string":
									return (
										(o = t.indexOf(":")) > -1
											? ((i = t.substring(0, o)), (n = t.substring(o + 1)))
											: (i = t),
										this._buildValidator(i, n)
									);
								case "function":
					...
					},
					{
						...
						value: function (e, t, i) {
							...
							return (
								e &&
									e.forEach(function (e) {
										e.func.call(n, t.getComponent(), i, e.params) ||
											o.push({ type: e.type, parameters: e.params });
									}),
								t.modules.validate || (t.modules.validate = {}),
								o.length
									? ((t.modules.validate.invalid = o),
									  "manual" !== this.table.options.validationMode &&
											t.getElement().classList.add("tabulator-validation-fail"),
									  -1 == a && this.invalidCells.push(t))
									: ((t.modules.validate.invalid = !1),
									  t
											.getElement()
											.classList.remove("tabulator-validation-fail"),
									  a > -1 && this.invalidCells.splice(a, 1)),
								!o.length || o
							);
						},
					},

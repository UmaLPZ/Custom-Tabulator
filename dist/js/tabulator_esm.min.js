...
class t {
	...
	static deepClone(e, t, i = []) {
		...
		e)) {
			...
			null == l ||
				"object" != typeof l ||
				(l.__proto__ !== s && l.__proto__ !== o) ||
				((r = i.findIndex((e) => e.subject === l)),
				r > -1
					? (t[n] = i[r].copy)
					: ((a = Object.assign(Array.isArray(l) ? [] : {}, l)),
					  i.unshift({ subject: l, copy: a }),
...
class s extends e {
	...
	_checkContainerIsParent(e, t = this.table.element) {
		return (
			e === t ||
			(!!t.parentNode && this._checkContainerIsParent(e, t.parentNode))
		);
	}
	renderCallback(e) {
	...
	containerEventCoords(e) {
		var i = !(e instanceof MouseEvent),
			s = i ? e.touches[0].pageX : e.pageX,
			o = i ? e.touches[0].pageY : e.pageY;
		if (this.container !== document.body) {
			let e = t.elOffset(this.container);
			(s -= e.left), (o -= e.top);
		}
		return { x: s, y: o };
	}
	elementPositionCoords(e, i = "right") {
		var s,
			o,
			n,
			r = t.elOffset(e);
		switch (
			(this.container !== document.body &&
				((s = t.elOffset(this.container)),
				(r.left -= s.left),
				(r.top -= s.top)),
			i)
		) {
			case "right":
				(o = r.left + e.offsetWidth), (n = r.top - 1);
				break;
			case "bottom":
				(o = r.left), (n = r.top + e.offsetHeight);
		}
		return { x: o, y: n, offset: r };
	}
	show(e, t) {
		var i, s, o, n, r;
		return (
		...
		if (
			((e + this.element.offsetWidth >= this.container.offsetWidth ||
				...
				(this.element.style.right = i
					? this.container.offsetWidth - s.left + "px"
					: this.container.offsetWidth - e + "px"),
				(this.reversedX = !0)),
			t + this.element.offsetHeight >
				Math.max(
					this.container.offsetHeight,
					n ? this.container.scrollHeight : 0
				))
		)
			if (i)
				switch (o) {
	...
	child(e) {
		return (
			this.childPopup && this.childPopup.hide(),
			(this.childPopup = new s(this.table, e, this)),
			this.childPopup
		);
	}
}
class o extends e {
	...
	registerTableFunction(e, t) {
		void 0 === this.table[e]
			? (this.table[e] = (...i) => (this.table.initGuard(e), t(...i)))
...
class n extends o {
	...
	initializeColumn(e) {
		...
		this.allowedTypes.forEach((s) => {
			...
			e.definition[n] &&
				(o = this.lookupAccessor(e.definition[n])) &&
				((t = !0),
				(i[n] = { accessor: o, params: e.definition[n + "Params"] || {} }));
		}),
	...
	transformRow(e, i) {
		var s = "accessor" + (i.charAt(0).toUpperCase() + i.slice(1)),
			o = e.getComponent(),
			n = t.deepClone(e.data || {});
		return (
			this.table.columnManager.traverse(function (e) {
				var t, r, a, l;
				e.modules.accessor &&
					(r = e.modules.accessor[s] || e.modules.accessor.accessor || !1) &&
					"undefined" != (t = e.getFieldValue(n)) &&
					((l = e.getComponent()),
					(a =
						"function" == typeof r.params ? r.params(t, n, i, l, o) : r.params),
					e.setFieldValue(n, r.accessor(t, n, i, a, l, o)));
			}),
			n
		);
	}
}
(n.moduleName = "accessor"), (n.accessors = {});
function r(e, t) {
	var i = [];
	if (((t = t || ""), Array.isArray(e)))
		e.forEach((e, s) => {
			i = i.concat(r(e, t ? t + "[" + s + "]" : s));
		});
	else if ("object" == typeof e)
		for (var s in e) i = i.concat(r(e[s], t ? t + "[" + s + "]" : s));
...
function h(e, t) {
	...
	if (((t = t || ""), Array.isArray(e)))
		e.forEach((e, s) => {
			i = i.concat(h(e, t ? t + "[" + s + "]" : s));
		});
	else if ("object" == typeof e)
		for (var s in e) i = i.concat(h(e[s], t ? t + "[" + s + "]" : s));
	else i.push({ key: t, value: e });
	return i;
}
var d = {
...
class c extends o {
	constructor(e) {
		super(e),
			...
			(this.contentTypeFormatters = c.contentTypeFormatters);
	}
	initialize() {
		(this.loaderPromise =
			this.table.options.ajaxRequestFunc || c.defaultLoaderPromise),
			(this.urlGenerator =
				this.table.options.ajaxURLGenerator || c.defaultURLGenerator),
	...
	sendRequest(e, t, i) {
		return !1 !== this.table.options.ajaxRequesting.call(this.table, e, t)
			? this.loaderPromise(e, i, t).then(
					(i) => (
						this.table.options.ajaxResponse &&
							(i = this.table.options.ajaxResponse.call(this.table, e, t, i)),
						i
					)
			  )
			: Promise.reject();
...
(c.moduleName = "ajax"),
	(c.defaultConfig = { method: "GET" }),
	(c.defaultURLGenerator = l),
	(c.defaultLoaderPromise = function (e, t, i) {
		var s;
		return new Promise((o, n) => {
			if (
				((e = this.urlGenerator.call(this.table, e, t, i)),
				"GET" != t.method.toUpperCase())
			)
				if (
					(s =
						"object" == typeof this.table.options.ajaxContentType
			...
			e
				? (void 0 === t.headers && (t.headers = {}),
				  ...
				  "cors" == t.mode
						? (void 0 === t.headers.Origin &&
								(t.headers.Origin = window.location.origin),
...
class u extends o {
		...
		(this.mode = this.table.options.clipboard),
			...
			(!0 !== this.mode && "copy" !== this.mode) ||
				this.table.element.addEventListener("copy", (e) => {
					var t, i;
					if (!this.blocked) {
						if ((e.preventDefault(), this.customSelection))
							(t = this.customSelection),
								this.table.options.clipboardCopyFormatter &&
									(t = this.table.options.clipboardCopyFormatter("plain", t));
						else {
							var s = this.table.modules.export.generateExportList(
								this.table.options.clipboardCopyConfig,
								this.table.options.clipboardCopyStyled,
								this.rowRange,
								"clipboard"
							);
							(t = (i = this.table.modules.export.genereateHTMLTable(s))
								? this.generatePlainContent(s)
								: ""),
								this.table.options.clipboardCopyFormatter &&
									((t = this.table.options.clipboardCopyFormatter("plain", t)),
						...
						window.clipboardData && window.clipboardData.setData
							...
							? (e.clipboardData.setData("text/plain", t),
							  i && e.clipboardData.setData("text/html", i))
							: e.originalEvent &&
			...
			(!0 !== this.mode && "copy" !== this.mode) ||
				...
				void 0 !== window.getSelection && void 0 !== document.createRange
					...
					: void 0 !== document.selection &&
					  ...
					  ((s = document.body.createTextRange()).moveToElementText(
							this.table.element
					  ),
					  s.select()),
	...
	setPasteAction(e) {
		switch (typeof e) {
			case "string":
				(this.pasteAction = u.pasteActions[e]),
					this.pasteAction ||
						console.warn("Clipboard Error - No such paste action found:", e);
				break;
			case "function":
				this.pasteAction = e;
		}
	...
	setPasteParser(e) {
		switch (typeof e) {
			case "string":
				(this.pasteParser = u.pasteParsers[e]),
					this.pasteParser ||
						console.warn("Clipboard Error - No such paste parser found:", e);
				break;
			case "function":
				this.pasteParser = e;
		}
		...
		this.checkPaseOrigin(e) &&
			...
			(i = this.pasteParser.call(this, t))
				? (e.preventDefault(),
				  ...
				  this.dispatchExternal("clipboardPasted", t, i, s))
	...
	checkPaseOrigin(e) {
		var t = !0;
		return (
			("DIV" != e.target.tagName || this.table.modules.edit.currentCell) &&
				(t = !1),
			t
		);
	}
		...
		return (
			...
			new Proxy(this, {
				get: function (e, t, i) {
					return void 0 !== e[t]
						? e[t]
						: e._cell.table.componentFunctionBinder.handle("cell", e._cell, t);
				},
			})
		);
	}
...
class g extends e {
	...
	getComponent() {
		return this.component || (this.component = new p(this)), this.component;
	}
}
class b {
	constructor(e) {
	...
	getParentColumn() {
		return (
			this._column.parent instanceof v && this._column.parent.getComponent()
		);
	}
	_getSelf() {
		return this._column;
...
class v extends e {
	...
	checkDefinition() {
		Object.keys(this.definition).forEach((e) => {
			-1 === v.defaultOptionList.indexOf(e) &&
				console.warn(
	...
	_buildColumnHeaderTitle() {
		...
		if ((t.classList.add("tabulator-col-title"), e.editableTitle)) {
	...
	show(e, t) {
		this.visible ||
			...
			this.silent || this.table.columnManager.renderer.rerenderColumns());
	}
	hide(e, t) {
		this.visible &&
			((this.visible = !1),
	...
	setWidthActual(e) {
		isNaN(e) &&
			(e = Math.floor((this.table.element.clientWidth / 100) * parseInt(e))),
	...
	delete() {
		return new Promise((e, t) => {
			...
			this.element.parentNode &&
				...
				this.table.columnManager.renderer.rerenderColumns(!0),
				e();
		});
	}
	columnRendered() {
		...
		return this.isGroup || this.parent.isGroup
			...
			: ((t = Object.assign({}, this.getDefinition())),
			  ...
			  this.table.columnManager
					...
					.then(
						(e) => (
							t.field == this.field && (this.field = !1),
...
class C extends e {
	...
	calcHeight(e) {
		...
		this.table.options.rowHeight
			...
			: ((t = this.table.options.resizableRows ? this.element.clientHeight : 0),
			  this.cells.forEach(function (e) {
					var t = e.getHeight();
					t > i && (i = t);
			  }),
	...
	updateData(e) {
		var i,
			s = this.element && t.elVisible(this.element),
			o = {};
		return new Promise((t, n) => {
			for (var r in ("string" == typeof e && (e = JSON.parse(e)),
			this.dispatch("row-data-save-before", this),
			this.subscribed("row-data-changing") &&
				((o = Object.assign(o, this.data)), (o = Object.assign(o, e))),
			(i = this.chain("row-data-changing", [this, o, e], null, e))))
				this.data[r] = i[r];
			for (var r in (this.dispatch("row-data-save-after", this), e)) {
				this.table.columnManager.getColumnsByFieldRoot(r).forEach((e) => {
					let t = this.getCell(e.getField());
					if (t) {
						let o = e.getFieldValue(i);
						t.getValue() != o &&
							(t.setValueProcessData(o), s && t.cellRendered());
					}
				});
			}
			s
				...
				: ((this.initialized = !1),
				  (this.height = 0),
				  (this.heightStyled = "")),
				this.dispatch("row-data-changed", this, s, e),
	...
	delete() {
		return (
			this.dispatch("row-delete", this), this.deleteActual(), Promise.resolve()
		);
	}
	deleteActual(e) {
...
class y extends o {
	...
	initialize() {
		(this.genColumn = new v({ field: "value" }, this)),
	...
	initializeColumn(e) {
		...
		if (t.topCalc) {
			switch (typeof t.topCalc) {
				case "string":
					y.calculations[t.topCalc]
						? (i.topCalc = y.calculations[t.topCalc])
						: console.warn(
		...
		if (t.bottomCalc) {
			switch (typeof t.bottomCalc) {
				case "string":
					y.calculations[t.bottomCalc]
						? (i.botCalc = y.calculations[t.bottomCalc])
						: console.warn(
								"Column Calc Error - No such calculation found, ignoring: ",
								t.bottomCalc
						  );
	...
	initializeBottomRow() {
		this.botInitialized ||
			(this.footerPrepend(this.botElement), (this.botInitialized = !0));
	}
	scrollHorizontal(e) {
		this.botInitialized &&
			this.botRow &&
		...
		return (
			e.forEach((e) => {
				if (
					...
					var i = this.rowsToData(
						this.table.modules.dataTree.getFilteredTreeChildren(e)
					);
					t = t.concat(i);
				}
			}),
	...
	generateRow(e, t) {
		...
		return (
			...
			(i.component = !1),
			(i.getComponent = () => (
				i.component || (i.component = new m(i)), i.component
			)),
			(i.generateCells = () => {
				var t = [];
				this.table.columnManager.columnsByIndex.forEach((s) => {
					this.genColumn.setField(s.getField()),
						...
						s.definition[e + "CalcFormatter"] && this.table.modExists("format")
							? (this.genColumn.modules.format = {
									formatter: this.table.modules.format.getFormatter(
										s.definition[e + "CalcFormatter"]
									),
									params: s.definition[e + "CalcFormatterParams"] || {},
							  })
							: (this.genColumn.modules.format = {
									formatter:
										this.table.modules.format.getFormatter("plaintext"),
									params: {},
							  }),
						(this.genColumn.definition.cssClass = s.definition.cssClass);
					var o = new g(this.genColumn, i);
					o.getElement(),
						(o.column = s),
						o.setWidth(),
						s.cells.push(o),
		...
		return (
			n.forEach(function (e) {
				...
				e.modules.columnCalcs &&
					...
					(s = r + "Params"),
					(i =
						"function" == typeof e.modules.columnCalcs[s]
							? e.modules.columnCalcs[s](n, t)
...
(y.moduleName = "columnCalcs"), (y.calculations = E);
class R extends o {
	constructor(e) {
		super(e),
			(this.indent = 10),
		...
		if (this.table.options.dataTree) {
			...
			switch (
				...
				t.dataTreeCollapseElement
					? "string" == typeof t.dataTreeCollapseElement
						? (((e = document.createElement("div")).innerHTML =
								t.dataTreeCollapseElement),
						  (this.collapseEl = e.firstChild))
						: (this.collapseEl = t.dataTreeCollapseElement)
					: ((this.collapseEl = document.createElement("div")),
					  this.collapseEl.classList.add("tabulator-data-tree-control"),
					  (this.collapseEl.tabIndex = 0),
					  (this.collapseEl.innerHTML =
							"<div class='tabulator-data-tree-control-collapse'></div>")),
				t.dataTreeExpandElement
					? "string" == typeof t.dataTreeExpandElement
						? (((e = document.createElement("div")).innerHTML =
								t.dataTreeExpandElement),
						  (this.expandEl = e.firstChild))
						: (this.expandEl = t.dataTreeExpandElement)
	...
	rowDataChanged(e, t, i) {
		this.redrawNeeded(i) &&
			(this.initializeRow(e), t && (this.layoutRow(e), this.refreshData(!0)));
	}
	cellValueChanged(e) {
	...
	layoutRow(e) {
		...
		i.branchEl &&
			(i.branchEl.parentNode && i.branchEl.parentNode.removeChild(i.branchEl),
			(i.branchEl = !1)),
			i.controlEl &&
					...
					? ((i.branchEl = this.branchEl.cloneNode(!0)),
					  ...
					  this.table.rtl
							...
							: (i.branchEl.style.marginLeft =
									(i.branchEl.offsetWidth + i.branchEl.style.marginRight) *
										(i.index - 1) +
									i.index * this.indent +
									"px"))
					: this.table.rtl
	...
	generateControlElement(e, t) {
		var i = e.modules.dataTree,
			s = ((t = t || e.getCells()[0].getElement()), i.controlEl);
		!1 !== i.children &&
			(i.open
			...
			s && s.parentNode === t
				? s.parentNode.replaceChild(i.controlEl, s)
		...
		return (
			e.forEach((e, i) => {
				...
				t.push(e),
					e instanceof C &&
						(e.create(),
						(s = e.modules.dataTree.children).index ||
							!1 === s.children ||
							this.getChildren(e).forEach((e) => {
								e.create(), t.push(e);
							}));
			}),
			t
	...
	getChildren(e, t) {
		...
		return (
			!1 !== i.children &&
				(i.open || t) &&
				(Array.isArray(i.children) || (i.children = this.generateChildren(e)),
				(s =
				...
				this.table.modExists("sort") &&
					...
					this.table.modules.sort.sort(s),
				s.forEach((e) => {
					o.push(e),
						this.getChildren(e).forEach((e) => {
							o.push(e);
	...
	generateChildren(e) {
		...
		return (
			Array.isArray(i) || (i = [i]),
			i.forEach((i) => {
				var s = new C(i || {}, this.table.rowManager);
				s.create(),
					(s.modules.dataTree.index = e.modules.dataTree.index + 1),
					(s.modules.dataTree.parent = e),
					s.modules.dataTree.children &&
						(s.modules.dataTree.open = this.startOpen(
							s.getComponent(),
							s.modules.dataTree.index
						)),
					t.push(s);
			}),
			t
	...
	getTreeParent(e) {
		return (
			!!e.modules.dataTree.parent && e.modules.dataTree.parent.getComponent()
		);
	}
	getTreeParentRoot(e) {
	...
	findChildIndex(e, t) {
		...
		return (
			"object" == typeof e
				? e instanceof C
					? (i = e.data)
					: e instanceof RowComponent
					? (i = e._getSelf().data)
					: "undefined" != typeof HTMLElement &&
					  e instanceof HTMLElement &&
					  t.modules.dataTree &&
					  (i = t.modules.dataTree.children.find(
							(t) => t instanceof C && t.element === e
					  )) &&
					  (i = i.data)
				: (i =
						null != e &&
						t.data[this.field].find(
							(t) => t.data[this.table.options.index] == e
						)),
			i &&
			...
			s.children &&
				...
				s.children.forEach((e) => {
					e instanceof C &&
						...
						i && (o = o.concat(this.getTreeChildren(e, t, i))));
				})),
			o
		);
	}
...
R.moduleName = "dataTree";
var x = {
	csv: function (e, t, i) {
		var s = t && t.delimiter ? t.delimiter : ",",
			o = [],
			n = [];
		e.forEach((e) => {
			var t = [];
	...
	pdf: function (e, t, i) {
			...
			return (
				e.columns.forEach((e) => {
					...
					if (e) {
						...
						(s = { content: e.value, colSpan: e.width, rowSpan: e.height }),
							t && (s.styles = t),
							i.push(s);
					}
				}),
		...
		t &&
			t.autoTable &&
			(n =
				"function" == typeof t.autoTable ? t.autoTable(c) || {} : t.autoTable),
			h &&
			...
			(n.body = o),
			c.autoTable(n),
			t && t.documentProcessing && t.documentProcessing(c),
			...
			return (
				t.forEach((t, s) => {
					...
					t.columns.forEach(function (e, t) {
						e
							? (o.push(
									e.value instanceof Date || "object" != typeof e.value
										? e.value
							  ...
							  (e.width > 1 || e.height > -1) &&
									...
									i.push({
										s: { r: s, c: t },
										e: { r: s + e.height - 1, c: t + e.width - 1 },
									}))
							: o.push("");
					}),
						e.push(o);
				}),
				XLSX.utils.sheet_add_aoa(s, e),
				(s["!ref"] = XLSX.utils.encode_range(o)),
				i.length && (s["!merges"] = i),
				s
			);
		}
		if (((n.SheetNames = []), (n.Sheets = {}), i.sheetOnly)) s(a());
		else {
			if (i.sheets)
				for (var l in i.sheets)
					!0 === i.sheets[l]
						? (n.SheetNames.push(l), (n.Sheets[l] = a()))
						: (n.SheetNames.push(l),
			...
			i.documentProcessing && (n = i.documentProcessing(n)),
				s(
					(function (e) {
						for (
							var t = new ArrayBuffer(e.length), i = new Uint8Array(t), s = 0;
							s != e.length;
							++s
						)
							i[s] = 255 & e.charCodeAt(s);
						return t;
					})(XLSX.write(n, { bookType: "xlsx", bookSST: !0, type: "binary" })),
...
class T extends o {
	constructor(e) {
		super(e),
			this.registerTableOption("downloadReady", function (e, t) {
				return t;
			}),
		...
		if (
			...
			n.call(
				...
				function (i, s) {
					o
						? !0 === o
							? this.triggerDownload(i, s, e, t, !0)
							: o(i)
						: this.triggerDownload(i, s, e, t);
				}.bind(this)
			);
		}
	}
...
(T.moduleName = "download"), (T.downloaders = x);
class L {
	...
	_createInputElement() {
		...
		if (
			(t.setAttribute("type", this.params.clearable ? "search" : "text"),
			(t.style.padding = "4px"),
			(t.style.width = "100%"),
			(t.style.boxSizing = "border-box"),
			this.params.autocomplete ||
				((t.style.cursor = "default"), (t.style.caretColor = "transparent")),
			e && "object" == typeof e)
		)
			for (let i in e)
				"+" == i.charAt(0)
					? ((i = i.slice(1)),
					  t.setAttribute(i, t.getAttribute(i) + e["+" + i]))
					: t.setAttribute(i, e[i]);
		return this.params.mask && M(t, this.params), this._bindInputEvents(t), t;
	}
	_initializeParams(e) {
		var t,
			i = ["values", "valuesURL", "valuesLookup"];
		return (
			((e = Object.assign({}, e)).verticalNavigation =
				e.verticalNavigation || "editor"),
			(e.placeholderLoading =
				void 0 === e.placeholderLoading
					? "Searching ..."
					: e.placeholderLoading),
			(e.placeholderEmpty =
				void 0 === e.placeholderEmpty
					? "No Results Found"
					: e.placeholderEmpty),
			(e.filterDelay = void 0 === e.filterDelay ? 300 : e.filterDelay),
			(e.emptyValue = Object.keys(e).includes("emptyValue")
				? e.emptyValue
				: ""),
			(t = Object.keys(e).filter((e) => i.includes(e)).length)
				? t > 1 &&
				  console.warn(
			...
			e.filterRemote &&
				"function" != typeof e.valuesLookup &&
				(e.valuesURL, 0) &&
				((e.filterRemote = !1),
				console.warn(
	...
	_scrollToValue(e) {
		...
		var i = this.displayItems.find(
			(e) =>
				void 0 !== e.label && e.label.toLowerCase().startsWith(this.filterTerm)
		);
		i && this._focusItem(i),
			(this.filterTimeout = setTimeout(() => {
				this.filterTerm = "";
	...
	_generateOptions(e) {
		...
		return (
			...
			this.params.values
				...
				? (t = this._ajaxRequest(this.params.valuesURL, this.input.value))
				: "function" == typeof this.params.valuesLookup
				? (t = this.params.valuesLookup(this.cell, this.input.value))
				: this.params.valuesLookup &&
				  (t = this._uniqueColumnValues(this.params.valuesLookupField)),
			t instanceof Promise
				? (e || this._addPlaceholder(this.params.placeholderLoading),
				  t
						.then()
						.then((e) =>
							this.listIteration === i ? this._parseList(e) : Promise.reject(i)
						))
	...
	_ajaxRequest(e, t) {
		return (
			(e = l(e, {}, this.params.filterRemote ? { term: t } : {})),
			fetch(e)
				.then((e) =>
					e.ok
						? e
				...
				.catch(
					(e) => (
						console.error("List Ajax Load Error - Connection Error: ", e),
						Promise.reject(e)
					)
				)
		);
	...
	_parseList(e) {
		...
		return (
			Array.isArray(e) ||
				(e = Object.entries(e).map(([e, t]) => ({ label: t, value: e }))),
			e.forEach((e) => {
				"object" != typeof e && (e = { label: e, value: e }),
	...
	_sortGroup(e, t) {
		t.sort((t, i) =>
			e(t.label, i.label, t.value, i.value, t.original, i.original)
		),
			t.forEach((t) => {
		...
		if (("desc" === this.params.sort && ([e, t] = [t, e]), e || 0 === e)) {
			if (t || 0 === t) {
				...
				for (
					i = i.match(l),
						s = s.match(l),
						r = i.length > s.length ? s.length : i.length;
					a < r;
		...
		if (!this.filtered || e.visible) {
			if (!i) {
				if (
					...
					(t = this.params.itemFormatter
						? this.params.itemFormatter(e.label, e.value, e.original, i)
						: e.label) instanceof HTMLElement
						? i.appendChild(t)
						: (i.innerHTML = t),
					e.group
						? i.classList.add("tabulator-edit-list-group")
						: i.classList.add("tabulator-edit-list-item"),
					...
					for (let t in e.elementAttributes)
						"+" == t.charAt(0)
							? ((t = t.slice(1)),
							  i.setAttribute(
									t,
									this.input.getAttribute(t) + e.elementAttributes["+" + t]
							  ))
							: i.setAttribute(t, e.elementAttributes[t]);
				e.group
					? i.addEventListener("click", this._groupClick.bind(this, e))
					: i.addEventListener("click", this._itemClick.bind(this, e)),
...
var k = {
	input: function (e, t, i, s, o) {
		...
		if (
			(r.setAttribute("type", o.search ? "search" : "text"),
			(r.style.padding = "4px"),
			(r.style.width = "100%"),
			...
			for (let e in o.elementAttributes)
				"+" == e.charAt(0)
					? ((e = e.slice(1)),
					  r.setAttribute(e, r.getAttribute(e) + o.elementAttributes["+" + e]))
					: r.setAttribute(e, o.elementAttributes[e]);
		function a(e) {
			(null == n && "" !== r.value) || r.value !== n
				? i(r.value) && (n = r.value)
				: s();
		}
		return (
	...
	textarea: function (e, t, i, s, o) {
		...
		if (
			...
			for (let e in o.elementAttributes)
				"+" == e.charAt(0)
					? ((e = e.slice(1)),
					  l.setAttribute(e, l.getAttribute(e) + o.elementAttributes["+" + e]))
					: l.setAttribute(e, o.elementAttributes[e]);
		function d(t) {
		...
		return (
			...
			l.addEventListener("keyup", function () {
				...
				(l.style.height = t + "px"),
					t != h && ((h = t), e.getRow().normalizeHeight());
			}),
			l.addEventListener("keydown", function (e) {
				switch (e.keyCode) {
					case 27:
						...
						break;
					case 38:
						("editor" == r || ("hybrid" == r && l.selectionStart)) &&
							(e.stopImmediatePropagation(), e.stopPropagation());
						break;
					case 40:
						("editor" == r ||
							("hybrid" == r && l.selectionStart !== l.value.length)) &&
							(e.stopImmediatePropagation(), e.stopPropagation());
						break;
					case 35:
					case 36:
	...
	number: function (e, t, i, s, o) {
		...
		if (
			...
			for (let e in o.elementAttributes)
				"+" == e.charAt(0)
					? ((e = e.slice(1)),
					  a.setAttribute(e, a.getAttribute(e) + o.elementAttributes["+" + e]))
					: a.setAttribute(e, o.elementAttributes[e]);
		a.value = n;
		var l = function (e) {
			h();
		};
	...
	select: function (e, t, i, s, o) {
		return (
			...
			new L(this, e, t, i, s, o).input
		);
	},
	list: function (e, t, i, s, o) {
		return new L(this, e, t, i, s, o).input;
	},
	...
	star: function (e, t, i, s, o) {
		var n = this,
			...
			h = r.getElementsByTagName("svg")[0]
				? r.getElementsByTagName("svg")[0].getAttribute("width")
				: 14,
			d = [],
		...
		if (
			...
			for (let e in o.elementAttributes)
				"+" == e.charAt(0)
					? ((e = e.slice(1)),
					  c.setAttribute(e, c.getAttribute(e) + o.elementAttributes["+" + e]))
					: c.setAttribute(e, o.elementAttributes[e]);
	...
	progress: function (e, t, i, s, o) {
		var n,
			...
			l =
				void 0 === o.max
					? (a.getElementsByTagName("div")[0] &&
							a.getElementsByTagName("div")[0].getAttribute("max")) ||
					  100
					: o.max,
			h =
				void 0 === o.min
					? (a.getElementsByTagName("div")[0] &&
							a.getElementsByTagName("div")[0].getAttribute("min")) ||
					  0
					: o.min,
			d = (l - h) / 100,
			c = e.getValue() || 0,
		...
		if (
			...
			for (let e in o.elementAttributes)
				"+" == e.charAt(0)
					? ((e = e.slice(1)),
					  m.setAttribute(e, m.getAttribute(e) + o.elementAttributes["+" + e]))
					: m.setAttribute(e, o.elementAttributes[e]);
		return (
	...
	tickCross: function (e, t, i, s, o) {
		...
		function u(e) {
			var t = r.checked;
			return (
				(t = d && t ? o.trueValue : c && !t ? o.falseValue : t),
				a
					? e
						? h
							? l
							: t
						: r.checked && !h
						? ((r.checked = !1), (r.indeterminate = !0), (h = !0), l)
						: ((h = !1), t)
					: t
			);
		}
...
class D extends o {
	...
	navigatePrev(e = this.currentCell, t) {
		...
		if (e) {
			...
			if (
				(s = this.table.rowManager.prevDisplayRow(e.row, !0)) &&
				(i = this.findNextEditableCell(s, s.cells.length))
			)
	...
	navigateNext(e = this.currentCell, t) {
		...
		if (e) {
			...
			if (
				(s = this.table.rowManager.nextDisplayRow(e.row, !0)) &&
				(i = this.findNextEditableCell(s, -1))
			)
				return i.getComponent().edit(), !0;
		}
		return !1;
	...
	navigateLeft(e = this.currentCell, t) {
		...
		return (
			!!(
				...
				(t && t.preventDefault(),
				(i = e.getIndex()),
				(s = this.findPrevEditableCell(e.row, i)))
			) && (s.getComponent().edit(), !0)
		);
	}
	navigateRight(e = this.currentCell, t) {
		...
		return (
			!!(
				...
				(t && t.preventDefault(),
				(i = e.getIndex()),
				(s = this.findNextEditableCell(e.row, i)))
			) && (s.getComponent().edit(), !0)
		);
	}
	...
	findNextEditableCell(e, i) {
		var s = !1;
		if (i < e.cells.length - 1)
			for (var o = i + 1; o < e.cells.length; o++) {
				let i = e.cells[o];
				if (i.column.modules.edit && t.elVisible(i.getElement())) {
					let e = !0;
					if (
						("function" == typeof i.column.modules.edit.check &&
							(e = i.column.modules.edit.check(i.getComponent())),
						e)
					) {
						s = i;
						break;
	...
	initializeColumn(e) {
		...
		switch (typeof e.definition.editor) {
			case "string":
				this.editors[e.definition.editor]
					? (t.editor = this.editors[e.definition.editor])
					: console.warn(
				...
				!0 === e.definition.editor &&
					("function" != typeof e.definition.formatter
						? this.editors[e.definition.formatter]
							? (t.editor = this.editors[e.definition.formatter])
							: (t.editor = this.editors.input)
						: console.warn(
	...
	focusScrollAdjust(e) {
		if ("virtual" == this.table.rowManager.getRenderMode()) {
			...
			s.offsetTop;
			s.offsetTop < t
				? (this.table.rowManager.element.scrollTop -= t - s.offsetTop)
				: s.offsetTop + s.offsetHeight > i &&
				  (this.table.rowManager.element.scrollTop +=
						s.offsetTop + s.offsetHeight - i);
			...
			this.table.modExists("frozenColumns") &&
				...
				(n -= parseInt(this.table.modules.frozenColumns.rightMargin))),
				"virtual" === this.table.options.renderHorizontal &&
					((o -= parseInt(this.table.columnManager.renderer.vDomPadLeft)),
					(n -= parseInt(this.table.columnManager.renderer.vDomPadLeft))),
				r.offsetLeft < o
					? (this.table.rowManager.element.scrollLeft -= o - r.offsetLeft)
					: r.offsetLeft + r.offsetWidth > n &&
					  (this.table.rowManager.element.scrollLeft +=
							r.offsetLeft + r.offsetWidth - n);
		}
	}
	edit(e, t, i) {
		...
		if (!this.currentCell) {
			...
			switch ((t && t.stopPropagation(), typeof e.column.modules.edit.check)) {
				case "function":
					a = e.column.modules.edit.check(e.getComponent());
					break;
				case "boolean":
					a = e.column.modules.edit.check;
			}
			if (a || i) {
				if (
					(r.cancelEdit(),
					...
					this.mouseClick &&
						((this.mouseClick = !1),
						e.column.definition.cellClick &&
							e.column.definition.cellClick.call(this.table, t, o)),
					e.column.definition.cellEditing &&
						e.column.definition.cellEditing.call(this.table, o),
					this.dispatch("cell-editing", e),
					this.dispatchExternal("cellEditing", o),
					(n =
						"function" == typeof e.column.modules.edit.params
							? e.column.modules.edit.params(o)
						...
						(s = e.column.modules.edit.editor.call(
							...
							function (t) {
								if (r.currentCell === e) {
									...
									return !0 === i ||
										"highlight" === r.table.options.validationMode
										? (r.clearEditor(),
				...
				for (
					h.classList.add("tabulator-editing"),
				...
				h.appendChild(s), l();
				for (var d = h.children, c = 0; c < d.length; c++)
	...
	clearEdited(e) {
		...
		e.modules.edit &&
			...
			((e.modules.edit.edited = !1), this.dispatch("edit-edited-clear", e)),
			(t = this.editedCells.indexOf(e)) > -1 && this.editedCells.splice(t, 1);
	}
}
(D.moduleName = "edit"), (D.editors = k);
class P {
	constructor(e, t, i, s) {
		(this.type = e),
			(this.columns = t),
...
class z extends o {
	...
	rowLookup(e) {
		...
		if ("function" == typeof e)
			...
			switch (e) {
				...
				case "active":
				default:
					t = this.table.options.pagination
		...
		function o(e, s) {
			...
			if (
				...
				for (let i = 1; i < e.height; i++)
					void 0 === t[s + i] && (t[s + i] = []), t[s + i].push(!1);
			...
			t.forEach((e) => {
				...
				e.forEach((e) => {
					if (e) {
						...
						t.push(
							new S(i, e.column.getComponent(), e.width, e.height, e.depth)
						);
					} else t.push(null);
				}),
					s.push(new P("header", t));
			}),
			s
		);
	}
	bodyToExportRows(e) {
		...
		return (
			...
			(e = e.filter((e) => {
				...
				switch (e.type) {
					case "group":
						(r = e.level), n.push(new S(e.key, e.getComponent(), t.length, 1));
						break;
					case "calc":
					case "row":
						t.forEach((e) => {
							n.push(new S(e._column.getFieldValue(o), e, 1, 1));
						}),
							this.table.options.dataTree &&
								!1 !== this.config.dataTree &&
								(r = e.modules.dataTree.index);
				}
				i.push(new P(e.type, n, e.getComponent(), r));
			}),
			i
		);
	}
	genereateTableElement(e) {
		...
		return (
			...
			this.table.options.dataTree &&
				!1 !== this.config.dataTree &&
				this.table.modExists("columnCalcs") &&
				(r.treeElementField = this.table.modules.dataTree.elementField),
			(r.groupHeader =
				this.table.options[
					"groupHeader" +
						(this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))
			...
			r.groupHeader &&
				!Array.isArray(r.groupHeader) &&
				(r.groupHeader = [r.groupHeader]),
			...
			e.forEach((e, t) => {
				switch (e.type) {
					case "header":
						i.appendChild(this.genereateHeaderElement(e, r, o));
						break;
					case "group":
						s.appendChild(this.genereateGroupElement(e, r, o));
						break;
					case "calc":
						s.appendChild(this.genereateCalcElement(e, r, o));
						break;
					case "row":
						let n = this.genereateRowElement(e, r, o);
						this.mapElementStyles(
							t % 2 && o.evenRow ? o.evenRow : o.oddRow,
							n,
							[
								"border-top",
								"border-left",
			...
			t.appendChild(s),
			this.mapElementStyles(this.table.element, t, [
				"border-top",
				"border-left",
				"border-right",
				"border-bottom",
	...
	lookupTableStyles() {
		...
		return (
			this.cloneTableStyle &&
				...
				e.firstRow &&
					((e.styleCells = e.firstRow.getElementsByClassName("tabulator-cell")),
					(e.firstCell = e.styleCells[0]),
					(e.lastCell = e.styleCells[e.styleCells.length - 1]))),
			e
		);
	}
	genereateHeaderElement(e, t, i) {
				...
				if (e) {
					...
					(t.colSpan = e.width),
						...
						e.component._column.visible
							? this.mapElementStyles(e.component.getElement(), t, ["width"])
							: e.component._column.definition.width &&
							  (t.style.width = e.component._column.definition.width + "px"),
	...
	genereateGroupElement(e, t, i) {
		...
		return (
			...
			t.groupHeader && t.groupHeader[e.indent]
				? (n.value = t.groupHeader[e.indent](
						n.value,
						e.component._group.getRowCount(),
						e.component._group.getData(),
						e.component
				...
				: !1 === t.groupHeader
				? (n.value = n.value)
				: (n.value = e.component._group.generator(
						n.value,
						e.component._group.getRowCount(),
						e.component._group.getData(),
						e.component
			...
			this.mapElementStyles(i.firstGroup, s, [
				"border-top",
				"border-left",
				"border-right",
				"border-bottom",
	...
	genereateCalcElement(e, t, i) {
		var s = this.genereateRowElement(e, t, i);
		return (
			s.classList.add("tabulator-print-table-calcs"),
			this.mapElementStyles(i.calcRow, s, [
				"border-top",
				"border-left",
				"border-right",
				"border-bottom",
			...
			e.columns.forEach((n) => {
				if (n) {
					var r = document.createElement("td"),
						a = n.component._column,
						l = this.table.columnManager.findColumnIndex(a),
						h = n.value,
						d = {
							modules: {},
							getValue: function () {
					...
					if (
						((a.definition.cssClass
							? a.definition.cssClass.split(" ")
							: []
						).forEach(function (e) {
							r.classList.add(e);
						}),
					...
					h instanceof Node ? r.appendChild(h) : (r.innerHTML = h),
						(s.styleCells[l] || s.firstCell) &&
							(this.mapElementStyles(s.styleCells[l] || s.firstCell, r, [
								"padding-top",
								"padding-left",
								"padding-right",
								"padding-bottom",
							...
							a.definition.align && (r.style.textAlign = a.definition.align)),
						this.table.options.dataTree &&
							!1 !== this.config.dataTree &&
							((t.treeElementField && t.treeElementField == a.field) ||
								(!t.treeElementField && 0 == i)) &&
							(e.component._row.modules.dataTree.controlEl &&
								r.insertBefore(
									e.component._row.modules.dataTree.controlEl.cloneNode(!0),
									r.firstChild
								),
							e.component._row.modules.dataTree.branchEl &&
								r.insertBefore(
									e.component._row.modules.dataTree.branchEl.cloneNode(!0),
									r.firstChild
								)),
						o.appendChild(r),
						d.modules.format &&
...
var F = {
	...
	in: function (e, t, i, s) {
		return Array.isArray(e)
			...
			: (console.warn("Filter Error - filter value is not an array:", e), !1);
	},
};
class H extends o {
	constructor(e) {
		super(e),
			...
			this.registerTableFunction(
				"clearFilter",
				this.userClearFilter.bind(this)
			),
			this.registerTableFunction(
				"clearHeaderFilter",
	...
	userSetHeaderFilterValue(e, t) {
		...
		if (!i)
			return (
				console.warn("Column Filter Error - No matching column found:", e), !1
			);
		...
		(e.modules.filter = {
			success: function (t) {
				...
				if (
					...
					if (
						((e.modules.filter.prevSuccess = t), e.modules.filter.emptyFunc(t))
					)
						...
						switch (
							...
							case "string":
								H.filters[e.definition.headerFilterFunc]
									? ((r = e.definition.headerFilterFunc),
									  (o = function (i) {
											var s = e.definition.headerFilterFuncParams || {},
												o = e.getFieldValue(i);
											return (
												(s = "function" == typeof s ? s(t, o, i) : s),
												H.filters[e.definition.headerFilterFunc](t, o, i, s)
											);
									  }))
									: console.warn(
							...
							switch (n) {
								case "partial":
									(o = function (i) {
										...
										return (
											null != s &&
											String(s).toLowerCase().indexOf(String(t).toLowerCase()) >
												-1
										);
									}),
										(r = "like");
						...
						i.headerFilters[s] = { value: t, func: o, type: r, params: {} };
					}
					(e.modules.filter.value = t),
						(a = JSON.stringify(i.headerFilters)),
						i.prevHeaderFilterChangeCheck !== a &&
							((i.prevHeaderFilterChangeCheck = a),
							i.trackChanges(),
							i.refreshFilter());
				}
	...
	generateHeaderFilterElement(e, t, i) {
		var s,
			...
			h,
			d = this,
			c = e.modules.filter.success,
			u = e.getField();
		if (
			((e.modules.filter.value = t),
			e.modules.filter.headerElement &&
				e.modules.filter.headerElement.parentNode &&
				e.contentElement.removeChild(e.modules.filter.headerElement.parentNode),
			u)
		) {
			switch (
				...
				case "string":
					d.table.modules.edit.editors[e.definition.headerFilter]
						? ((o = d.table.modules.edit.editors[e.definition.headerFilter]),
				...
				case "boolean":
					e.modules.edit && e.modules.edit.editor
						...
						: e.definition.formatter &&
						  d.table.modules.edit.editors[e.definition.formatter]
						? ((o = d.table.modules.edit.editors[e.definition.formatter]),
			...
			if (o) {
				if (
					...
					(h =
						"function" == typeof (h = e.definition.headerFilterParams || {})
							? h.call(d.table, r)
							: h),
					!(n = o.call(
				...
				u
					? d.langBind(
							...
							function (e) {
								n.setAttribute(
									"placeholder",
									void 0 !== e && e ? e : d.langText("headerFilters|default")
								);
							}
					  )
					...
					n.addEventListener("focus", (e) => {
						var t = this.table.columnManager.element.scrollLeft;
						t !==
							this.table.rowManager.element.scrollLeft +
					...
					(e.modules.filter.attrType = n.hasAttribute("type")
						? n.getAttribute("type").toLowerCase()
						: ""),
					...
					i || d.headerFilterColumns.push(e);
			}
		} else
			console.warn(
	...
	filtersToArray(e, t) {
		...
		return (
			e.forEach((e) => {
				var s;
				Array.isArray(e)
					? i.push(this.filtersToArray(e, t))
					: ((s = { field: e.field, type: e.type, value: e.value }),
	...
	removeFilter(e, t, i) {
		Array.isArray(e) || (e = [{ field: e, type: t, value: i }]),
			e.forEach((e) => {
				var t = -1;
				(t =
					"object" == typeof e.field
						? this.filterList.findIndex((t) => e === t)
...
(H.moduleName = "filter"), (H.filters = F);
var _ = {
	...
	money: function (e, t, i) {
		...
		if (
			(a < 0 && ((a = Math.abs(a)), (l = c)),
			(s = !1 !== p ? a.toFixed(p) : a),
			(o = (s = String(s).split("."))[0]),
			(n = s.length > 1 ? h + s[1] : ""),
			!1 !== t.thousand)
		)
			for (r = /(\d+)(\d{3})/; r.test(o); ) o = o.replace(r, "$1" + d + "$2");
		return m ? l + o + n + u : l + u + o + n;
	},
	link: function (e, t, i) {
		var s,
			o = e.getValue(),
		...
		if (a) {
			if ((t.urlField && (o = (s = e.getData())[t.urlField]), t.url))
				switch (typeof t.url) {
					case "string":
						o = t.url;
						break;
			...
			return (
				...
				t.download &&
					((r = "function" == typeof r ? r(e) : !0 === r ? "" : r),
					l.setAttribute("download", r)),
	...
	image: function (e, t, i) {
		var s = document.createElement("img"),
			o = e.getValue();
		switch (
			(t.urlPrefix && (o = t.urlPrefix + e.getValue()),
	...
	tickCross: function (e, t, i) {
		...
		return (a && s === t.trueValue) ||
			...
			: !n || ("null" !== s && "" !== s && null != s)
			? (o.setAttribute("aria-checked", !1), h || "")
	...
	datetime: function (e, t, i) {
		var s,
			...
			l = e.getValue();
		if (void 0 !== o)
			return (s = o.isDateTime(l)
				? l
				: "iso" === n
				? o.fromISO(String(l))
				: o.fromFormat(String(l), n)).isValid
				? (t.timezone && (s = s.setZone(t.timezone)), s.toFormat(r))
				: !0 !== a && l
				? "function" == typeof a
					? a(l)
					: a
	...
	datetimediff: function (e, t, i) {
		var s,
			...
			c = e.getValue();
		if (void 0 !== o)
			return (s = o.isDateTime(c)
				? c
				: "iso" === n
				? o.fromISO(String(c))
				: o.fromFormat(String(c), n)).isValid
				? h
					? s.diff(d, l).toHuman() + (a ? " " + a : "")
					: parseInt(s.diff(d, l)[l]) + (a ? " " + a : "")
				: !0 === r
				? c
				: "function" == typeof r
				? r(c)
	...
	lookup: function (e, t, i) {
		var s = e.getValue();
		return void 0 === t[s]
			? (console.warn("Missing display value for " + s), s)
			: t[s];
	},
	star: function (e, t, i) {
		var s = e.getValue(),
	...
	traffic: function (e, t, i) {
		...
		if (!isNaN(n) && void 0 !== e.getValue()) {
			switch (
				(r.classList.add("tabulator-traffic-light"),
	...
	progress: function (e, t, i) {
		var s,
			...
			r,
			a,
			l = this.sanitizeHTML(e.getValue()) || 0,
			h = e.getElement(),
			d = t && t.max ? t.max : 100,
			c = t && t.min ? t.min : 0,
			u = t && t.legendAlign ? t.legendAlign : "center";
		switch (
			((o = parseFloat(l) <= d ? parseFloat(l) : d),
			(o = parseFloat(o) >= c ? parseFloat(o) : c),
			(s = (d - c) / 100),
			(o = Math.round((o - c) / s)),
			typeof t.color)
		) {
		...
		switch (typeof t.legendColor) {
			...
			case "object":
				if (Array.isArray(t.legendColor)) {
					(m = 100 / t.legendColor.length), (g = Math.floor(o / m));
		...
		(h.style.minWidth = "30px"),
			(h.style.position = "relative"),
			h.setAttribute("aria-label", o);
		...
		return (
			i(function () {
				...
				h.appendChild(f), f.appendChild(b), r && f.appendChild(v);
			}),
			""
		);
	},
	color: function (e, t, i) {
		return (
			(e.getElement().style.backgroundColor = this.sanitizeHTML(e.getValue())),
			""
		);
	},
	...
	responsiveCollapse: function (e, t, i) {
		...
		function n(e) {
			...
			(o.open = e),
				t &&
					(o.open
						? (s.classList.add("open"), (t.style.display = ""))
						: (s.classList.remove("open"), (t.style.display = "none")));
		}
		return (
			...
			s.addEventListener("click", function (e) {
				e.stopImmediatePropagation(), n(!o.open);
			}),
			n(o.open),
			s
		);
			...
			if (
				...
				n instanceof w
					? (s.addEventListener("change", (e) => {
							"click" === this.table.options.selectableRangeMode && o
								? (o = !1)
								: n.toggleSelect();
					  }),
				...
				s.addEventListener("change", (e) => {
					this.table.modules.selectRow.selectedRows.length
						? this.table.deselectRow()
						: this.table.selectRow(t.rowRange);
				}),
...
class O extends o {
	...
	initializeColumn(e) {
		(e.modules.format = this.lookupFormatter(e, "")),
			...
			void 0 !== e.definition.formatterHtmlOutput &&
				(e.modules.format.htmlOutput = this.lookupFormatter(e, "HtmlOutput"));
	}
	lookupFormatter(e, t) {
		...
		switch (typeof s) {
			case "string":
				O.formatters[s]
					? (i.formatter = O.formatters[s])
					: (console.warn("Formatter Error - No such formatter found: ", s),
					  (i.formatter = O.formatters.plaintext));
				break;
			case "function":
				i.formatter = s;
				break;
	...
	cellRendered(e) {
		e.modules.format &&
			...
			(e.modules.format.renderedCallback(), (e.modules.format.rendered = !0));
	}
	formatHeader(e, t, i) {
		var s, o, n, r;
		return e.definition.titleFormatter
			? ((s = this.getFormatter(e.definition.titleFormatter)),
			  ...
			  (o =
					"function" == typeof (o = e.definition.titleFormatterParams || {})
						? o()
						: o),
			  s.call(this, r, o, n))
			: t;
	...
	formatExportValue(e, t) {
		...
		if (s) {
			return (
				(i = "function" == typeof s.params ? s.params(component) : s.params),
				s.formatter.call(this, e.getComponent(), i, function (t) {
					e.modules.format || (e.modules.format = {}),
						(e.modules.format.renderedCallback = t),
						(e.modules.format.rendered = !1);
				})
	...
	getFormatter(e) {
		switch (typeof e) {
			case "string":
				O.formatters[e]
					? (e = O.formatters[e])
					: (console.warn("Formatter Error - No such formatter found: ", e),
					  (e = O.formatters.plaintext));
				break;
			case "function":
				e = e;
				break;
...
(O.moduleName = "format"), (O.formatters = _);
class A extends o {
	constructor(e) {
		super(e),
			(this.leftColumns = []),
	...
	layoutGroupCalcs(e) {
		e.forEach((e) => {
			e.calcs.top && this.layoutRow(e.calcs.top),
				...
				e.groupList &&
					e.groupList.length &&
					this.layoutGroupCalcs(e.groupList && e.groupList);
		});
	}
	layoutColumnPosition(e) {
		...
		(this.table.columnManager.headersElement.style.marginLeft =
			...
			this.leftColumns.forEach((s, o) => {
				if (
					((s.modules.frozen.marginValue =
						i + this.table.columnManager.scrollLeft),
					(s.modules.frozen.margin = s.modules.frozen.marginValue + "px"),
					s.visible && (i += s.getWidth()),
					o == this.leftColumns.length - 1
						? (s.modules.frozen.edge = !0)
						: (s.modules.frozen.edge = !1),
					s.parent.isGroup)
				) {
					var n = this.getColGroupParentElement(s);
					t.includes(n) || (this.layoutElement(n, s), t.push(n)),
						s.modules.frozen.edge &&
							n.classList.add("tabulator-frozen-" + s.modules.frozen.position);
			...
			this.rightColumns.forEach((t, i) => {
				t.visible && (s += t.getWidth()),
					(t.modules.frozen.marginValue = this.rightPadding - s),
					(t.modules.frozen.margin = t.modules.frozen.marginValue + "px"),
					i == this.rightColumns.length - 1
						? (t.modules.frozen.edge = !0)
						: (t.modules.frozen.edge = !1),
					t.parent.isGroup
						? this.layoutElement(this.getColGroupParentElement(t), t)
						: this.layoutElement(t.getElement(), t),
					e &&
						t.cells.forEach((e) => {
	...
	reinitializeRows() {
		var e = this.table.rowManager.getVisibleRows();
...
class N {
	...
	_addRowToGroup(e) {
		...
		if (this.hasSubGroups) {
			var i = this.groupManager.groupIDLookups[t].func(e.getData()),
				s = t + "_" + i;
			this.groupManager.allowedValues && this.groupManager.allowedValues[t]
				? this.groups[s] && this.groups[s].addRow(e)
				: (this.groups[s] || this._createGroup(i, t), this.groups[s].addRow(e));
		}
	}
	_addRow(e) {
			...
			this.visible
				? this.groupList.length
					...
					: (!e &&
							...
							(this.calcs.top &&
								(this.calcs.top.detachElement(), this.calcs.top.deleteCells()),
							(this.calcs.top =
	...
	reinitialize() {
		(this.initialized = !1),
			(this.height = 0),
			t.elVisible(this.element) && this.initialize(!0);
	}
	setHeight(e) {
		this.height != e &&
...
class V extends o {
		...
		if (this.table.options.groupBy) {
			...
			if (
				...
				this.langBind("groups|item", (e, t) => {
					this.headerGenerator[0] = (i, s, o) =>
						(void 0 === i ? "" : i) +
						"<span>(" +
						s +
						" " +
						(1 === s ? e : t.groups.items) +
						")</span>";
				}),
				(this.groupIDLookups = []),
				Array.isArray(e) || e)
				...
				this.table.columnManager.getRealColumns().forEach((e) => {
					e.definition.topCalc &&
						this.table.modules.columnCalcs.initializeTopRow(),
						e.definition.bottomCalc &&
	...
	setGroupBy(e) {
		(this.table.options.groupBy = e),
			this.initialized ? this.configureGroupSetup() : this.initialize(),
			this.refreshData(),
			this.trackChanges();
	}
	setGroupValues(e) {
	...
	rowMoving(e, t, i) {
		!i && t instanceof N && (t = this.table.rowManager.prevDisplayRow(e) || t);
		var s = t instanceof N ? t : t.modules.group,
			o = e instanceof N ? e : e.modules.group;
		s === o
			? this.table.rowManager.moveRowInArray(s.rows, e, t, i)
			: (o && o.removeRow(e), s.insertRow(e, t, i));
	}
	rowDeleting(e) {
		...
		return (
			e.forEach((e) => {
				var i = { level: 0, rowCount: 0, headerContent: "" },
					s = [];
				e.hasSubGroups
					? ((s = this.pullGroupListData(e.groupList)),
					  (i.level = e.level),
	...
	reassignRowToGroup(e) {
		if ("row" === e.type) {
			...
			(i.length == s.length && i.every((e, t) => e === s[t])) ||
				(t.removeRow(e),
...
class W extends o {
	...
	rowDeleted(e) {
		...
		this.table.options.groupBy
			...
			this.action("rowDelete", e, { data: e.getData(), pos: !t, index: t });
	}
	cellUpdated(e) {
	...
	_rebindRow(e, t) {
		this.history.forEach(function (i) {
			if (i.component instanceof C) i.component === e && (i.component = t);
			else if (i.component instanceof g && i.component.row === e) {
...
class G extends o {
	...
	_extractHeaders(e, t) {
		for (var i = 0; i < e.length; i++) {
			...
			r ? (n = !0) : (r = { title: o.textContent.trim() }),
				r.field ||
					(r.field = o.textContent.trim().toLowerCase().replace(" ", "_")),
...
class U extends o {
	...
	loadData(e, t, i, s, o) {
		return this.importData(this.lookupImporter(), e)
			...
			.catch(
				(e) => (
					console.error("Import Error:", e || "Unable to import data"),
					Promise.reject(e)
				)
			);
	}
	lookupImporter(e) {
		...
		return (
			...
			(t = "string" == typeof e ? U.importers[e] : e) ||
...
(U.moduleName = "import"), (U.importers = j);
class X extends o {
	constructor(e) {
		super(e),
			(this.eventMap = {
		...
		if (
			...
			try {
				if (document.selection)
					(i = document.body.createTextRange()).moveToElementText(this.element),
						i.select();
	...
	subscribeTouchEvents(e) {
		...
		this.touchSubscribers[t + "-touchstart"] ||
			((this.touchSubscribers[t + "-touchstart"] = this.handleTouch.bind(
				this,
				t,
				"start"
			)),
			...
			case "end":
				o.tap && ((o.tap = null), this.dispatchEvent(e + "Tap", i, s)),
					o.tapDbl
						? (clearTimeout(o.tapDbl),
						  (o.tapDbl = null),
						  this.dispatchEvent(e + "DblTap", i, s))
						: (o.tapDbl = setTimeout(() => {
	...
	dispatchEvent(e, t, i) {
		...
		this.columnSubscribers[e] &&
			(i instanceof g
				? (s = i.column.definition[e])
				: i instanceof v && (s = i.definition[e]),
			s && s(t, o)),
			this.dispatchExternal(e, t, o);
	}
}
X.moduleName = "interaction";
class q extends o {
	constructor(e) {
		super(e),
			(this.watchKeys = null),
	...
	mapBinding(e, t) {
		var i = { action: q.actions[e], keys: [], ctrl: !1, shift: !1, meta: !1 };
		t.toString()
			.toLowerCase()
			.split(" ")
			.join("")
...
class K extends o {
	...
	initializeColumnHeaderMenu(e) {
		...
		(t = document.createElement("span")).classList.add(
			...
			i
				? ("function" == typeof i && (i = i(e.getComponent())),
				  i instanceof HTMLElement ? t.appendChild(i) : (t.innerHTML = i))
				: (t.innerHTML = "&vellip;"),
	...
	loadMenuEvent(e, t, i) {
		i._group ? (i = i._group) : i._row && (i = i._row),
			(e =
				"function" == typeof e ? e.call(this.table, t, i.getComponent()) : e),
			this.loadMenu(t, i, e);
	}
	loadMenu(e, t, i, s, o) {
		var n,
			...
			i.forEach((e) => {
				...
				e.separator
					...
					: (i.classList.add("tabulator-menu-item"),
					  "function" == typeof s &&
							(s = s.call(this.table, t.getComponent())),
					  s instanceof Node ? i.appendChild(s) : (i.innerHTML = s),
					  "function" == typeof o &&
							(o = o.call(this.table, t.getComponent())),
					  o
...
class J extends o {
	...
	initializeColumn(e) {
		...
		e.modules.frozen ||
			...
			(o.mousemove = function (o) {
				e.parent === s.moving.parent &&
					((s.touchMove ? o.touches[0].pageX : o.pageX) -
						t.elOffset(i).left +
						s.table.columnManager.element.scrollLeft >
					e.getWidth() / 2
						? (s.toCol === e && s.toColAfter) ||
						  (i.parentNode.insertBefore(s.placeholderElement, i.nextSibling),
						  s.moveColumn(e, !0))
						: (s.toCol !== e || s.toColAfter) &&
						  (i.parentNode.insertBefore(s.placeholderElement, i),
						  s.moveColumn(e, !1)));
			}.bind(s)),
			...
			i.addEventListener("mouseup", function (e) {
				1 === e.which && s.checkTimeout && clearTimeout(s.checkTimeout);
			}),
			s.bindTouchEvents(e)),
	...
	startMove(e, i) {
		var s = i.getElement(),
			o = this.table.columnManager.getElement(),
			n = this.table.columnManager.getHeadersElement();
		(this.moving = i),
			(this.startX =
				(this.touchMove ? e.touches[0].pageX : e.pageX) - t.elOffset(s).left),
			this.table.element.classList.add("tabulator-block-select"),
			(this.placeholderElement.style.width = i.getWidth() + "px"),
			(this.placeholderElement.style.height = i.getHeight() + "px"),
			s.parentNode.insertBefore(this.placeholderElement, s),
			s.parentNode.removeChild(s),
			(this.hoverElement = s.cloneNode(!0)),
			this.hoverElement.classList.add("tabulator-moving"),
			this.table.columnManager.getElement().appendChild(this.hoverElement),
			(this.hoverElement.style.left = "0"),
			(this.hoverElement.style.bottom = o.clientHeight - n.offsetHeight + "px"),
			this.touchMove ||
				(this._bindMouseMove(),
	...
	_unbindMouseMove() {
		this.table.columnManager.columnsByIndex.forEach(function (e) {
			e.modules.moveColumn.mousemove &&
				e
					.getElement()
					.removeEventListener("mousemove", e.modules.moveColumn.mousemove);
		});
	}
	moveColumn(e, t) {
		...
		(this.toCol = e),
			...
			t
				? e.getCells().forEach(function (e, t) {
						...
						s.parentNode &&
							i[t] &&
							s.parentNode.insertBefore(i[t].getElement(), s.nextSibling);
				  })
				: e.getCells().forEach(function (e, t) {
						var s = e.getElement(!0);
						s.parentNode &&
							i[t] &&
							s.parentNode.insertBefore(i[t].getElement(), s);
				  });
	}
	endMove(e) {
	...
	moveHover(e) {
		var i,
			s = this.table.columnManager.getElement(),
			o = s.scrollLeft,
			n =
				(this.touchMove ? e.touches[0].pageX : e.pageX) -
				t.elOffset(s).left +
				o;
		(this.hoverElement.style.left = n - this.startX + "px"),
			n - o < this.autoScrollMargin &&
				(this.autoScrollTimeout ||
					(this.autoScrollTimeout = setTimeout(() => {
						(i = Math.max(0, o - 5)),
							(this.table.rowManager.getElement().scrollLeft = i),
							(this.autoScrollTimeout = !1);
					}, 1))),
			o + s.clientWidth - n < this.autoScrollMargin &&
				(this.autoScrollTimeout ||
					(this.autoScrollTimeout = setTimeout(() => {
						(i = Math.min(s.clientWidth, o + 5)),
							(this.table.rowManager.getElement().scrollLeft = i),
							(this.autoScrollTimeout = !1);
					}, 1)));
	}
}
J.moduleName = "moveColumn";
class Y extends o {
	constructor(e) {
		super(e),
			(this.placeholderElement = this.createPlaceholderElement()),
	...
	initializeRow(e) {
		...
		(o.mouseup = function (t) {
			...
			(o.mousemove = function (i) {
				var o = e.getElement();
				i.pageY - t.elOffset(o).top + s.table.rowManager.element.scrollTop >
				e.getHeight() / 2
					? (s.toRow === e && s.toRowAfter) ||
					  (o.parentNode.insertBefore(s.placeholderElement, o.nextSibling),
					  s.moveRow(e, !0))
					: (s.toRow !== e || s.toRowAfter) &&
					  (o.parentNode.insertBefore(s.placeholderElement, o),
					  s.moveRow(e, !1));
			}.bind(s)),
			this.hasHandle ||
				((i = e.getElement()).addEventListener("mousedown", function (t) {
					1 === t.which &&
						(s.checkTimeout = setTimeout(function () {
							s.startMove(t, e);
						}, s.checkPeriod));
	...
	bindTouchEvents(e, t) {
		...
		t.addEventListener(
			...
			t.addEventListener("touchend", (e) => {
				this.checkTimeout && clearTimeout(this.checkTimeout),
					this.moving && (this.endMove(e), (this.touchMove = !1));
			});
	}
	_bindMouseMove() {
		...
		(i = t.getElement()),
			this.connection
				? ((s = i.getBoundingClientRect()),
				  ...
				  (this.startY = s.top - n + window.pageYOffset))
				: (this.startY = n - i.getBoundingClientRect().top);
	}
	endMove(e) {
	...
	moveHoverTable(e) {
		var t = this.table.rowManager.getElement(),
			...
			s =
				...
				i;
		this.hoverElement.style.top = s - this.startY + "px";
	}
			...
			this.connectionSelectorsElements &&
				...
				this.connectionSelectorsElements.forEach((e) => {
					"string" == typeof e
						...
						: this.connectionElements.push(e);
				}),
...
class $ extends o {
	...
	initializeColumn(e) {
		...
		this.allowedTypes.forEach((s) => {
			...
			e.definition[n] &&
				(o = this.lookupMutator(e.definition[n])) &&
				((t = !0),
				(i[n] = { mutator: o, params: e.definition[n + "Params"] || {} }));
		}),
		...
		return (
			this.enabled &&
				this.table.columnManager.traverse((n) => {
					var r, a, l;
					n.modules.mutate &&
						(r = n.modules.mutate[o] || n.modules.mutate.mutator || !1) &&
						((s = n.getFieldValue(void 0 !== i ? i : e)),
						("data" != t && void 0 === s) ||
							((l = n.getComponent()),
							(a =
	...
	transformCell(e, t) {
		if (e.column.modules.mutate) {
			...
			if (i)
				return (
					(s = Object.assign(s, e.row.getData())),
...
var Z = {
	rows: function (e, t, i, s, o) {
		...
		return (
			...
			s
				? ((a.innerHTML = " " + t + "-" + Math.min(t + e - 1, s) + " "),
				  (h.innerHTML = " " + s + " "),
				  n.appendChild(r),
				  n.appendChild(a),
				  n.appendChild(l),
...
class Q extends o {
	constructor(e) {
		super(e),
			...
			this.registerTableFunction(
				"setPageSize",
				this.userSetPageSize.bind(this)
			),
		...
		return (
			t
				? o.length
					? (i = o[0])
					: s.activeRows.length &&
					  ((i = s.activeRows[s.activeRows.length - 1]), (t = !1))
				: o.length && ((i = o[o.length - 1]), (t = !(o.length < this.size))),
			{ index: i, top: t }
		);
	}
	calculatePageSizes() {
		...
		this.table.options.paginationSize
			...
			: ((e = document.createElement("div")).classList.add("tabulator-row"),
			  ...
			  (this.size = Math.floor(
					this.table.rowManager.getElement().clientHeight / e.offsetHeight
			  )),
	...
	userSetPageToRow(e) {
		return this.table.options.pagination && (e = this.rowManager.findRow(e))
			? this.setPageToRow(e)
			: Promise.reject();
	}
	userSetPageSize(e) {
		return (
			!!this.table.options.pagination && (this.setPageSize(e), this.setPage(1))
		);
	}
	scrollVertical(e, t) {
		var i;
	...
	initializePageCounter() {
		var e = this.table.options.paginationCounter,
			t = null;
		e &&
			((t = "function" == typeof e ? e : Q.pageCounters[e])
				? ((this.pageCounter = t),
				  (this.pageCounterElement = document.createElement("span")),
				  this.pageCounterElement.classList.add("tabulator-page-counter"))
				: console.warn("Pagination Error - No such page counter found: ", e));
	}
		...
		e ||
			...
			this.pageSizeSelect &&
				...
				this.pageSizeSelect.addEventListener("change", (e) => {
					this.setPageSize(
						"true" == this.pageSizeSelect.value || this.pageSizeSelect.value
					),
						this.setPage(1);
				})),
	...
	setPage(e) {
		...
		return ((e = parseInt(e)) > 0 && e <= this.max) || "local" !== this.mode
	...
	setPageSize(e) {
		!0 !== e && (e = parseInt(e)),
			e > 0 && ((this.size = e), this.dispatchExternal("pageSizeChanged", e)),
	...
	_setPageButtons() {
		...
		1 == this.page
			...
			this.page == this.max
				...
				: ((this.lastBut.disabled = !1), (this.nextBut.disabled = !1));
		for (let e = i; e <= s; e++)
			e > 0 &&
				e <= this.max &&
				this.pagesElement.appendChild(this._generatePageButton(e));
		this.footerRedraw();
	}
	...
	getRows(e) {
		...
		if ("local" == this.mode) {
			(t = []),
				...
				!0 === this.size
					? ((i = 0), (s = e.length))
					: (s = (i = this.size * (this.page - 1)) + parseInt(this.size)),
				...
				(this.remoteRowCountEstimate =
					void 0 !== e.last_row
						...
						: e.last_page * this.size -
						  (this.page == e.last_page ? this.size - e.data.length : 0)),
				this.progressiveLoad)
			) {
				switch (this.mode) {
					case "progressive_load":
						1 == this.page
							? this.table.rowManager.setData(e.data, !1, 1 == this.page)
...
(Q.moduleName = "page"), (Q.pageCounters = Z);
var ee = {
		local: function (e, t) {
		...
		cookie: function (e, t) {
			...
			return (
				r > -1 &&
					((i = (o = o.slice(r)).indexOf(";")) > -1 && (o = o.slice(0, i)),
					(s = o.replace(n + "=", ""))),
				!!s && JSON.parse(s)
			);
		},
			...
			(this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie"),
				this.table.options.persistenceReaderFunc
					? "function" == typeof this.table.options.persistenceReaderFunc
						...
						: ie.readers[this.table.options.persistenceReaderFunc]
						? (this.readFunc =
								ie.readers[this.table.options.persistenceReaderFunc])
						: console.warn(
					...
					: ie.readers[this.mode]
					? (this.readFunc = ie.readers[this.mode])
					: console.warn(
							"Persistence Read Error - invalid reader set",
							this.mode
					  ),
				this.table.options.persistenceWriterFunc
					? "function" == typeof this.table.options.persistenceWriterFunc
						...
						: ie.writers[this.table.options.persistenceWriterFunc]
						? (this.writeFunc =
								ie.writers[this.table.options.persistenceWriterFunc])
						: console.warn(
					...
					: ie.writers[this.mode]
					? (this.writeFunc = ie.writers[this.mode])
					: console.warn(
							"Persistence Write Error - invalid writer set",
							this.mode
					  ),
				(this.id =
					"tabulator-" + (i || this.table.element.getAttribute("id") || "")),
				(this.config = {
					sort:
	...
	mergeDefinition(e, t) {
		...
		return (
			(t = t || []).forEach((t, s) => {
				...
				n &&
					(!0 === this.config.columns || null == this.config.columns
						? (o = Object.keys(n)).push("width")
						: (o = this.config.columns),
					o.forEach((e) => {
						"columns" !== e && void 0 !== t[e] && (n[e] = t[e]);
					}),
					n.columns && (n.columns = this.mergeDefinition(n.columns, t.columns)),
					i.push(n));
			}),
			e.forEach((e, s) => {
				this._findColumn(t, e) ||
					(i.length > s ? i.splice(s, 0, e) : i.push(e));
			}),
			i
		);
	}
	...
	parseColumns(e) {
		...
		return (
			e.forEach((e) => {
				...
				e.isGroup
					? ((o.title = n.title),
					  (o.columns = this.parseColumns(e.getColumns())))
					: ((o.field = e.getField()),
					  !0 === this.config.columns || null == this.config.columns
							? ((s = Object.keys(n)).push("width"), s.push("visible"))
...
(ie.moduleName = "persistence"),
	(ie.moduleInitOrder = -10),
	(ie.readers = ee),
	(ie.writers = te);
class se extends o {
	constructor(e) {
	...
	loadPopup(e, t, i, s) {
		...
		i instanceof HTMLElement
			...
			r || e.preventDefault(),
			(n = this.popup(o)),
			"function" == typeof s && n.renderCallback(s),
			n.show(e).hideOnBlur(() => {
...
class oe extends o {
	...
	printFullscreen(e, t, i) {
		var s,
			...
			h = this.table.modules.export.genereateTable(
		...
		(this.manualBlock = !0),
			...
			this.table.options.printFormatter &&
				this.table.options.printFormatter(this.element, h),
			window.print(),
			this.cleanup(),
			window.scrollTo(n, r),
			(this.manualBlock = !1);
...
class ne extends o {
				...
				value: function () {
					...
					return (
						i.blocked ||
							t !== i.currentVersion ||
							(i.data.length &&
								(s = i.table.rowManager.getRowFromDataObject(i.data[0])) &&
								s.deleteActual()),
				...
				value: function () {
					...
					return (
						i.blocked ||
							t !== i.currentVersion ||
							(i.data.length &&
								(s = i.table.rowManager.getRowFromDataObject(
			...
			Object.defineProperty(this.data, "splice", {
				...
				value: function () {
					var s,
						...
						n = o[0] < 0 ? e.length + o[0] : o[0],
						r = o[1],
						a = !!o[2] && o.slice(2);
					if (!i.blocked && t === i.currentVersion) {
						if (
							(a &&
								((s = !!e[n] && i.table.rowManager.getRowFromDataObject(e[n]))
									? a.forEach((e) => {
											i.table.rowManager.addRowActual(e, !0, s, !0);
									  })
									: (a = a.slice().reverse()).forEach((e) => {
											i.table.rowManager.addRowActual(e, !0, !1, !0);
									  })),
							0 !== r)
						) {
							var l = e.slice(n, void 0 === o[1] ? o[1] : n + r);
							l.forEach((e, t) => {
								var s = i.table.rowManager.getRowFromDataObject(e);
								s && s.deleteActual(t !== l.length - 1);
							});
						}
						(a || 0 !== r) && i.table.rowManager.reRenderInPosition();
					}
	...
	watchTreeChildren(e) {
		var t = e.getData()[this.table.options.dataTreeChildField],
			i = {};
		function s() {
		...
		t &&
			...
			Object.defineProperty(t, "push", {
				...
				configurable: !0,
				value: () => {
					var e = i.push.apply(t, arguments);
					return s(), e;
				},
			}),
			(i.unshift = t.unshift),
			Object.defineProperty(t, "unshift", {
				enumerable: !1,
				configurable: !0,
				value: () => {
					var e = i.unshift.apply(t, arguments);
					return s(), e;
				},
			}),
			(i.shift = t.shift),
			Object.defineProperty(t, "shift", {
				...
				configurable: !0,
				value: () => {
					var e = i.shift.call(t);
					return s(), e;
				},
			}),
			(i.pop = t.pop),
			Object.defineProperty(t, "pop", {
				enumerable: !1,
				configurable: !0,
				value: () => {
					var e = i.pop.call(t);
			...
			(i.splice = t.splice),
			Object.defineProperty(t, "splice", {
				enumerable: !1,
				configurable: !0,
				value: () => {
					var e = i.splice.apply(t, arguments);
					return s(), e;
				},
			}));
	}
	watchKey(e, t, i) {
		...
		Object.defineProperty(t, i, {
			set: (t) => {
				if (((o = t), !this.blocked && n === this.currentVersion)) {
					var r = {};
					(r[i] = t), e.updateData(r);
				}
				s.set && s.set(t);
			},
			get: () => (s.get && s.get(), o),
...
class re extends o {
	...
	reinitializeColumn(e) {
		var t =
			!!e.modules.frozen && e.modules.frozen.marginValue + e.getWidth() + "px";
		e.cells.forEach((e) => {
			e.modules.resize &&
	...
	initializeColumn(e, t, i, s) {
		...
		if (
			("header" === e &&
				(r = {
					variableHeight:
						"textarea" == i.definition.formatter || i.definition.variableHeight,
				}),
			...
			l.addEventListener("mousedown", h),
				...
				i.modules.frozen &&
					...
					(l.style.left = i.modules.frozen.marginValue + i.getWidth() + "px")),
				(r.handleEl = l),
	...
	_mouseDown(e, t, i) {
		...
		function o(e) {
			...
			if (
				...
				t.setWidth(s.startWidth + r),
				(o = t.width == t.minWidth || t.width == t.maxWidth),
				a < 0 && (s.nextColumn = s.initialNextColumn),
				s.table.options.resizableColumnFit && s.nextColumn && (!i || !o))
			) {
				let e = s.nextColumn.getWidth();
				a > 0 &&
					e <= s.nextColumn.minWidth &&
					(s.nextColumn = s.nextColumn.nextColumn()),
					s.nextColumn && s.nextColumn.setWidth(s.nextColumn.getWidth() - a);
			}
			s.table.columnManager.renderer.rerenderColumns(!0),
				!s.table.browserSlow &&
					t.modules.resize &&
		...
		function n(e) {
			s.startColumn.modules.edit && (s.startColumn.modules.edit.blocked = !1),
				...
				s.startWidth !== t.getWidth() &&
					(s.dispatch("column-resized", t),
					s.table.externalEvents.dispatch("columnResized", t.getComponent()));
		}
...
class ae extends o {
	...
	_mouseDown(e, t, i) {
		...
		function o(e) {
			t.setHeight(
				s.startHeight +
					((void 0 === e.screenY ? e.touches[0].screenY : e.screenY) - s.startY)
			);
		}
		function n(e) {
			document.body.removeEventListener("mouseup", o),
				...
				i.removeEventListener("touchend", n),
				s.table.element.classList.remove("tabulator-block-select"),
				s.dispatchExternal("rowResized", t.getComponent());
		}
		s.table.element.classList.add("tabulator-block-select"),
			e.stopPropagation(),
		...
		if (this.table.options.autoResize) {
			...
			(this.tableHeight = t.element.clientHeight),
				...
				t.element.parentNode &&
					((this.containerHeight = t.element.parentNode.clientHeight),
					(this.containerWidth = t.element.parentNode.clientWidth)),
				"undefined" != typeof ResizeObserver &&
				"virtual" === t.rowManager.getRenderMode()
					? ((this.autoResize = !0),
					  (this.observer = new ResizeObserver((e) => {
							if (
								!t.browserMobile ||
								(t.browserMobile && !t.modules.edit.currentCell)
							) {
								var i = Math.floor(e[0].contentRect.height),
									s = Math.floor(e[0].contentRect.width);
								(this.tableHeight == i && this.tableWidth == s) ||
									((this.tableHeight = i),
									(this.tableWidth = s),
									t.element.parentNode &&
										((this.containerHeight = t.element.parentNode.clientHeight),
					  ...
					  this.table.element.parentNode &&
							...
							(e.getPropertyValue("max-height") ||
								e.getPropertyValue("min-height")) &&
							((this.containerObserver = new ResizeObserver((e) => {
								if (
									...
									var i = Math.floor(e[0].contentRect.height),
										s = Math.floor(e[0].contentRect.width);
									(this.containerHeight == i && this.containerWidth == s) ||
										((this.containerHeight = i),
										(this.containerWidth = s),
										(this.tableHeight = t.element.clientHeight),
										(this.tableWidth = t.element.clientWidth)),
										t.columnManager.renderer.rerenderColumns(!0),
										t.redraw();
								}
							})),
					...
					: ((this.binding = function () {
							(!t.browserMobile ||
								(t.browserMobile && !t.modules.edit.currentCell)) &&
								(t.columnManager.renderer.rerenderColumns(!0), t.redraw());
					  }),
...
class he extends o {
	...
	tableRedraw(e) {
		-1 === ["fitColumns", "fitDataStretch"].indexOf(this.layoutMode()) &&
			(e || this.update());
	}
		...
		(this.mode = this.table.options.responsiveLayout),
			...
			this.table.columnManager.columnsByIndex.forEach((t, i) => {
				t.modules.responsive &&
					t.modules.responsive.order &&
					t.modules.responsive.visible &&
					((t.modules.responsive.index = i),
					e.push(t),
	...
	update() {
		for (var e = this, t = !0; t; ) {
			...
			if (s < 0) {
				let i = e.columns[e.index];
				i ? (e.hideColumn(i), e.index++) : (t = !1);
			} else {
				let i = e.columns[e.index - 1];
				i && s > 0 && s >= i.getWidth()
					? (e.showColumn(i), e.index--)
					: (t = !1);
			}
	...
	generateCollapsedRowData(e) {
		var t,
			...
			o = [];
		return (
			this.hiddenColumns.forEach(function (n) {
				var r = n.getFieldValue(s);
					...
					if (
						...
						(t = {
							...
							o.push({
								...
								value: n.modules.format.formatter.call(
									i.table.modules.format,
									t,
									n.modules.format.params,
									function (e) {
										e();
									}
								),
						...
						o.push({ field: n.field, title: n.definition.title, value: r });
			}),
			o
		);
	}
...
he.moduleName = "responsiveLayout";
class de extends o {
	constructor(e) {
		super(e),
			(this.selecting = !1),
			...
			this.registerTableOption("selectableCheck", function (e, t) {
				return !0;
			}),
							  ...
							  i.addEventListener("mousedown", function (i) {
									if (i.shiftKey)
										return (
											...
											(t.selecting = !0),
											(t.selectPrev = []),
											document.body.addEventListener("mouseup", s),
	...
	handleComplexRowClick(e, t) {
		if (t.shiftKey) {
			...
			t.ctrlKey || t.metaKey
				? (r.forEach((t) => {
						t !== this.lastClickedRow &&
							(!0 === this.table.options.selectable ||
								this.isRowSelected(e) ||
				...
				: (this.deselectRows(void 0, !0),
				  !0 !== this.table.options.selectable &&
						r.length > this.table.options.selectable &&
	...
	toggleRow(e) {
		this.table.options.selectableCheck.call(this.table, e.getComponent()) &&
		...
		switch (typeof e) {
			...
			case "string":
				(t = this.table.rowManager.findRow(e))
					...
					: this.table.rowManager.getRows(e).forEach((e) => {
							this._selectRow(e, !0, !0);
					  }),
					this._rowSelectionChanged();
				break;
	...
	_selectRow(e, t, i) {
		...
		s
			? -1 == this.selectedRows.indexOf(s) &&
			  (s.getElement().classList.add("tabulator-selected"),
			  s.modules.select || (s.modules.select = {}),
			  (s.modules.select.selected = !0),
			  s.modules.select.checkboxEl &&
					(s.modules.select.checkboxEl.checked = !0),
			  this.selectedRows.push(s),
			  this.table.options.dataTreeSelectPropagate &&
					this.childRowSelection(s, !0),
	...
	deselectRows(e, t) {
		...
		if (void 0 === e) {
			...
			for (let e = 0; e < i; e++) s._deselectRow(s.selectedRows[0], !0);
			...
			Array.isArray(e)
				? (e.forEach(function (e) {
				  ...
				  s._rowSelectionChanged(t))
				: s._deselectRow(e, t);
	}
	_deselectRow(e, t) {
		var i,
			s = this,
			o = s.table.rowManager.findRow(e);
		o
			? (i = s.selectedRows.findIndex(function (e) {
					return e == o;
			  })) > -1 &&
	...
	if (void 0 !== a) {
		if (
			((e = a.isDateTime(e)
				...
				: "iso" === l
				? a.fromISO(String(e))
				: a.fromFormat(String(e), l)),
			(t = a.isDateTime(t)
				? t
				: "iso" === l
				? a.fromISO(String(t))
				: a.fromFormat(String(t), l)),
			e.isValid)
		) {
...
var ue = {
	number: function (e, t, i, s, o, n, r) {
		...
		if (
			((e = String(e)),
			(t = String(t)),
			h && ((e = e.split(h).join("")), (t = t.split(h).join(""))),
	...
	string: function (e, t, i, s, o, n, r) {
		...
		if (e) {
			if (t) {
				...
				return String(e)
					.toLowerCase()
					.localeCompare(String(t).toLowerCase(), a);
			}
			h = 1;
		} else h = t ? -1 : 0;
		return (
			(("top" === l && "desc" === n) || ("bottom" === l && "asc" === n)) &&
				(h *= -1),
			h
		);
	},
	date: function (e, t, i, s, o, n, r) {
		return (
			r.format || (r.format = "dd/MM/yyyy"), ce.call(this, e, t, i, s, o, n, r)
		);
	},
	time: function (e, t, i, s, o, n, r) {
		return r.format || (r.format = "HH:mm"), ce.call(this, e, t, i, s, o, n, r);
	},
	datetime: ce,
	...
	array: function (e, t, i, s, o, n, r) {
		...
		if (Array.isArray(e)) {
			if (Array.isArray(t)) return (e ? d(e) : 0) - (t ? d(t) : 0);
			l = 1;
		...
		if (e || 0 === e) {
			if (t || 0 === t) {
				...
				for (
					a = a.match(m),
						l = l.match(m),
						c = a.length > l.length ? l.length : a.length;
					u < c;

				)
					if ((h = a[u]) !== (d = l[u++]))
						return isFinite(h) && isFinite(d)
							? ("0" === h.charAt(0) && (h = "." + h),
							  "0" === d.charAt(0) && (d = "." + d),
							  h - d)
							: h > d
...
class me extends o {
	...
	initializeColumn(e) {
		...
		switch (typeof e.definition.sorter) {
			case "string":
				me.sorters[e.definition.sorter]
					? (s = me.sorters[e.definition.sorter])
					: console.warn(
		...
		(e.modules.sort = {
			...
			!1 !== e.definition.headerSort &&
				((t = e.getElement()).classList.add("tabulator-sortable"),
				(i = document.createElement("div")).classList.add(
					"tabulator-col-sorter"
				),
				"object" == typeof this.table.options.headerSortElement
				...
				t.addEventListener("click", (t) => {
					...
					if (e.modules.sort) {
						...
						(t.shiftKey || t.ctrlKey)
							? ((o = (s = this.getSort()).findIndex(
									(t) => t.field === e.getField()
							  )) > -1
									? ((s[o].dir = i),
									  o != s.length - 1 &&
											((o = s.splice(o, 1)[0]), "none" != i && s.push(o)))
									: "none" != i && s.push({ column: e, dir: i }),
							  this.setSort(s))
							: "none" == i
							? this.clear()
							: this.setSort(e, i),
		...
		Array.isArray(e) || (e = [{ column: e, dir: t }]),
			e.forEach(function (e) {
				...
				(t = i.table.columnManager.findColumn(e.column))
					? ((e.column = t), s.push(e), (i.changed = !0))
					: console.warn(
	...
	setColumnHeader(e, t) {
		(e.modules.sort.dir = t),
			e
				.getElement()
				.setAttribute("aria-sort", "asc" === t ? "ascending" : "descending");
	}
	_sortItems(e, t) {
		var i = t.length - 1;
		e.sort((e, s) => {
	...
	_sortRow(e, t, i, s, o) {
		var n,
			...
			l = "asc" == s ? t : e;
		return (
			(e = void 0 !== (e = i.getFieldValue(a.getData())) ? e : ""),
...
(me.moduleName = "sort"), (me.sorters = ue);
class pe extends o {
	constructor(e) {
		super(e),
	...
	mousemoveCheck(e, t, i) {
		...
		s &&
			...
			(this.timeout = setTimeout(
				this.loadTooltip.bind(this, t, i, s),
	...
	loadTooltip(e, t, i) {
		...
		"function" == typeof i &&
			...
			(i || 0 === i || "0" === i || !1 === i) &&
				...
				(n = this.popupInstance.containerEventCoords(e)),
				this.popupInstance.show(n.x + 15, n.y + 15).hideOnBlur(() => {
...
pe.moduleName = "tooltip";
var ge = {
	integer: function (e, t, i) {
		return (
			"" === t ||
			null == t ||
			("number" == typeof (t = Number(t)) && isFinite(t) && Math.floor(t) === t)
		);
	},
...
class be extends o {
	...
	_extractValidator(e) {
		...
		switch (typeof e) {
			case "string":
				return (
					(s = e.indexOf(":")) > -1
						? ((t = e.substring(0, s)), (i = e.substring(s + 1)))
						: (t = e),
	...
	_buildValidator(e, t) {
		var i = "function" == typeof e ? e : be.validators[e];
		return i
			? { type: "function" == typeof e ? "function" : e, func: i, params: t }
			: (console.warn(
	...
	validate(e, t, i) {
		...
		return (
			e &&
				e.forEach((e) => {
					e.func.call(s, t.getComponent(), i, e.params) ||
...
(be.moduleName = "validate"), (be.validators = ge);
var fe = Object.freeze({
	...
	FilterModule: H,
	FormatModule: O,
	FrozenColumnsModule: A,
	FrozenRowsModule: B,
	GroupRowsModule: V,
	HistoryModule: W,
	HtmlTableImportModule: G,
	ImportModule: U,
	InteractionModule: X,
	KeybindingsModule: q,
	MenuModule: K,
	...
	MutatorModule: $,
	PageModule: Q,
	PersistenceModule: ie,
	PopupModule: se,
	PrintModule: oe,
	ReactiveDataModule: ne,
	ResizeColumnsModule: re,
	ResizeRowsModule: ae,
	ResizeTableModule: le,
	ResponsiveLayoutModule: he,
	SelectRowModule: de,
	SortModule: me,
	TooltipModule: pe,
	ValidateModule: be,
...
class ve {
	...
	generate(e, t = {}) {
		...
		if (
			(Object.assign(i, e),
			!1 !== t.debugInvalidOptions || this.table.options.debugInvalidOptions)
		)
			for (var s in t)
				i.hasOwnProperty(s) ||
					console.warn("Invalid " + this.msgType + " option:", s);
		for (var s in i)
			s in t
				? (i[s] = t[s])
				: Array.isArray(i[s])
				? (i[s] = Object.assign([], i[s]))
				: "object" == typeof i[s] && null !== i[s]
				? (i[s] = Object.assign({}, i[s]))
...
class we extends e {
	...
	scrollToRowPosition(e, i, s) {
		...
		return new Promise((a, l) => {
			if (o > -1) {
				if (
					(void 0 === s && (s = this.table.options.scrollToRowIfVisible),
					!s &&
						t.elVisible(n) &&
						(r = t.elOffset(n).top - t.elOffset(this.elementVertical).top) >
							0 &&
						r < this.elementVertical.clientHeight - n.offsetHeight)
				)
					return a(), !1;
				switch (
					(void 0 === i && (i = this.table.options.scrollToRowPosition),
					"nearest" === i &&
						(i = this.scrollToRowNearestTop(e) ? "top" : "bottom"),
					this.scrollToRow(e),
					i)
				) {
					case "middle":
					case "center":
						...
						this.elementVertical.clientHeight
							? (this.elementVertical.scrollTop =
									this.elementVertical.scrollTop +
									(n.offsetTop - this.elementVertical.scrollTop) -
									(this.elementVertical.scrollHeight - n.offsetTop) / 2)
							: (this.elementVertical.scrollTop =
									this.elementVertical.scrollTop -
					...
					case "bottom":
						...
						this.elementVertical.clientHeight
							? (this.elementVertical.scrollTop =
									this.elementVertical.scrollTop -
									(this.elementVertical.scrollHeight - n.offsetTop) +
									n.offsetHeight)
							: (this.elementVertical.scrollTop =
									this.elementVertical.scrollTop -
									this.elementVertical.clientHeight +
...
class Ee extends we {
			...
			this.table.columnManager.columnsByIndex.forEach((e) => {
				...
				if (e.visible) {
					...
					(t.leftPos = s),
						...
						s + i > this.vDomScrollPosLeft && s < this.vDomScrollPosRight
							? (-1 == this.leftCol &&
									((this.leftCol = this.columns.length),
									(this.vDomPadLeft = s)),
							  (this.rightCol = this.columns.length))
							: -1 !== this.leftCol && (this.vDomPadRight += i),
						this.columns.push(e),
						(e.modules.vdomHoz = t),
						(s += i);
				}
	...
	dataChange() {
		...
		if (this.isFitData) {
			if (
				...
				for (s = 0; s < t.cells.length; s++) {
					let i = t.cells[s];
					e.appendChild(i.getElement()),
						i.column.reinitializeWidth(),
						i.column.getWidth();
				}
	...
	addColRight() {
		for (var e = !1; ; ) {
			let t = this.columns[this.rightCol + 1];
			if (!t) break;
			if (!(t.modules.vdomHoz.leftPos <= this.vDomScrollPosRight)) break;
			(e = !0),
				this.getVisibleRows().forEach((e) => {
					if ("group" !== e.type) {
						var i = e.getCell(t);
				...
				this.rightCol >= this.columns.length - 1
					? (this.vDomPadRight = 0)
					: (this.vDomPadRight -= t.getWidth());
		}
		e && (this.tableElement.style.paddingRight = this.vDomPadRight + "px");
	}
	addColLeft() {
		for (var e = !1; ; ) {
			let t = this.columns[this.leftCol - 1];
			if (!t) break;
			if (!(t.modules.vdomHoz.rightPos >= this.vDomScrollPosLeft)) break;
			{
				(e = !0),
					this.getVisibleRows().forEach((e) => {
						if ("group" !== e.type) {
							var i = e.getCell(t);
							e.getElement().prepend(i.getElement()), i.cellRendered();
						}
					}),
					this.leftCol--,
					this.leftCol <= 0
				...
				let i = this.fitDataColActualWidthCheck(t);
				i &&
					((this.scrollLeft = this.elementVertical.scrollLeft =
						this.elementVertical.scrollLeft + i),
					(this.vDomPadRight -= i));
			}
		}
	...
	removeColRight() {
		for (var e = !1; ; ) {
			let t = this.columns[this.rightCol];
			if (!t) break;
			if (!(t.modules.vdomHoz.leftPos > this.vDomScrollPosRight)) break;
			(e = !0),
				this.getVisibleRows().forEach((e) => {
					if ("group" !== e.type) {
						var i = e.getCell(t);
						try {
							e.getElement().removeChild(i.getElement());
						} catch (e) {
	...
	removeColLeft() {
		for (var e = !1; ; ) {
			let t = this.columns[this.leftCol];
			if (!t) break;
			if (!(t.modules.vdomHoz.rightPos < this.vDomScrollPosLeft)) break;
			(e = !0),
				this.getVisibleRows().forEach((e) => {
...
class ye extends e {
	constructor(e) {
		super(e),
			...
			(this.columnsByField = {}),
			(this.scrollLeft = 0),
			(this.optionsList = new ve(this.table, "column definition", f)),
			(this.renderer = null);
	}
	initialize() {
	...
	createHeadersElement() {
		var e = document.createElement("div");
		return (
			e.classList.add("tabulator-headers"), e.setAttribute("role", "row"), e
		);
	}
	createHeaderElement() {
		var e = document.createElement("div");
	...
	_addColumn(e, t, i) {
		...
		if (i && n > -1) {
			var r = i.getTopColumn(),
				a = this.columns.indexOf(r),
				l = r.getElement();
			t
				? (this.columns.splice(a, 0, s), l.parentNode.insertBefore(o, l))
				: (this.columns.splice(a + 1, 0, s),
				  l.parentNode.insertBefore(o, l.nextSibling));
		} else
			t
				? (this.columns.unshift(s),
	...
	verticalAlignHeaders() {
		...
		this.columns.forEach((t) => {
			var i;
			t.clearVerticalAlign(), (i = t.getHeight()) > e && (e = i);
		}),
			this.columns.forEach((t) => {
	...
	findColumn(e) {
		...
		if (e instanceof b) return e._getSelf() || !1;
		if ("undefined" != typeof HTMLElement && e instanceof HTMLElement) {
			return this.columns.find((t) => t.element === e) || !1;
		}
		return !1;
	}
	getColumnByField(e) {
	...
	getFirstVisibleColumn(e) {
		return (
			(e = this.columnsByIndex.findIndex((e) => e.visible)) > -1 &&
	...
	_moveColumnInArray(e, t, i, s, o) {
		...
		r > -1 &&
			...
			e.splice(n, 0, t),
			o &&
				(this.chain("column-moving-rows", [t, i, s], null, []) || [])
	...
	scrollToColumn(e, t, i) {
		...
		return new Promise((a, l) => {
			if (
				(void 0 === t && (t = this.table.options.scrollToColumnPosition),
				...
				if (
					!i &&
					(o = r.offsetLeft) > 0 &&
					o + r.offsetWidth < this.element.clientWidth
				)
					return !1;
				(s = r.offsetLeft + n),
					(s = Math.max(
	...
	redraw(e) {
		t.elVisible(this.element) && this.verticalAlignHeaders(),
			e &&
...
class Re extends we {
	...
	scrollToRowNearestTop(e) {
		var i = t.elOffset(e.getElement()).top;
		return !(
			Math.abs(this.elementVertical.scrollTop - i) >
			Math.abs(
				this.elementVertical.scrollTop + this.elementVertical.clientHeight - i
			)
		);
	}
	scrollToRow(e) {
		...
		this.elementVertical.scrollTop =
			t.elOffset(i).top -
			t.elOffset(this.elementVertical).top +
			this.elementVertical.scrollTop;
	}
	visibleRows(e) {
		return this.rows();
...
class xe extends we {
	...
	rerenderRows(e) {
		...
		n.forEach((e) => {
			...
			e && e(),
			this._virtualRenderFill(!1 === i ? this.rows.length - 1 : i, !0, s || 0),
	...
	scrollRows(e, t) {
		...
		if (((this.scrollTop = e), -i > o || s > o)) {
			...
			t
				? (i < 0 && this._addTopRow(n, -i),
				  s < 0 &&
						(this.vDomScrollHeight - this.scrollTop > this.vDomWindowBuffer
							? this._removeBottomRow(n, -s)
							: (this.vDomScrollPosBottom = this.scrollTop)))
				: (s >= 0 && this._addBottomRow(n, s),
				  i >= 0 &&
						(this.scrollTop > this.vDomWindowBuffer
							? this._removeTopRow(n, i)
	...
	_virtualRenderFill(e, i, s) {
		var o = this.tableElement,
			...
			c = this.rows(),
			u = c.length,
			m = this.elementVertical.clientHeight;
		if (((s = s || 0), (e = e || 0))) {
			for (; o.firstChild; ) o.removeChild(o.firstChild);
			(l = (u - e + 1) * this.vDomRowHeight) < m &&
				(e -= Math.ceil((m - l) / this.vDomRowHeight)) < 0 &&
				(e = 0),
				(e -= r =
					Math.min(
						Math.max(
		...
		if (u && t.elVisible(this.elementVertical)) {
			for (
				this.vDomTop = e, this.vDomBottom = e - 1;
				(a <= m + this.vDomWindowBuffer || d < this.vDomWindowMinTotalRows) &&
				this.vDomBottom < u - 1;
				...
				var p,
					...
					b = c[g];
				this.styleRow(b, g),
					o.appendChild(b.getElement()),
					b.initialize(),
					b.heightInitialized || b.normalizeHeight(!0),
					(p = b.getHeight()),
					d < r ? (h += p) : (a += p),
			...
			e
				? ((this.vDomTopPad = i
						? this.vDomRowHeight * this.vDomTop + s
						: this.scrollTop - h),
				  (this.vDomBottomPad =
						this.vDomBottom == u - 1
							? 0
							: Math.max(this.vDomScrollHeight - this.vDomTopPad - a - h, 0)))
				: ((this.vDomTopPad = 0),
				  (this.vDomRowHeight = Math.floor((a + h) / d)),
				  (this.vDomBottomPad = this.vDomRowHeight * (u - this.vDomBottom - 1)),
				  (this.vDomScrollHeight = h + a + this.vDomBottomPad - m)),
				...
				i &&
					(this.scrollTop =
						...
						(this.elementVertical.scrollWidth > this.elementVertical.clientWidth
							? this.elementVertical.offsetHeight - m
							: 0)),
				(this.scrollTop = Math.min(
					this.scrollTop,
					this.elementVertical.scrollHeight - m
				)),
				this.elementVertical.scrollWidth > this.elementVertical.offsetWidth &&
					i &&
					(this.scrollTop += this.elementVertical.offsetHeight - m),
				(this.vDomScrollPosTop = this.scrollTop),
				(this.vDomScrollPosBottom = this.scrollTop),
	...
	_addTopRow(e, t) {
		for (
			var i = this.tableElement, s = [], o = 0, n = this.vDomTop - 1, r = 0;
			this.vDomTop;
			...
			let a,
				l,
				h = e[n];
			if (!(h && r < this.vDomMaxRenderChain)) break;
			if (
				((a = h.getHeight() || this.vDomRowHeight),
				(l = h.initialized),
				!(t >= a))
			)
				break;
			this.styleRow(h, n),
				i.insertBefore(h.getElement(), i.firstChild),
				(h.initialized && h.heightInitialized) || s.push(h),
				h.initialize(),
				l ||
					((a = h.getElement().offsetHeight),
					a > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * a)),
				(t -= a),
				(o += a),
				this.vDomTop--,
				n--,
	...
	_removeTopRow(e, t) {
		for (var i = [], s = 0, o = 0; ; ) {
			let n,
				r = e[this.vDomTop];
			if (!(r && o < this.vDomMaxRenderChain)) break;
			if (((n = r.getHeight() || this.vDomRowHeight), !(t >= n))) break;
			this.vDomTop++, (t -= n), (s += n), i.push(r), o++;
		}
		for (let e of i) {
			let t = e.getElement();
	...
	_addBottomRow(e, t) {
		for (
			var i = this.tableElement, s = [], o = 0, n = this.vDomBottom + 1, r = 0;
			;
		...
		this._quickNormalizeRowHeight(s),
			o &&
				...
				(this.vDomBottomPad < 0 || n == e.length - 1) &&
					(this.vDomBottomPad = 0),
	...
	_removeBottomRow(e, t) {
		for (var i = [], s = 0, o = 0; ; ) {
			...
			if (!(r && o < this.vDomMaxRenderChain)) break;
			if (((n = r.getHeight() || this.vDomRowHeight), !(t >= n))) break;
			this.vDomBottom--, (t -= n), (s += n), i.push(r), o++;
		}
		for (let e of i) {
			let t = e.getElement();
			t.parentNode && t.parentNode.removeChild(t);
...
class Te extends e {
	...
	createHolderElement() {
		var e = document.createElement("div");
		return (
			e.classList.add("tabulator-tableholder"), e.setAttribute("tabindex", 0), e
		);
	}
	createTableElement() {
		var e = document.createElement("div");
		return (
			e.classList.add("tabulator-table"), e.setAttribute("role", "rowgroup"), e
		);
	}
	...
	findRow(e) {
		...
		if (e instanceof w) return e._getSelf() || !1;
		if ("undefined" != typeof HTMLElement && e instanceof HTMLElement) {
		...
		return new Promise((s, o) => {
			t && this.getDisplayRows().length
				...
				: (this.table.options.autoColumns &&
						...
						this.table.columnManager.generateColumnsFromRowData(e),
				  this.resetScroll(),
				  this._setDataActual(e)),
				s();
		});
	...
	addRowActual(e, t, i, s) {
		var o,
			n,
			r = e instanceof C ? e : new C(e || {}, this),
			a = this.findAddRowPos(t),
			l = -1;
		return (
			i ||
				((n = this.chain("row-adding-position", [r, a], null, {
					index: i,
					top: a,
				})),
				(i = n.index),
			...
			(i = this.chain("row-adding-index", [r, i, a], null, i)) &&
	...
	nextDisplayRow(e, t) {
		...
		return (
			!1 !== i &&
				...
				(s = this.getDisplayRows()[i + 1]),
			!s || (s instanceof C && "row" == s.type) ? s : this.nextDisplayRow(s, t)
		);
	}
	prevDisplayRow(e, t) {
		var i = this.getDisplayRowIndex(e),
			s = !1;
		return (
			i && (s = this.getDisplayRows()[i - 1]),
			!t || !s || (s instanceof C && "row" == s.type)
				? s
				: this.prevDisplayRow(s, t)
		);
	}
	findRowIndex(e, t) {
		var i;
	...
	registerDataPipelineHandler(e, t) {
		void 0 !== t
			? (this.dataPipeline.push({ handler: e, priority: t }),
			  this.dataPipeline.sort((e, t) => e.priority - t.priority))
			: console.error(
	...
	registerDisplayPipelineHandler(e, t) {
		void 0 !== t
			? (this.displayPipeline.push({ handler: e, priority: t }),
			  this.displayPipeline.sort((e, t) => e.priority - t.priority))
			: console.error(
					"Display pipeline handlers must have a priority in order to be registered"
			  );
	}
	refreshActiveData(e, i, s) {
		var o = this.table,
			n = "",
			r = 0,
			a = ["all", "dataPipeline", "display", "displayPipeline", "end"];
		if ("function" == typeof e)
			if ((r = this.dataPipeline.findIndex((t) => t.handler === e)) > -1)
				(n = "dataPipeline"),
					i && (r == this.dataPipeline.length - 1 ? (n = "display") : r++);
			else {
				if (
					!((r = this.displayPipeline.findIndex((t) => t.handler === e)) > -1)
				)
				...
				(n = "displayPipeline"),
					i && (r == this.displayPipeline.length - 1 ? (n = "end") : r++);
			}
		else (n = e || "all"), (r = 0);
		this.redrawBlock
			? (!this.redrawBlockRestoreConfig ||
					(this.redrawBlockRestoreConfig &&
						((this.redrawBlockRestoreConfig.stage === n &&
							r < this.redrawBlockRestoreConfig.index) ||
							a.indexOf(n) <
								a.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
			  (this.redrawBlockRestoreConfig = {
					handler: e,
					skipStage: i,
					renderInPosition: s,
			...
			: (t.elVisible(this.element)
					? s
						? this.reRenderInPosition(
								this.refreshPipelines.bind(this, e, n, r, s)
						  )
						: (this.refreshPipelines(e, n, r, s),
						  e || this.table.columnManager.renderer.renderColumns(),
						  this.renderTable(),
						  o.options.layoutColumnsOnNewData &&
		...
		switch (
			...
			case "dataPipeline":
				for (let e = i; e < this.dataPipeline.length; e++) {
					let t = this.dataPipeline[e].handler(
						this.activeRowsPipeline[e].slice(0)
					);
					this.activeRowsPipeline[e + 1] =
						t || this.activeRowsPipeline[e].slice(0);
				}
			...
			case "displayPipeline":
				for (let e = i; e < this.displayPipeline.length; e++) {
					let t = this.displayPipeline[e].handler(
						(e ? this.getDisplayRows(e - 1) : this.activeRows).slice(0),
						s
					);
	...
	regenerateRowNumbers() {
		this.rowNumColumn &&
			this.activeRows.forEach((e) => {
				var t = e.getCell(this.rowNumColumn);
				t && t._generateContents();
			});
	}
	setActiveRows(e) {
	...
	setDisplayRows(e, t) {
		...
		return (
			t && void 0 !== this.displayRows[t]
				...
				: (this.displayRows.push(e), (i = t = this.displayRows.length - 1)),
		...
		this.dispatchExternal("renderStarted"),
			...
			this.displayRowsCount
				? (this.renderer.renderRows(),
				  this.firstRender && ((this.firstRender = !1), this.layoutRefresh()))
	...
	adjustTableSize() {
		...
		if ("fill" === this.renderer.verticalFillMode) {
			...
			this.fixedHeight
				? ((this.element.style.minHeight = "calc(100% - " + t + "px)"),
...
class Le extends e {
	...
	pseudoMouseEnter(e, t, i) {
		this.pseudoTrackers[e].target !== i &&
			(this.pseudoTrackers[e].target &&
				this.dispatch(e + "-mouseleave", t, this.pseudoTrackers[e].target),
	...
	pseudoMouseLeave(e, t) {
		...
		(i = i.filter((t) => {
			...
			this.pseudoTrackers[e].target &&
				(this.dispatch(e + "-mouseleave", t, i),
	...
	subscriptionChanged(e, t, i) {
		...
		i
			? -1 === o && (s.push(e), (n = !0))
			: this.subscribed(e + "-" + t) || (o > -1 && (s.splice(o, 1), (n = !0))),
	...
	updateEventListeners() {
		for (let e in this.listeners) {
			...
			t.components.length
				...
				: t.handler &&
				  (this.el.removeEventListener(e, t.handler), (t.handler = null));
		}
	}
	track(e, t) {
	...
	findTargets(e) {
		...
		for (let s of e) {
			...
			for (let e of o) t[this.componentMap[e]] = s;
		}
	...
	bindComponents(e, t) {
		...
		for (let e of i) {
			let i,
				n = t[e],
				r = this.previousTargets[e];
			if (r && r.target === n) i = r.component;
			else
				switch (e) {
					case "row":
					case "group":
						if (
							s.components.includes("row") ||
							s.components.includes("cell") ||
							s.components.includes("group")
						) {
							(i = this.table.rowManager
								.getVisibleRows(!0)
								.find((e) => e.getElement() === n)),
								t.row &&
									t.row.parentNode &&
						...
						break;
					case "column":
						s.components.includes("column") &&
							(i = this.table.columnManager.findColumn(n));
						break;
					case "cell":
						s.components.includes("cell") &&
							(t.row instanceof C
			...
			i && ((t[e] = i), (o[e] = { target: n, component: i }));
		}
		return (this.previousTargets = o), t;
	}
	triggerEvents(e, t, i) {
							...
							r == this.requestOrder
								? (this.clearAlert(),
								  !1 !== t &&
										...
										this.table.rowManager.setData(t, s, void 0 === n ? !s : n)))
								: console.warn(
...
class Pe {
	...
	_notifiySubscriptionChange(e, t) {
...
class ze {
	...
	static deregister(e) {
		var t = ze.tables.indexOf(e);
		t > -1 && ze.tables.splice(t, 1);
	}
...
var He = {
		...
		e.forEach((e, i) => {
			...
			o
				? ((s = i - t + o.getWidth()),
				  this.table.options.responsiveLayout &&
						this.table.modExists("responsiveLayout", !0) &&
						(o.setWidth(0), this.table.modules.responsiveLayout.update()),
				  s > 0 ? o.setWidth(s) : o.reinitializeWidth())
				: this.table.options.responsiveLayout &&
				  this.table.modExists("responsiveLayout", !0) &&
				  this.table.modules.responsiveLayout.update();
	},
	fitColumns: function (e) {
		var t,
			i,
			s = this.table.element.clientWidth,
			o = 0,
			n = 0,
			r = 0,
			a = [],
		...
		function u(e, t, i, s) {
			...
			function b(e) {
				return c(e.width) - i * (e.column.definition.widthShrink || 0);
			}
			return (
				...
				o.length
					? (o.forEach(function (e) {
					  ...
					  (d = (a = t - n) - (l = m ? Math.floor(a / m) : a) * m),
					  (d += u(p, a, l, s)))
					: ((d = m ? t - Math.floor(t / m) * m : t),
		...
		this.table.options.responsiveLayout &&
					...
					t
						? ((s = c(t)),
						  ...
						  e.definition.widthShrink &&
								(l.push({ column: e, width: s > i ? s : i }),
								(h += e.definition.widthShrink)))
			...
			(t = Math.floor(n / r)),
			(d = u(a, n, t, !1)),
			a.length && d > 0 && (a[a.length - 1].width += +d),
			a.forEach(function (e) {
				n -= e.width;
			}),
			(i = Math.abs(d) + n) > 0 && h && (d = u(l, i, Math.floor(i / h), !0)),
			l.length && (l[l.length - 1].width -= d),
			a.forEach(function (e) {
...
class _e extends o {
	...
	layout() {
		this.dispatch("layout-refreshing"),
			_e.modes[this.mode].call(this, this.table.columnManager.columnsByIndex),
			this.dispatch("layout-refreshed");
	}
}
(_e.moduleName = "layout"), (_e.modes = He);
class Oe extends o {
	constructor(e) {
		super(e),
			(this.locale = "default"),
	...
	initialize() {
		(this.langList = t.deepClone(Oe.langs)),
	...
	setLocale(e) {
		...
		(this.locale = e),
			(this.lang = t.deepClone(this.langList.default || {})),
			"default" != e &&
				(function e(t, i) {
					for (var s in t)
						"object" == typeof t[s]
...
class Ie {
	constructor(e, t) {
		this.bindStaticFuctionality(e),
			this.bindModules(e, Be, !0),
			t && this.bindModules(e, t);
	}
	bindStaticFuctionality(e) {
		(e.moduleBindings = {}),
			(e.extendModule = function (t, i, s) {
				if (e.moduleBindings[t]) {
					var o = e.moduleBindings[t][i];
					if (o)
						if ("object" == typeof s) for (let e in s) o[e] = s[e];
						else
							console.warn(
			...
			(e.prototype.bindModules = function () {
				...
				t.sort((e, t) => (e.moduleInitOrder > t.moduleInitOrder ? 1 : -1)),
					i.sort((e, t) => (e.moduleInitOrder > t.moduleInitOrder ? 1 : -1)),
					(this.modulesRegular = t.concat(s.concat(i)));
			});
	}
	bindModules(e, t, i) {
...
class Ne extends e {
	...
	_createMsgElement() {
		var e = document.createElement("div");
		return (
			e.classList.add("tabulator-alert-msg"), e.setAttribute("role", "alert"), e
		);
	}
	_typeClass() {
...
class Ve {
	constructor(e, t) {
		(this.options = {}),
			...
			(this.componentFunctionBinder = new ke(this)),
			(this.dataLoader = !1),
			(this.modules = {}),
			(this.modulesCore = []),
			(this.modulesRegular = []),
			(this.optionsList = new ve(this, "table constructor")),
			(this.initialized = !1),
			(this.destroyed = !1),
	...
	initializeCoreSystems(e) {
		(this.columnManager = new ye(this)),
			(this.rowManager = new Te(this)),
			(this.footerManager = new Me(this)),
			(this.dataLoader = new De(this)),
			(this.alertManager = new Ne(this)),
			this.bindModules(),
			(this.options = this.optionsList.generate(Ve.defaultOptions, e)),
			this._clearObjectPointers(),
			this._mapDeprecatedFunctionality(),
			(this.externalEvents = new Pe(
				this,
				this.options,
				this.options.debugEventsExternal
			)),
			(this.eventBus = new Se(this.options.debugEventsInternal)),
			(this.interactionMonitor = new Le(this)),
	...
	_buildElement() {
		...
		for (
			t.classList.add("tabulator"), t.setAttribute("role", "grid");
			t.firstChild;
		...
		i.height &&
			...
			!1 !== i.minHeight &&
				((i.minHeight = isNaN(i.minHeight) ? i.minHeight : i.minHeight + "px"),
				(t.style.minHeight = i.minHeight)),
			!1 !== i.maxHeight &&
				((i.maxHeight = isNaN(i.maxHeight) ? i.maxHeight : i.maxHeight + "px"),
	...
	deleteRow(e) {
		...
		for (let i of e) {
			...
			if (!e)
				return (
					console.error("Delete Error - No matching row found:", i),
		...
		return (
			t.sort((e, t) =>
				this.rowManager.rows.indexOf(e) > this.rowManager.rows.indexOf(t)
					? 1
					: -1
			),
			t.forEach((e) => {
	...
	addRow(e, t, i) {
		return (
			this.initGuard(),
			"string" == typeof e && (e = JSON.parse(e)),
			this.rowManager.addRows(e, t, i).then((e) => e[0].getComponent())
		);
	}
	updateOrAddRow(e, t) {
		...
		return (
			...
			"string" == typeof t && (t = JSON.parse(t)),
			i
				? i.updateData(t).then(() => i.getComponent())
				: this.rowManager.addRows(t).then((e) => e[0].getComponent())
		);
	}
	updateRow(e, t) {
		var i = this.rowManager.findRow(e);
		return (
			...
			"string" == typeof t && (t = JSON.parse(t)),
			i
				? i.updateData(t).then(() => Promise.resolve(i.getComponent()))
	...
	scrollToRow(e, t, i) {
		...
		return s
			? this.rowManager.scrollToRow(s, t, i)
	...
	showColumn(e) {
		...
		if ((this.initGuard(), !t))
			return (
				console.warn("Column Show Error - No matching column found:", e), !1
			);
		t.show();
	}
	hideColumn(e) {
		...
		if ((this.initGuard(), !t))
			return (
				console.warn("Column Hide Error - No matching column found:", e), !1
			);
		t.hide();
	}
	toggleColumn(e) {
	...
	moveColumn(e, t, i) {
		...
		this.initGuard(),
			s
				? o
					? this.columnManager.moveColumn(s, o, i)
	...
	scrollToColumn(e, t, i) {
		return new Promise((s, o) => {
			...
			return n
				? this.columnManager.scrollToColumn(n, t, i)
...
class Ge {
	...
	_createElement() {
		var e = document.createElement("div");
		return e.classList.add("tabulator-row"), e;
	}
	getElement() {
		return this.element;
	}
...
export {
	...
	m as CalcComponent,
	p as CellComponent,
	u as ClipboardModule,
	y as ColumnCalcsModule,
	b as ColumnComponent,
	R as DataTreeModule,
	T as DownloadModule,
	D as EditModule,
	z as ExportModule,
	H as FilterModule,
	O as FormatModule,
	A as FrozenColumnsModule,
	B as FrozenRowsModule,
	I as GroupComponent,
	V as GroupRowsModule,
	W as HistoryModule,
	G as HtmlTableImportModule,
	U as ImportModule,
	X as InteractionModule,
	q as KeybindingsModule,
	K as MenuModule,
	o as Module,
	J as MoveColumnsModule,
	Y as MoveRowsModule,
	$ as MutatorModule,
	Q as PageModule,
	ie as PersistenceModule,
	se as PopupModule,
	oe as PrintModule,
	Ge as PseudoRow,
	ne as ReactiveDataModule,
	we as Renderer,
	re as ResizeColumnsModule,
	ae as ResizeRowsModule,
	le as ResizeTableModule,
	he as ResponsiveLayoutModule,
	w as RowComponent,
	de as SelectRowModule,
	me as SortModule,
	Ve as Tabulator,
	We as TabulatorFull,
	pe as TooltipModule,
	be as ValidateModule,
};
